...
public class Polygon extends Polyline {
	...
	public boolean containsPoint(final int x, final int y) {
		...
		boolean isOdd = false;
		final int[] pointsxy = getPoints().toIntArray();
		final int n = pointsxy.length;
	...
	private int crossProduct(final int ax, final int ay, final int bx, final int by, final int cx, final int cy) {
