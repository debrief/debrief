...
public interface IMovement {
	...
	/**
	 * Set up the movement. with init( 0, 1, 50), it will take 50 steps to go from 0
	 * to 1. There is no garanties that getValue will return only values between min
	 * and max.
	 *
	 * The only thing you know is : getValue( 0 ) = 0 and getValue( 50 ) = 1
	 *
	 * @param min   - min (start) value
	 * @param max   - max( end ) value
