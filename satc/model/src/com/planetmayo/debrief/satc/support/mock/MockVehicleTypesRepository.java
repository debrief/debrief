...
public class MockVehicleTypesRepository implements VehicleTypesRepository
{
	...
	{
		return Arrays.asList(new VehicleType("UK Ferry", 12, 30, 400, 1600, 0.2,
				0.4, 0.2, 0.4), new VehicleType("Medium Tanker", 8, 15, 800, 2600, 1,
				3, 1, 3),
				new VehicleType("Large Tanker", 8, 12, 1400, 4600, 1, 3, 1, 3)
