...
{	
	...
	public void addContribution(BaseContribution contribution)
	{
		...
		for (PropertyChangeListener listener : listeners) 
		{
			if (listener instanceof PropertyChangeListenerProxy) 
			{
				...
				contribution.addPropertyChangeListener(proxy.getPropertyName(), (PropertyChangeListener) proxy.getListener());
			}
		}
	...
	public void removeContribution(BaseContribution contribution)
	{
		...
		for (PropertyChangeListener listener : listeners) 
		{
			...
			{
				PropertyChangeListenerProxy proxy = (PropertyChangeListenerProxy) listener;
				contribution.removePropertyChangeListener(proxy.getPropertyName(), (PropertyChangeListener) proxy.getListener());
			}
		}		
	...
	{
		// thread safety, if threads invoke addPropertyListener and addContribution concurrently
	...
	public void removePropertyListener(final String property,
			final PropertyChangeListener listener)
	{
		// thread safety, if threads invoke removePropertyListener and removeContribution concurrently
