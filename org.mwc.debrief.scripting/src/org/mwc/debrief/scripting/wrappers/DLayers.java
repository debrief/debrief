...
public class DLayers {
	 ...
	 */
	@WrapToScript
	public LightweightTrackWrapper findTrack(@ScriptParameter(defaultValue = "unset") final String name) {
	...
	public String[] getTrackNames() {
		...
		int ctr = 0;
		for (final LightweightTrackWrapper t : tracks) {
			res[ctr++] = t.getName();
		}
		return res;
	}
	...
	public LightweightTrackWrapper[] getTracks() {
		final ArrayList<LightweightTrackWrapper> items = new ArrayList<LightweightTrackWrapper>();
