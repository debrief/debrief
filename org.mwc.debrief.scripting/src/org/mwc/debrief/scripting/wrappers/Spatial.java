...
public class Spatial {
	...
	public static class TestSpatial extends TestCase {
		...
		public void testCreateDistance() {
			...
			assertEquals("Same units for WorldDistance", testInt, distance.getUnits());
			assertEquals("Same value for WorldDistance", testDouble, distance.getValueIn(testInt), 1e-5);
		}

		public void testCreateLocation() {
			final WorldLocation location = createLocation(testDouble, testDouble2, testDouble3);
			assertEquals("Same value for lattitude", testDouble, location.getLat(), 1e-5);
			assertEquals("Same value for longitud", testDouble2, location.getLong(), 1e-5);
			assertEquals("Same value for depth", testDouble3, location.getDepth(), 1e-5);
		}
		...
		public void testCreateWorldSpeed() {
			...
			assertEquals("Same value for worldSpeed", testDouble, worldSpeed.getValueIn(testInt), 1e-5);
		}
	}
	 ...
	 */
	@WrapToScript
	public static WorldArea createArea(final WorldLocation tl, final WorldLocation br) {
	 ...
	 */
	@WrapToScript
	public static WorldDistance createDistance(final double value, final int units) {
	 ...
	 */
	@WrapToScript
	public static WorldLocation createLocation(final double dLat, final double dLong, final double depth) {
	 ...
	 */
	@WrapToScript
	public static WorldVector createVector(final double distM, final double bearingDegs) {
	 ...
	 */
	@WrapToScript
	public static WorldVector createVectorKm(final double distKm, final double bearingDegs) {
		return new WorldVector(MWC.Algorithms.Conversions.Degs2Rads(bearingDegs),
