...
public class Annotations {
	...
	public static class TestAnnotations extends TestCase {
		...
		public void testCreateLabel() {
			final LabelWrapper label = createLabel(labelName, labelLocation, labelColor);
		...
		public void testCreateLabelDate() {
			final LabelWrapper label = createLabelDate(labelName, labelLocation, labelColor, startLabel, endLabel);
	 ...
	 * @param location Location of the label
	 * @param theColor Color of the label
	 * @return the new label. <br />
	 *         For autocomplete, use the following type <br />
	 *         // @type Debrief.Wrappers.LabelWrapper
	 */
	@WrapToScript
	public static LabelWrapper createLabel(final String name, final WorldLocation location,
	 ...
	 */
	@WrapToScript
	public static LabelWrapper createLabelDate(final String label, final WorldLocation location,
