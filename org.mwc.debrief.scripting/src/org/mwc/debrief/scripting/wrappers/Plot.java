...
public class Plot {
	...
	public WorldArea getArea() {
		if (_plot != null) {
			final PlainProjection proj = (PlainProjection) _plot.getAdapter(PlainProjection.class);
	...
	public DLayers getLayers() {
		if (_plot != null) {
			final MWC.GUI.Layers layers = (MWC.GUI.Layers) _plot.getAdapter(MWC.GUI.Layers.class);
			if (layers != null) {
	...
	public PlainProjection getMap() {
		if (_plot != null) {
			final PlainProjection map = (PlainProjection) _plot.getAdapter(PlainProjection.class);
			if (map != null) {
				return map;
			}
		}
	...
	public Outline getOutline() {
		if (_plot != null) {
			final IContentOutlinePage outline = (IContentOutlinePage) _plot.getAdapter(IContentOutlinePage.class);
			if (outline != null) {
	...
	public HiResDate getTime() {
		final TimeProvider time = (TimeProvider) _plot.getAdapter(TimeProvider.class);
		return time.getTime();
	}

	/**
	 * Method that returns the Time Control Preferences. This object can change the
	 * step intervals, small steps, etc.
	 * 
	...
	public TimeControlPreferences getTimeControlPreferences() {
		if (_plot != null) {
			final TimeControlPreferences timeControlPreferences = (TimeControlPreferences) _plot
	...
	public TimeManager getTimeManager() {
		if (_plot != null) {
			final TimeManager timeManager = (TimeManager) _plot.getAdapter(ControllableTime.class);
			if (timeManager != null) {
				return timeManager;
			}
		}
	...
	/**
	 * Method that returns the current period of time covered by the data on the
	 * plot
	 * 
	...
	public Tote getTote() {
		if (_plot != null) {
			final TrackManager trackManager = (TrackManager) _plot.getAdapter(TrackManager.class);
			if (trackManager != null) {
				final Tote answer = new Tote();
