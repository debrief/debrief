...
public class Chart {
	...
	/**
	 * Function that loads the Chart Library defined in the maritime preferences to
	 * the current plot.
	 */
	@WrapToScript
	...
	/**
	 * Method that load the natural earth from the path specified in the maritime
	 * preference section.
	 * 
