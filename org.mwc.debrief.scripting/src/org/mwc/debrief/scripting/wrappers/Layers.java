...
public class Layers {
	...
	public static class TestLayers extends TestCase {
		public void testFindItem() {
			...
			final ShapeWrapper lineShape = new ShapeWrapper("line", new LineShape(loc1, loc2), Color.red, null);
			final ShapeWrapper rectShape = new ShapeWrapper("rectangle", new RectangleShape(loc1, loc2), Color.red,
					null);
			...
			final FixWrapper newFix = new FixWrapper(new Fix(new HiResDate(100000), loc1, 0d, 0d));
			track.addFix(newFix);
			newFix.setName("fix");
