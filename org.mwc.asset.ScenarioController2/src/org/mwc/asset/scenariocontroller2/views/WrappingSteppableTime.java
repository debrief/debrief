...
public class WrappingSteppableTime implements SteppableTime, TimeProvider, ScenarioSteppedListener {
	 ...
	 * @param propertyType the (optional) property to listen to. Use null if you
	 *                     don't mind
	 */
	@Override
	 ...
	 * @param propertyType the (optional) property to stop listening to. Use null if
	 *                     you don't mind
	 */
	@Override
	 ...
	 * 
	 * @param scenario the scenario to watch
	 */
	 ...
	 * 
	 * @param origin - whoever is setting the time period (so that they can
	 *               optionally ignore changes they triggered)
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.mwc.cmap.core.DataTypes.Temporal.ControllableTime#setTime(java.lang
		...
		if (fireUpdate) {
			...
			if (_pSupport != null) {
				...
				for (int i = 0; i < theseListeners.length; i++) {
					...
					pcl.propertyChange(new PropertyChangeEvent(this, TIME_CHANGED_PROPERTY_NAME, oldTime, newDate));
				}
			}
		}
