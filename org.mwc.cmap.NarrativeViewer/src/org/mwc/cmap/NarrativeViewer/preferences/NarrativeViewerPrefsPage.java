...
public class NarrativeViewerPrefsPage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

	final private class MyFontFieldEditor extends FontFieldEditor {
		private Font prefFont;

		public MyFontFieldEditor(final String font, final String string, final Composite fieldEditorParent) {
		...
		public void setPropertyChangeListener(final IPropertyChangeListener listener) {
			super.setPropertyChangeListener(new IPropertyChangeListener() {
				...
				public void propertyChange(final PropertyChangeEvent event) {
					...
					final FontData[] readFontData = new FontData[] { (FontData) event.getNewValue() };
		...
		protected void updatePreview() {
			...
			final FontData[] readFontData = PreferenceConverter.readFontData(CorePlugin.getDefault()
					.getPreferenceStore().getString(NarrativeViewerPrefsPage.PreferenceConstants.FONT));
	...
	public void createFieldEditors() {
		addField(new StringFieldEditor(PreferenceConstants.HIGHLIGHT_PHRASES, "&Words/phrases:",
				getFieldEditorParent()));

		final FontFieldEditor fontEditor = new MyFontFieldEditor(PreferenceConstants.FONT, "Font:",
				getFieldEditorParent());
		...
		previewText = new Text(getFieldEditorParent(), SWT.BORDER | SWT.MULTI | SWT.WRAP);
