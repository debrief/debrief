...
public abstract class FilteredGrid extends Composite
{
  ...
  /**
   * The viewer for the filtered grid. This value should never be <code>null</code> after the widget
   ...
   * {@link #doCreateGridViewer(Composite, int)} to create the grid viewer. Subclasses should
   * override {@link #doCreateGridViewer(Composite, int)} instead of overriding this method.
   * 
   * @param parent
      ...
      public IStatus runInUIThread(IProgressMonitor monitor)
      {
        ...
        Display.getDefault().asyncExec(new Runnable()
        {
          ...
          public void run()
          {
            ...
            Control redrawFalseControl =
                gridComposite != null ? gridComposite : gridViewer.getControl();
            try
            {
