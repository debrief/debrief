...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.mwc.asset.NetAsset2"; //$NON-NLS-1$
	...
	public static void logError(final int severity, final String message, final Throwable exception) {
		final Activator singleton = plugin;
		if (singleton != null) {
			final Status stat = new Status(severity, "org.mwc.asset.netasset", IStatus.OK, message, exception);
