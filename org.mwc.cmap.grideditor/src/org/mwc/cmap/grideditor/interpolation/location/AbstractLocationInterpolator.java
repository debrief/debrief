...
public abstract class AbstractLocationInterpolator implements ItemsInterpolator {
	...
	/*
	 * private static LinearInterpolator createWorker(TimeStampedDataItem
	 * startPoint, TimeStampedDataItem endPoint, GriddableItemDescriptor descriptor)
	 * { if (startMillis == endMillis) { return null; }
	 *
	 * double startValue = getDoubleValue(startPoint, descriptor); double endValue =
	 * getDoubleValue(endPoint, descriptor);
	 *
	 * return }
	 *
	 */
	...
	public AbstractLocationInterpolator(final GriddableItemDescriptor descriptor,
