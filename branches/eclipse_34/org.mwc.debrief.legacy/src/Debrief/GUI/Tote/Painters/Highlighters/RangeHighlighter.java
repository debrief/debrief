...
public final class RangeHighlighter implements PlotHighlighter {
                              ...
                              final CanvasType dest)
  {
    ...
    final WorldLocation worldEdge = worldCentre.add(new WorldVector(MWC.Algorithms.Conversions.Degs2Rads(rawAxis), MWC.Algorithms.Conversions.Yds2Degs(worldRadius), 0));
    ...
    // right, only draw the heading spoke if our spoke_separation is greater than zero
    ...
    /** NOTE we only draw the stalks if we are NOT drawing arcs
     *  of 180 degrees either side (since in that case drawing it twice effectively hides it
     */
