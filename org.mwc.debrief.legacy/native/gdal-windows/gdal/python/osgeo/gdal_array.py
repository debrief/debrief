...
def OpenMultiDimensionalNumPyArray(*args):
  """OpenMultiDimensionalNumPyArray(PyArrayObject psArray) -> Dataset"""
  return _gdal_array.OpenMultiDimensionalNumPyArray(*args)
OpenMultiDimensionalNumPyArray = _gdal_array.OpenMultiDimensionalNumPyArray
...
def DatasetIONumPy(*args, **kwargs):
  """
    DatasetIONumPy(Dataset ds, int bWrite, int xoff, int yoff, int xsize, 
        ...
        bool binterleave = True) -> CPLErr
    """
  return _gdal_array.DatasetIONumPy(*args, **kwargs)
DatasetIONumPy = _gdal_array.DatasetIONumPy

def MDArrayIONumPy(*args):
  """
    MDArrayIONumPy(bool bWrite, GDALMDArrayHS mdarray, PyArrayObject psArray, 
        int nDims1, int nDims3, GDALExtendedDataTypeHS buffer_datatype) -> CPLErr
    """
  return _gdal_array.MDArrayIONumPy(*args)
MDArrayIONumPy = _gdal_array.MDArrayIONumPy
