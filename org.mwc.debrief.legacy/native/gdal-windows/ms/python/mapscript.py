...
class CompositingFilter(_object):
    """Proxy of C CompositingFilter struct"""
    __swig_setmethods__ = {}
    ...
    if _newclass:filter = _swig_property(_mapscript.CompositingFilter_filter_get, _mapscript.CompositingFilter_filter_set)
    ...
    if _newclass:next = _swig_property(_mapscript.CompositingFilter_next_get, _mapscript.CompositingFilter_next_set)
    def __init__(self): 
...
class LayerCompositer(_object):
    """Proxy of C LayerCompositer struct"""
    __swig_setmethods__ = {}
    ...
    if _newclass:comp_op = _swig_property(_mapscript.LayerCompositer_comp_op_get, _mapscript.LayerCompositer_comp_op_set)
    ...
    if _newclass:opacity = _swig_property(_mapscript.LayerCompositer_opacity_get, _mapscript.LayerCompositer_opacity_set)
    ...
    if _newclass:filter = _swig_property(_mapscript.LayerCompositer_filter_get, _mapscript.LayerCompositer_filter_set)
    __swig_setmethods__["next"] = _mapscript.LayerCompositer_next_set
    __swig_getmethods__["next"] = _mapscript.LayerCompositer_next_get
    if _newclass:next = _swig_property(_mapscript.LayerCompositer_next_get, _mapscript.LayerCompositer_next_set)
    def __init__(self): 
...
class outputFormatObj(_object):
    """Proxy of C outputFormatObj struct"""
    __swig_setmethods__ = {}
...
class styleObj(_object):
    ...
    if _newclass:symbolname = _swig_property(_mapscript.styleObj_symbolname_get)
    ...
    if _newclass:patternlength = _swig_property(_mapscript.styleObj_patternlength_get)
    ...
    __swig_setmethods__["sizeunits"] = _mapscript.styleObj_sizeunits_set
    __swig_getmethods__["sizeunits"] = _mapscript.styleObj_sizeunits_get
    if _newclass:sizeunits = _swig_property(_mapscript.styleObj_sizeunits_get, _mapscript.styleObj_sizeunits_set)
    ...
    def pattern_set(self, *args): return _mapscript.styleObj_pattern_set(self, *args)
    def pattern_get(self): return _mapscript.styleObj_pattern_get(self)
...
class labelLeaderObj(_object):
    """Proxy of C labelLeaderObj struct"""
    __swig_setmethods__ = {}
...
class labelObj(_object):
    ...
    __swig_setmethods__["sizeunits"] = _mapscript.labelObj_sizeunits_set
    __swig_getmethods__["sizeunits"] = _mapscript.labelObj_sizeunits_get
    if _newclass:sizeunits = _swig_property(_mapscript.labelObj_sizeunits_get, _mapscript.labelObj_sizeunits_set)
    def __init__(self): 
...
class classObj(_object):
    ...
    if _newclass:numlabels = _swig_property(_mapscript.classObj_numlabels_get)
    ...
    if _newclass:leader = _swig_property(_mapscript.classObj_leader_get)
    ...
    __swig_setmethods__["isfallback"] = _mapscript.classObj_isfallback_set
    __swig_getmethods__["isfallback"] = _mapscript.classObj_isfallback_get
    if _newclass:isfallback = _swig_property(_mapscript.classObj_isfallback_get, _mapscript.classObj_isfallback_set)
    ...
    __swig_setmethods__["sizeunits"] = _mapscript.classObj_sizeunits_set
    __swig_getmethods__["sizeunits"] = _mapscript.classObj_sizeunits_get
    if _newclass:sizeunits = _swig_property(_mapscript.classObj_sizeunits_get, _mapscript.classObj_sizeunits_set)
...
class labelCacheMemberObj(_object):
    """Proxy of C labelCacheMemberObj struct"""
    __swig_setmethods__ = {}
    ...
    if _newclass:textsymbols = _swig_property(_mapscript.labelCacheMemberObj_textsymbols_get)
    __swig_getmethods__["numtextsymbols"] = _mapscript.labelCacheMemberObj_numtextsymbols_get
    if _newclass:numtextsymbols = _swig_property(_mapscript.labelCacheMemberObj_numtextsymbols_get)
    ...
    if _newclass:bbox = _swig_property(_mapscript.labelCacheMemberObj_bbox_get)
...
class markerCacheMemberObj(_object):
    """Proxy of C markerCacheMemberObj struct"""
    __swig_setmethods__ = {}
    ...
    if _newclass:bounds = _swig_property(_mapscript.markerCacheMemberObj_bounds_get)
    def __init__(self): 
...
class labelCacheSlotObj(_object):
    """Proxy of C labelCacheSlotObj struct"""
    __swig_setmethods__ = {}
...
class labelCacheObj(_object):
    """Proxy of C labelCacheObj struct"""
    __swig_setmethods__ = {}
    ...
    if _newclass:rendered_text_symbols = _swig_property(_mapscript.labelCacheObj_rendered_text_symbols_get)
    __swig_getmethods__["num_allocated_rendered_members"] = _mapscript.labelCacheObj_num_allocated_rendered_members_get
    if _newclass:num_allocated_rendered_members = _swig_property(_mapscript.labelCacheObj_num_allocated_rendered_members_get)
    __swig_getmethods__["num_rendered_members"] = _mapscript.labelCacheObj_num_rendered_members_get
    if _newclass:num_rendered_members = _swig_property(_mapscript.labelCacheObj_num_rendered_members_get)
...
class resultCacheObj(_object):
    """Proxy of C resultCacheObj struct"""
    __swig_setmethods__ = {}
...
class symbolSetObj(_object):
    """Proxy of C symbolSetObj struct"""
    __swig_setmethods__ = {}
...
class referenceMapObj(_object):
    """Proxy of C referenceMapObj struct"""
    __swig_setmethods__ = {}
...
class scalebarObj(_object):
    ...
    if _newclass:offsetx = _swig_property(_mapscript.scalebarObj_offsetx_get, _mapscript.scalebarObj_offsetx_set)
    ...
    if _newclass:offsety = _swig_property(_mapscript.scalebarObj_offsety_get, _mapscript.scalebarObj_offsety_set)
...
class scaleTokenEntryObj(_object):
    """Proxy of C scaleTokenEntryObj struct"""
    __swig_setmethods__ = {}
...
class scaleTokenObj(_object):
    """Proxy of C scaleTokenObj struct"""
    __swig_setmethods__ = {}
...
class layerObj(_object):
    ...
    __swig_setmethods__["rendermode"] = _mapscript.layerObj_rendermode_set
    __swig_getmethods__["rendermode"] = _mapscript.layerObj_rendermode_get
    if _newclass:rendermode = _swig_property(_mapscript.layerObj_rendermode_get, _mapscript.layerObj_rendermode_set)
    ...
    if _newclass:utfitem = _swig_property(_mapscript.layerObj_utfitem_get, _mapscript.layerObj_utfitem_set)
    ...
    if _newclass:utfitemindex = _swig_property(_mapscript.layerObj_utfitemindex_get, _mapscript.layerObj_utfitemindex_set)
    __swig_setmethods__["utfdata"] = _mapscript.layerObj_utfdata_set
    __swig_getmethods__["utfdata"] = _mapscript.layerObj_utfdata_get
    if _newclass:utfdata = _swig_property(_mapscript.layerObj_utfdata_get, _mapscript.layerObj_utfdata_set)
    ...
    if _newclass:compositer = _swig_property(_mapscript.layerObj_compositer_get, _mapscript.layerObj_compositer_set)
    ...
    if _newclass:connectionoptions = _swig_property(_mapscript.layerObj_connectionoptions_get, _mapscript.layerObj_connectionoptions_set)
    ...
    def setOpacity(self, *args): return _mapscript.layerObj_setOpacity(self, *args)
    def getOpacity(self): return _mapscript.layerObj_getOpacity(self)
    ...
    def getItemType(self, *args): return _mapscript.layerObj_getItemType(self, *args)
...
class mapObj(_object):
    ...
    __swig_setmethods__["sldurl"] = _mapscript.mapObj_sldurl_set
    __swig_getmethods__["sldurl"] = _mapscript.mapObj_sldurl_get
    if _newclass:sldurl = _swig_property(_mapscript.mapObj_sldurl_get, _mapscript.mapObj_sldurl_set)
    ...
    def pixelToGeoref(self, *args): return _mapscript.mapObj_pixelToGeoref(self, *args)
    def getRotation(self): return _mapscript.mapObj_getRotation(self)
    ...
    def generateSLD(self, sldVersion = None): return _mapscript.mapObj_generateSLD(self, sldVersion)
    ...
    def applyDefaultSubstitutions(self): return _mapscript.mapObj_applyDefaultSubstitutions(self)
    def applySubstitutions(self, *args): return _mapscript.mapObj_applySubstitutions(self, *args)
...
def msSaveImage(*args):
  """msSaveImage(mapObj map, imageObj img, char filename) -> int"""
  return _mapscript.msSaveImage(*args)

def msFreeImage(*args):
  """msFreeImage(imageObj img)"""
...
def msLoadMapFromString(*args):
  """msLoadMapFromString(char buffer, char new_mappath) -> mapObj"""
...
class shapeObj(_object):
    ...
    def buffer(self, *args):
        """See :ref:`MAXDISTANCE <mapfile-class-buffer>`"""
        return _mapscript.shapeObj_buffer(self, *args)
...
class shapefileObj(_object):
    """Proxy of C shapefileObj struct"""
    __swig_setmethods__ = {}
...
class projectionObj(_object):
    """Proxy of C projectionObj struct"""
    __swig_setmethods__ = {}
...
class hashTableObj(_object):
    """Proxy of C hashTableObj struct"""
    __swig_setmethods__ = {}
...
class errorObj(_object):
    ...
    if _newclass:errorcount = _swig_property(_mapscript.errorObj_errorcount_get, _mapscript.errorObj_errorcount_set)
    def __init__(self): 
...
def msGetErrorString(*args):
  """msGetErrorString(char delimiter) -> char"""
