...
public class ImportNisida {
	...
	public static class NisidaLoadState {
		...
		public void setErrors(final List<ImportNisidaError> errors) {
			this.errors = errors;
		}

		public void setLastEntryWithText(final Object lastEntryWithText) {
		...
		public void setPlatform(final TrackWrapper platform) {
	 ...
	 */
	public static Double parseDegrees(final String value, final NisidaLoadState status) {
		try {
	...
	private static void processPosition(final String[] tokens, final NisidaLoadState status) {
		...
		if (dtg != null && latVal != null && longVal != null) {
			...
			final Fix fix = new Fix(dtg, location, 0d, 0d);
			if (courseVal != null) {
