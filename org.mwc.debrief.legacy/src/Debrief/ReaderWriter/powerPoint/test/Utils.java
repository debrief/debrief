...
public class Utils
{
   ...
   * @throws IOException
   */
  public static final void assertZipEquals(String archive1, String archive2)
   ...
   * @throws IOException
   */
  private static final HashMap<String, ZipEntry> getMembers(ZipFile archive)
      throws IOException
  {
  ...
  private static final void assertMembersEqual(ZipFile zip1,
      HashMap<String, ZipEntry> files1, ZipFile zip2,
      HashMap<String, ZipEntry> files2) throws IOException
  {
    if (files1.size() != files2.size())
    {
      fail("Different Sizes, expected " + Integer.toString(files1.size())
          + " found " + Integer.toString(files2.size()));
    }
