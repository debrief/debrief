...
public final class SwingImportRangeData extends ImportRangeDataPanel {
	...
	static final class TimeFrequencyCombo extends JComboBox {
		...
		private final String[] stringTags = { "1 Sec", "5 Secs", "10 Secs", "15 Secs", "30 Secs", "1 Min", "5 Mins",
				"10 Mins", "15 Mins", "30 Mins", "60 Mins", "None" };

		private final long[] freqs = { 1, 5, 10, 15, 30, 60, 5 * 60, 10 * 60, 15 * 60, 30 * 60, 60 * 60, 0 };
	...
	// constructor
	//////////////////////////////////
	public SwingImportRangeData(final Layers theData, final String lastDirectory, final PropertiesPanel thePanel) {
	...
	synchronized void checkDTG() {
		try {
			...
			MWC.GUI.Dialogs.DialogFactory.showMessage("Date Format Error",
					"Sorry, date incorrectly formatted (2001/1/21)");
		}
	}
