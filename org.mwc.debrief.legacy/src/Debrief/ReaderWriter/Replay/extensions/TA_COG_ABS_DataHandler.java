...
public class TA_COG_ABS_DataHandler extends Core_TA_Handler {
	...
	public Object readThisLine(final String theLine) throws ParseException {
		// should look like:
		// ;TA_COG_ABS: 100112 120230 SENSOR TA_ARRAY 60.187961627128395
		// 0.2243122833234192 19.02
		...
		if (isNull(dLatStr) || isNull(dLongStr) || isNull(dDepthStr)) {
			...
			storeMeasurement2D(platform_name, sensor_name, CENTRE_OF_GRAVITY, "LatLong", "\u00b0", theDate, "Lat",
					"Long", dLat, dLong);
