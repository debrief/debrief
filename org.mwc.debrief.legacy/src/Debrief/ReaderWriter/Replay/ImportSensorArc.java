...
final class ImportSensorArc extends AbstractPlainLineImporter
{
  ...
  private int addValue(final List<String> myTokens,
      final List<DynamicShape> values, int index) throws ParseException
  {
    ...
    final DynamicShape value = new DynamicCoverageShape(minAngleDegs,
  ...
  public final String exportThis(final MWC.GUI.Plottable theWrapper)
  {
    ...
    {
      builder.append(MWC.Utilities.TextFormatting.DebriefFormatDateTime
          .toStringHiRes(sacw.getStartDTG()));
    }
    builder.append(" ");
  ...
  public final Object readThisLine(final String theLine)
  {
    ...
    // ;SENSORARC 951212 062800 951212 063000 NELSON @@ -75 35 0 1000 "fwd dynamic"
    // ;SENSORARC YYMMDD HHMMSS.SSS YYMMDD HHMMSS.SSS TRACKNAME SYMBOLOGY LEFT RIGHT INNER OUTER
    ...
    try
    {
      ...
      final DynamicTrackShapeWrapper data = new DynamicTrackCoverageWrapper(
          theTrack, startDtg, endDtg, values, theColor, theStyle, sensorName);
    ...
    {
      MWC.Utilities.Errors.Trace.trace(pe, "Whilst import sensor arc: "
          + theLine);
      return null;
    }
  }
