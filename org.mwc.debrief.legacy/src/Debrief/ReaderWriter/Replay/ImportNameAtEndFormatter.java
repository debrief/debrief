...
final class ImportNameAtEndFormatter extends AbstractPlainLineImporter
{
  ...
  public final Object readThisLine(final String theLine)
  {
    ...
    PlainWrapper cif = new TrackNameAtEndFormatListener(formatName, names);
  ...
  public static class TestMe extends TestCase
  {
    ...
    public void testRead()
    {
      ...
      ImportNameAtEndFormatter iff = new ImportNameAtEndFormatter();
      TrackNameAtEndFormatListener res =
          (TrackNameAtEndFormatListener) iff
      ...
      res =
          (TrackNameAtEndFormatListener) iff
              .readThisLine(";FORMAT_TRACK_NAME_AT_END: end ");
      assertNotNull(res);
      assertEquals("has correct name", "end", res.getName());
