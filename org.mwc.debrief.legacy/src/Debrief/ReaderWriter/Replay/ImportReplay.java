...
public class ImportReplay extends PlainImporterBase
{
  ...
  private final void importRep(final String fName, final InputStream is,
      final int numLines, final MonitorProvider provider)
  {
    // declare linecounter
    int lineCounter = 0;
    final Reader reader;
    ...
    catch (final java.lang.NumberFormatException e)
    {
      ...
      handleException(e, lineCounter, thisLine, fName, "Number format error:"
          + e);
      throw new PlainImporter.ImportException(null, null);
    }
    catch (final IOException e)
    {
      handleException(e, lineCounter, thisLine, fName, "Unknown read error:"
          + e);
      throw new PlainImporter.ImportException(null, null);
    }
    ...
    else if (thisObject instanceof PlanningSegment)
    {
      ...
      if (track == null)
      {
        Application.logError2(ToolParent.INFO,
            "Failed to find track origin for planning segment. Track titled:"
                + trackName, null);
      }
      else
      {
        ...
        {
          Application.logError2(ToolParent.INFO,
              "Track for this leg isn't planning leg. Track titled:"
                  + trackName, null);
        }
      }
    }
