...
abstract public class FixHandler extends MWCXMLReader {
	...
	public static void exportFix(final FixWrapper fix, final Element parent, final Document doc) {
		/*
		 * <!ELEMENT fix (colour?, centre)> <!ATTLIST fix course CDATA #REQUIRED speed
		 * CDATA #REQUIRED dtg CDATA #REQUIRED visible (TRUE|FALSE) "TRUE" label CDATA
		 * #IMPLIED LabelShowing (TRUE|FALSE) #IMPLIED SymbolShowing (TRUE|FALSE) "TRUE"
