...
abstract public class SensorContactHandler extends MWC.Utilities.ReaderWriter.XML.MWCXMLReader {
	 ...
	 * class which contains list of textual representations of label locations
	 */
	private static final LineLocationPropertyEditor ll = new LineLocationPropertyEditor();

	/**
	 * class which contains list of textual representations of label locations
	 */
	private static final LineStylePropertyEditor ls = new LineStylePropertyEditor();
	 ...
	 */
	public static void exportFix(final Debrief.Wrappers.SensorContactWrapper contact, final org.w3c.dom.Element parent,
	...
	public static void exportFix(final String typeName, final Debrief.Wrappers.SensorContactWrapper contact,
		...
		/*
		 *
		 * Dtg CDATA #REQUIRED Track CDATA #REQUIRED Bearing CDATA #REQUIRED Range CDATA
		 * #REQUIRED Visible (TRUE|FALSE) "TRUE" Label CDATA #REQUIRED LabelShowing
		 * (TRUE|FALSE) "TRUE" LabelLocation (Top|Left|Bottom|Centre|Right) "Left"
		 * LineStyle (SOLID|DOTTED|DOT_DASH|SHORT_DASHES|LONG_DASHES|UNCONNECTED)
		 * "SOLID"
		 */
