...
public abstract class LightweightTrackHandler extends MWC.Utilities.ReaderWriter.XML.MWCXMLReader
	...
	public void elementClosed() {
		...
		final LightweightTrackWrapper track = new LightweightTrackWrapper(_name, _visible, _nameVisible, _color,
				_lineStyle);
	...
	public void exportThisPlottable(final Plottable plottable, final Element parent, final Document doc) {
		final LightweightTrackWrapper track = (LightweightTrackWrapper) plottable;
		...
		while (allItems.hasNext()) {
			final FixWrapper next = allItems.next();
