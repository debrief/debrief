    ...
    MWC.Utilities.ReaderWriter.XML.MWCXMLReader
{
   ...
   */
  static final MWC.GUI.Properties.LocationPropertyEditor labelLocation =
      new MWC.GUI.Properties.LocationPropertyEditor();

  /**
   * class which contains list of textual representations of label locations
   */
  static final MWC.GUI.Properties.LineStylePropertyEditor lineStyle =
  ...
  public static void exportFix(final String typeName,
      final DynamicTrackShapeWrapper contact, final org.w3c.dom.Element parent,
