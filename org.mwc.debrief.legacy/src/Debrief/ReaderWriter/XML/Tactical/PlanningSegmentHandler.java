...
abstract public class PlanningSegmentHandler extends MWC.Utilities.ReaderWriter.XML.MWCXMLReader {
	...
	public static Element exportThisSegment(final org.w3c.dom.Document doc, final Element trk,
			final PlanningSegment seg) {
		return exportThisSegment(doc, trk, seg, PLANNING_SEGMENT);
	}

	public static Element exportThisSegment(final org.w3c.dom.Document doc, final Element trk,
			final PlanningSegment seg, final String segName) {
		final PlanningSegment ps = seg;
