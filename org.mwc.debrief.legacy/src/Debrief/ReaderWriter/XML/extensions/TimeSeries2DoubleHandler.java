...
abstract public class TimeSeries2DoubleHandler extends MWC.Utilities.ReaderWriter.XML.MWCXMLReader {
	...
	public static void exportThisDataset(final TimeSeriesDatasetDouble2 dataset, final Element parent,
			final Document doc) {
	...
	public final void elementClosed() {
		...
		final double[] values1 = new double[_values1.size()];
		final double[] values2 = new double[_values2.size()];
		...
		// create the dataset
		final TimeSeriesDatasetDouble2 dataset = new TimeSeriesDatasetDouble2(_name, _units, _value1Name, _value2Name,
