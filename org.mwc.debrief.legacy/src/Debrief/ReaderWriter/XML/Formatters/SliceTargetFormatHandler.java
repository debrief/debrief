...
public abstract class SliceTargetFormatHandler extends MWC.Utilities.ReaderWriter.XML.MWCXMLReader {
	...
	static public void exportThisPlottable(final MWC.GUI.Plottable plottable, final org.w3c.dom.Element parent,
		...
		final SliceTrackFormatListener theShape = (SliceTrackFormatListener) plottable;
	...
	public void elementClosed() {
		// create the object
		final SliceTrackFormatListener listener = new SliceTrackFormatListener(fName, interval, track_names);
