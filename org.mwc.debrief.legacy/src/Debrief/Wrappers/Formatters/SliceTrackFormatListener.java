    ...
    INewItemListener
{
  ...
  public static class TestMe extends TestCase
  {
    ...
    private void processFix(final INewItemListener cf, final TrackWrapper tw,
        final int time)
    {
    ...
    public void testNoNames()
    {
      ...
      final INewItemListener cf = new SliceTrackFormatListener("Test", 1000L,
          names);
    ...
    final public PropertyDescriptor[] getPropertyDescriptors()
    {
      try
      {
        ...
        {displayProp("Name", "Name", "Name for this formatter"), displayProp(
            "Interval", "Interval", "Interval to split on"), displayProp(
