...
public class DynamicShapeWrapper extends ShapeWrapper implements IDynamicShapeWrapper {
	...
	public DynamicShapeWrapper(final String label, final PlainShape theShape, final Color theColor,
			final HiResDate theDate, final String name) {
	...
	public int compareTo(final Plottable o) {
		...
		if (o == this) {
			...
			final ShapeWrapper shape = (ShapeWrapper) o;
	...
	@Override
	public void setTrackName(final String theTrackName) {
