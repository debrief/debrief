...
/**
 * interface for class that is able to provide the an additional value for
 * specified time stams to help with styling, plus an accessor to find out if
 * that styling should be applied
 *
 * @author ian
 *
 */
