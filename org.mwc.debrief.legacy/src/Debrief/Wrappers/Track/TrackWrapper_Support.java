...
public class TrackWrapper_Support {
	 ...
	 * @author ian.mayo
	 */
	abstract public static class BaseItemLayer extends Plottables implements Layer, SupportsPropertyListeners {
	...
	public interface FixSetter {
		 ...
		 *
		 * @param fix subject of operation
		 * @param val yes/no value to apply
		 */
	...
	final public static class SegmentList extends BaseItemLayer {
		...
		public final class SegmentInfo extends Editable.EditorType {
			...
			public final MethodDescriptor[] getMethodDescriptors() {
				...
				MethodDescriptor[] mds = { method(c, "mergeAllSegments", null, "Merge all track segments"),
				...
				if (oldMeds != null) {
					final MethodDescriptor resMeds[] = new MethodDescriptor[mds.length + oldMeds.length];
	...
	public static List<TrackSegment> splitTrackAtJumps(final TrackWrapper track, final long interval) {
