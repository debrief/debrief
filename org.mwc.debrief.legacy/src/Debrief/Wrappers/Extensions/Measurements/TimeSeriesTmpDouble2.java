...
public class TimeSeriesTmpDouble2 extends TimeSeriesTmpCore {
	...
	public TimeSeriesTmpDouble2(final String name, final String units, final String value1Name,
	...
	public void add(final Long index, final Double value1, final Double value2) {
		_indices.add(index);
		_values1.add(value1);
		_values2.add(value2);
	}
