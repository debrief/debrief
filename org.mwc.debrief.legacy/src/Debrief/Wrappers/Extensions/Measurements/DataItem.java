...
/**
 * in our temporary data structures we allow a folder to contain both dataset
 * and other folders. This API is common to both
 *
 * @author ian
 *
 */
public interface DataItem {
	...
	/**
	 * for diagnostics - list the contents of this item
	 */
