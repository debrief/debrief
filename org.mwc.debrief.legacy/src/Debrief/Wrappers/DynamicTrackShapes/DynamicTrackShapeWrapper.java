...
abstract public class DynamicTrackShapeWrapper extends PlainWrapper
		implements Editable.DoNotHighlightMe, ExcludeFromRightClickEdit {
	...
	public static interface DynamicShape extends java.io.Serializable {
		 ...
		 */
		public void paint(CanvasType dest, Color color, boolean semiTransparent, WorldLocation location,
				double courseDegs, boolean filled);
			...
			try {
				final PropertyDescriptor[] res = {
						...
						displayProp("SemiTransparent", "Semi transparent",
								"whether to make the coverage semi-transparent", FORMAT),
	...
	public DynamicTrackShapeWrapper(final String theTrack, final HiResDate startDtg, final HiResDate endDtg,
	 ...
	 * @param keep_simple whether to allow a change in line styles
	 */
