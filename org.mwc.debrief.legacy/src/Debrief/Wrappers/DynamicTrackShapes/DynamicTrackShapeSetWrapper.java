...
public class DynamicTrackShapeSetWrapper extends BaseLayer implements Cloneable, DynamicPlottable, WatchableList {
	// //////////////////////////////////////////////////////////////////////////
	...
	public final class SensorInfo extends Editable.EditorType {
		...
		public final PropertyDescriptor[] getPropertyDescriptors() {
			try {
				final PropertyDescriptor[] res = { prop("Name", "the name for this sensor"),
	...
	// {
	// final DynamicTrackShapeSetWrapper other = (DynamicTrackShapeSetWrapper)
	// theLayer;
	//
	...
	public final void add(final MWC.GUI.Editable plottable) {
		...
		if (plottable instanceof DynamicTrackShapeWrapper) {
			...
			if (_timePeriod == null) {
				_timePeriod = new MWC.GenericData.TimePeriod.BaseTimePeriod(scw.getStartDTG(), scw.getEndDTG());
			} else {
	...
	public void paint(final CanvasType dest) {
		...
		MWC.Utilities.Errors.Trace.trace("Sensor Arc Wrapper paint() should not be called!");
	}
	...
	public void paintOverride(final CanvasType canvas, final long time, final WorldLocation origin,
		...
		while (it.hasMoreElements()) {
			final DynamicTrackShapeWrapper con = (DynamicTrackShapeWrapper) it.nextElement();
