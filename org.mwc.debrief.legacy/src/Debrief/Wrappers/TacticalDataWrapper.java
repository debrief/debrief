    ...
    implements MWC.GUI.Layer, SnailDrawTacticalContact.HostedList, HasEditables
{
  ...
  /**
   * a specialist linear interpolator class that allows quick (repeated) interpolations for a set of
   * similar items
   * 
   * @author ianmayo
   * 
  ...
  {
    final Vector<PlottableWrapperWithTimeAndOverrideableColor> newItems =
        new Vector<PlottableWrapperWithTimeAndOverrideableColor>();
    ...
    PlottableWrapperWithTimeAndOverrideableColor _last =
        (PlottableWrapperWithTimeAndOverrideableColor) _cuts.nextElement();
    ...
    PlottableWrapperWithTimeAndOverrideableColor _next =
        (PlottableWrapperWithTimeAndOverrideableColor) _cuts.nextElement();
    ...
    for (final Iterator<PlottableWrapperWithTimeAndOverrideableColor> iterator =
        newItems.iterator(); iterator.hasNext();)
    {
  ...
  public final void filterListTo(final HiResDate start, final HiResDate end)
  {
    ...
    while (contactWrappers.hasNext())
    {
      ...
      /**
       * note, we had trouble with unpredicable behaviour when testing this one. We overcame the
       * problem by initialising the dates in the two Gregorian calendars.
       */
      final PlottableWrapperWithTimeAndOverrideableColor fw =
          (PlottableWrapperWithTimeAndOverrideableColor) contactWrappers.next();
      ...
      final HiResDate start, final HiResDate end)
  {
    ...
    while ((it.hasNext()) && (!finished))
    {
      final PlottableWrapperWithTimeAndOverrideableColor scw =
          (PlottableWrapperWithTimeAndOverrideableColor) it.next();
  ...
  public final void paint(final MWC.GUI.CanvasType canvas)
  {
    ...
    while (it.hasNext())
    {
      ...
      final PlottableWrapperWithTimeAndOverrideableColor con =
          (PlottableWrapperWithTimeAndOverrideableColor) next;
  ...
  /**
   * how far away are we from this point? or return -1 if it can't be calculated We don't search
   * through our child objects, the searching algorithms do that for themselves, since we are a
   * layer
   */
  @Override
  ...
  public void setVisibleFrequency(final HiResDate visibleFrequency)
  {
    ...
    setFixes(new ObjectManipulator()
    {
      ...
      {
        final PlottableWrapperWithTimeAndOverrideableColor pl =
            (PlottableWrapperWithTimeAndOverrideableColor) subject;
        pl.setVisible(value);
      }
    }, visibleFrequency);
  ...
  public void trimTo(TimePeriod period)
  {
    ...
    while (iter.hasNext())
    {
      PlottableWrapperWithTimeAndOverrideableColor thisE =
          (PlottableWrapperWithTimeAndOverrideableColor) iter.next();
