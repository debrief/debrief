...
public final class FieldBuilder extends PatternBuilderType {
		...
		public final PropertyDescriptor[] getPropertyDescriptors() {
			try {
				final PropertyDescriptor[] myRes = {
						...
						displayProp("PatternRowSpacing", "Pattern row spacing",
								"the spacing between each row of buoys "),
						...
						displayProp("PatternOrientation", "Pattern orientation",
								"the orientation of the pattern (degs)"),
						...
						displayProp("JigPoint", "Jig point", "the jig point for the construction of this pattern"),
	...
	public static final class OffsetPropertyEditor extends PropertyEditorSupport {
		...
		public final String[] getTags() {
			final String tags[] = { "Left", "Right", "Centre" };
			return tags;
		}
	...
	// Constructor
	// ////////////////////////////////////////
	public FieldBuilder(final WorldLocation centre, final MWC.GUI.Properties.PropertiesPanel thePanel,
	...
	protected final void addBuoys(final Debrief.Wrappers.BuoyPatternWrapper pattern) {
		...
		final WorldVector along_step = new MWC.GenericData.WorldVector(orient_rads, buoy_spacing_degs, 0);
		...
		final WorldVector across_step = new MWC.GenericData.WorldVector(
		...
		final WorldVector normal_offset = new MWC.GenericData.WorldVector(normal_row, half_step, 0.0);
		final WorldVector back_offset = new MWC.GenericData.WorldVector(back_row, half_step, 0.0);
		...
		for (int i = 0; i < num_buoys; i++) {
			...
			final Debrief.Wrappers.LabelWrapper lw = new Debrief.Wrappers.LabelWrapper("F" + (i + 1), lastPoint,
