	...
	public final java.awt.Rectangle drawMe(final MWC.Algorithms.PlainProjection proj, final java.awt.Graphics dest,
		...
		if (_theTote != null) {
			...
			if (highlighter instanceof RectangleHighlight) {
				...
				// Are we using the symbol highlighter?? I think not, let's add this just in
				// case. Saul
		...
		if (screenPos != null) {
			...
			final java.awt.Rectangle dotsArea = _trackPlotter.drawMe(proj, dest, watch, parent, watch.getTime(), fader);
