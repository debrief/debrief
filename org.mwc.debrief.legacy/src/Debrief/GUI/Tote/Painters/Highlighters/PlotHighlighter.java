...
public interface PlotHighlighter extends Editable {
	...
	public final class RectangleHighlight implements PlotHighlighter {
		...
		public final void highlightIt(final MWC.Algorithms.PlainProjection proj, final java.awt.Graphics dest,
				final MWC.GenericData.WatchableList list, final MWC.GenericData.Watchable watch,
			...
			try {
				if (dest != null && watch != null && proj != null) {
					...
					/*
					 * dest.setColor(new Color(255 - _myColor.getRed(), 255 - _myColor.getGreen(),
					 * 255 - _myColor.getBlue()));
					 */
	 ...
	 */
	void highlightIt(final MWC.Algorithms.PlainProjection proj, final java.awt.Graphics dest,
