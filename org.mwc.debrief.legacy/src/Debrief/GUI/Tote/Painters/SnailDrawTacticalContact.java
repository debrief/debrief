...
public abstract class SnailDrawTacticalContact implements SnailPainter.drawHighLight, MWC.GUI.Editable {
	/**
	 * embedded convenience class which lets use use TMAWrapper and SensorWrapper
	 * interchangeably
	 */
	...
	public abstract static class PlottableWrapperWithTimeAndOverrideableColor extends PlainWrapper {
		...
		/**
		 * get the raw (stored) color value for this item. This may be different to the
		 * value returned by getColor(), since that may actually return the parent's
		 * color when null.
		 *
		 ...
		 */
		abstract public void paint(final MWC.GenericData.WatchableList track, final MWC.GUI.CanvasType dest,
				final boolean keep_simple, final int transparency);
