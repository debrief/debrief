 ...
 * <p>
 *
 * A threaded BehaviorConsumer should be used if it takes a long time to process
 * each DIS packet, or if you want to process the packets in your own thread,
 * rather than the thread used in the BehaviorProducer.
 *
...
public class BehaviorConsumerThreaded implements BehaviorConsumerIF, Runnable {
	 ...
	 */
	@Override
	public void receivePdu(final Pdu pdu) {
