...
public class AcousticEmitterSystem extends Object implements Serializable {
	...
	/**
	 * This field shall specify the UA emitter identification number relative to a
	 * specific system. This field shall be represented by an 8-bit unsigned
	 * integer. This field allows the differentiation of multiple systems on an
	 * entity, even if in some instances two or more of the systems may be identical
	 * UA emitter types. Numbering of systems shall begin with the value 1.
	 */
	...
	public void setAcousticID(final short pAcousticID) {
		acousticID = pAcousticID;
	}

	public void setAcousticName(final int pAcousticName) {
	...
	public void unmarshal(final java.nio.ByteBuffer buff) {
		acousticName = buff.getShort() & 0xFFFF;
