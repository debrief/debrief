...
public class AcousticBeamFundamentalParameter extends Object implements Serializable {
	...
	public void marshal(final DataOutputStream dos) {
		try {
			...
			dos.writeFloat(beamCenterAzimuth);
			dos.writeFloat(azimuthalBeamwidth);
			dos.writeFloat(beamCenterDE);
			dos.writeFloat(deBeamwidth);
		} // end try
	...
	public void marshal(final java.nio.ByteBuffer buff) {
		...
		buff.putFloat(beamCenterAzimuth);
		buff.putFloat(azimuthalBeamwidth);
		buff.putFloat(beamCenterDE);
		buff.putFloat(deBeamwidth);
	} // end of marshal method
	...
	public void setAzimuthalBeamwidth(final float pAzimuthalBeamwidth) {
		azimuthalBeamwidth = pAzimuthalBeamwidth;
	}

	public void setBeamCenterAzimuth(final float pBeamCenterAzimuth) {
		beamCenterAzimuth = pBeamCenterAzimuth;
	}

	public void setBeamCenterDE(final float pBeamCenterDE) {
		beamCenterDE = pBeamCenterDE;
	}

	public void setDeBeamwidth(final float pDeBeamwidth) {
