...
public class Vector3Double extends Object implements Serializable {
	...
	/**
	 * Assuming that the Vector3Double contains DIS coordinate system values,
	 * converts them in place to latitude in the x value, longitude in the y value,
	 * (in degrees) and altitude in meters for the z value.
	 *
	 */
	public void convertDisToLatitudeLongitudeAltitude() {
		final Vector3Double location = new Vector3Double();
	 ...
	 * y=longitude, (in degrees) and z=altitude (in meters), converts them to DIS
	 * coordinates
	 * <p>
	 *
	 ...
	 * at the equator and 90 deg east. Since pretty much no one else uses this, it
	 * can make finding the "DIS standard" x,y,z difficult if you have only
	 * latitude, longitude, and altitude. This method does the converstion from
	 * those three values to the DIS coordinate system.
	 * <p>
	 *
