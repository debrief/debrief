...
public class IffAtcNavAidsLayer1Pdu extends DistributedEmissionsFamilyPdu implements Serializable {
	...
	/**
	 * Location wrt entity. There is some ambugiuity in the standard here, but this
	 * is the order it is listed in the table.
	 */
	...
	public void setFundamentalParameters(final IffFundamentalData pFundamentalParameters) {
	...
	public void setSystemID(final SystemID pSystemID) {
		systemID = pSystemID;
	}
