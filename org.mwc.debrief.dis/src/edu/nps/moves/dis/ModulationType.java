...
public class ModulationType extends Object implements Serializable {
	...
	public void setMajor(final int pMajor) {
		major = pMajor;
	}
	...
	public void setSystem(final int pSystem) {
		system = pSystem;
	}
	...
	public void unmarshal(final java.nio.ByteBuffer buff) {
		...
		major = buff.getShort() & 0xFFFF;
		detail = buff.getShort() & 0xFFFF;
		system = buff.getShort() & 0xFFFF;
	} // end of unmarshal method
} // end of class
