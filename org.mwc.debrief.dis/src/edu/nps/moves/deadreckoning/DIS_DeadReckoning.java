...
/**
 * The root super class for all DIS Dead-Reckoning algorithms. Based on the
 * algrorithms from the IEEE 1278_1-1995_DIS standards found in Annex B.
 * <p>
 * Creates an abstract instance of a Dead Reckoning (DR) algorithm, defined by
 * the concrete Dead Reckoning algorithm on the right hand side.
 * <P>
 * At each PDU update received, call the set function to update the DR algorithm
 * with the most accurance and update information. Expected to receive a new
 * update approx every 5 seconds or so. Each PDU is essentally a restart or
 * reset of the DR state.
 * <p>
 ...
 * function.
 * <P>
 * The DR algorithm updates 30 times a second. The instantiating entity can get
 * updated DR states at its leasure upto 30 times a second by calling the get
 * function, which returns an array of 6 doubles 3 x location and 3 x
 * orientation. With these 6 parameters the entity can redraw itslef in an
 * updatedloation and orientsation based on its projected path.
 * <p>
 * <hr>
 * <p>
 * <center>
 * <h2>Keynotes form the IEEE DIS standard about DR</h2></center>
 * <p>
 * <center><img src="..\..\RefsImgs\formulas.jpg"/></center>
 * <P>
 * DRM notation shall consist of three elements.
 *
 * The First element shall indicate whether the model specifies rotation as
 * either fixed (F) or rotating (R). The second element shall specify dead
 * reckoning rates to be held constant as either rate of position (P) or rate of
 * velocity (V). The third element shall specify the coordinate system to be
 * used with the dead reckoning algorithm as either world coordinates (W) or
 * body axis coordinates (B).
 *
 * <P>
 * <hr>
 * <p>
 * <b>5.2.1 Angle representation</b><br>
 * Angles shall be specfified as 32-bit floating point numbers expressed in
 * radians.(page 55)
 * <p>
 * <b>5.2.2 Angular Velocity Vector record</b><br>
 * The angular velocity of simulated entities shall be represented by the
 * Angular Velocity Vector record. This record shall specify the rate at which
 * an entity's orientation is changing. The angular velocity shall be measured
 ...
 * Angular Velocity Vector record shall be shown as in table 5. (Page 55) <br>
 ...
 * Angles record shall be as shown in table 19. (page 65) <br>
 ...
 * positive direction out the bottom of the entity. Each vector component shall
 * represent meters from the origin (see figure 2).
 * <p>
 ...
 * second</u>. The format of the Vector record shall be as shown in table 30.
 * (page 73) <br>
 ...
 * longitude at the equator, and the Z-axis passing through the north pole (see
 * figure 1). These coordinates shall represent meters from the centroid of the
 * earth. A 64-bit double precision floating point number shall represent the
 * location for each coordinate.
 * <p>
 * The format of the World Coordinates record shall be as shown in table 31.
 * (page 73) <br>
 * <center><img src="..\..\RefsImgs\worldCord.jpg"></center>
 * <P>
 * <B>The Dead Reckoning parameters captured from each PDU</B> <center>
 * <img src="..\..\RefsImgs\drPDUinfo.jpg"> </center>
 *
 *
 *
 *
 ...
 * <p>
 * <center>
 * <h2>The IEEE specified algorithms to compute the DR for Primary Methods Group
 * (1-5)</h2></center>
 * <p>
 * <hr>
 * <p>
 ...
 * z-axis), PHI (rotation about the x-axis) need to be in the range of 0 - 2PI
 * since the fields are in radians.
 * <P>
 * <hr>
 * <p>
 *
 * <b><a href="..\..\RefsImgs\2_orientation.jpg"> The Orientation portion of the
 * algorithms</A></b><br>
 * <center><img src="..\..\RefsImgs\2_orientation.jpg"/></center> <br>
 *
 * <p>
 * <hr>
 * <p>
 ...
 * <hr>
 * <p>
 * <b><a href="..\..\RefsImgs\22_drMatrix.jpg"> The generic DR
 * matrix</A></b><br>
 * <center><img src="..\..\RefsImgs\22_drMatrix.jpg"/></center> <br>
 * <center> Graphics rotate (x,y,z) matrices <br>
 * <img src="..\..\RefsImgs\rX.jpg" alt="Rotate X">
 * <img src="..\..\RefsImgs\rY.jpg" alt="Rotate Y">
 * <img src="..\..\RefsImgs\rZ.jpg" alt="Rotate Z"> = [DR] <br>
 * ultimately what this is DR equation is doing but with a change of basis from
 * world to entity coordinates. </center>
 * <p>
 * <b><a href="..\..\RefsImgs\23_angVelocity.jpg"> The angular velocity
 * Magnitude</a></b><br>
 * <center><img src="..\..\RefsImgs\23_angVelocity.jpg"/></center> <br>
 * <p>
 *
 * <b><a href="..\..\RefsImgs\24_omegaSKEW.jpg"> The SKEW matrix</a></b><br>
 * <center><img src="..\..\RefsImgs\24_omegaSKEW.jpg"/></center> <br>
 *
 * <b><a href="..\..\RefsImgs\25_angVelMult.jpg"> The angular velocity
 * Matrix</A></b><br>
 * <center><img src="..\..\RefsImgs\25_angVelMult.jpg"/></center> <br>
 * <p>
 ...
 * axis angular velocities is needed. Thus the following transformation formulas
 * are given:
 * <p>
 * <b><a href="..\..\RefsImgs\body_world.jpg"> Body to Wrold
 * Transformation</A></b><br>
 * <center><img src="..\..\RefsImgs\body_world.jpg"/></center> <br>
 * <b><a href="..\..\RefsImgs\world_body.jpg"> World to Body
 * Transformation</A></b><br>
 * <center><img src="..\..\RefsImgs\world_body.jpg"/></center> <br>
 * <P>
 * <hr>
 * <p>
 ...
 * <hr>
 * <p>
 * <b><a href="..\..\RefsImgs\initOrientMatrix.jpg"> Initial Orientation
 * Matrix</A></b><br>
 ...
 * <hr>
 * <p>
 * <b><a href="..\..\RefsImgs\getRevOrientation.jpg"> Get the Revised
 * Orientation</A></b><br>
 ...
 * <p>
 * <center>
 * <h2>The IEEE specified algorithms to compute the DR for Secondary Methods
 * Group (6-9)</h2></center>
 * <p>
 * <hr>
 * <p>
 ...
 * <p>
 * <b><a href="..\..\RefsImgs\pos8.jpg"> General position formula</A></b><br>
 * <center><img src="..\..\RefsImgs\pos8.jpg"/></center>
 * <p>
 * <b><a href="..\..\RefsImgs\r1.jpg"> R1 vector (though I am not sure what its
 * really calculating)</A></b><br>
 * <center><img src="..\..\RefsImgs\r1.jpg"/></center>
 *
 * <p>
 * <b><a href="..\..\RefsImgs\r2.jpg"> R2 vector (though I am not sure what its
 * really calculating)</A></b><br>
...
public abstract class DIS_DeadReckoning implements Runnable {
	 ...
	 * <ol>
	 * Assumed a desired rate of 30 fps Given from the standard that all parameters
	 * are in meters/s To move 1 meter/second with 30 incriments = 1/30 Delta
	 * between updates delay in milli seconds is 1/30 * 1000 || 1000 / 30 </lo>
	 * <p>
	...
	/**
	 * the inital orientation, constant between delta T Only changes when a
	 * setNewAll is called
	 */
	Matrix initOrien = new Matrix(3);

	/**
	 * SKEW matrix, constant between delta T Only changes when a setNewAll is called
	 * * Only changes when a setNewAll is called
	 */
	Matrix skewOmega = new Matrix(3);

	/**
	 * Angular velocity matrix, constant between delta T Only changes when a
	 * setNewAll is called
	 */
	Matrix ww = new Matrix(3);

	/**
	 * Angular velocity magnitude, constant between delta T Only changes when a
	 * setNewAll is called
	 */
	double wMag;
	/**
	 ...
	 * <P>
	 * Each subclass DR algorithm has a no arguments constructor, but all it does is
	 * call the super, i.e. this constructor, which establishes the Thread
	 */
	 ...
	 * <p>
	 * Applies the required DR formula to the initial position and orientation of
	 * this entity and returns the updated locaiton and position.
	 * <p>
	 * This function does not actually perform the computations, it only returns the
	 * current state of the entity. The entity state is updated byt the specified DR
	 * alorithm within the DR class behind the scenes. Updates are crated every 1/30
	 * seconds.
	 * <ol>
	 * Assume a desire of 30 fps All parameters are in meters/s to move 1
	 * meter/second with 30 incriments = 1/30 Delta between updates
	 *
	 * <p>
	 * Only returns an array of location and orientation because that is all that is
	 * needed to update the location of the entity. All other DR inputs are
	 * parameters for solving the locaiton and orientation and so are not returned,
	 * only set.
	 * <p>
	 * Order of the retruned array elements
	 * <ol>
	 * entityLocation_X entityLocation_Y entityLocation_Z entityOrientation_psi
	...
	public double[] getUpdatedPositionOrientation() {
		final double[] newLoc = { entityLocation_X, entityLocation_Y, entityLocation_Z, entityOrientation_psi,
				entityOrientation_theta, entityOrientation_phi };
		return newLoc;
	 ...
	 */
	public void setFPS(final int frames) {
		fps = frames;
		changeDelta = 1 / fps;
	}// setFPS(int frames)-------------------------------------------------------

	/***************************************************************************
	 * With each setNewAll() makes the new initial orientation matrix given the new
	 * parameters
	 *
	 * @throws java.lang.Exception
	 */
	private void setInitOrient() throws Exception {
		final double cosPsi = Math.cos(entityOrientation_psi);
		final double sinPsi = Math.sin(entityOrientation_psi);
		final double cosTheta = Math.cos(entityOrientation_theta);
		final double sinTheta = Math.sin(entityOrientation_theta);
		final double cosPhi = Math.cos(entityOrientation_phi);
		final double sinPhi = Math.sin(entityOrientation_phi);
	...
	/***************************************************************************
	 * Set the parameters for this entity's DR function based on the most recent
	 * PDU.
	 * <p>
	 * This ic called by the entity anytime the entity receives an updated ESPDU for
	 * this entity.
	 * <P>
	 ...
	 * <LI>Entity Orientation 32bit Entity Linear Velocity 32bit Entity Linear
	 * Acceleration 32bit Entity Angular Velocity 32bit
	 *
	 * <P>
	 ...
	 *
	 * @param allDis - 15 double percisions representing the above in order of the
	 *               above
	 * @throws Exception
	 */
	public void setNewAll(final double[] allDis) throws Exception {
		...
		// solve for magnatude
		wMag = Math.sqrt(
				entityAngularVelocity_X * entityAngularVelocity_X + entityAngularVelocity_Y * entityAngularVelocity_Y
	...
	/***************************************************************************
	 * With each setNewAll() makes the new skew matrix given the new parameters
	 *
	 * @throws java.lang.Exception
	 */
	...
	/***************************************************************************
	 * With each setNewAll() makes the new angular velocity matrix given the new
	 * parameters
	 *
	 * @throws java.lang.Exception
	 */
	...
	public String toString() {
		final String buff = "Current State of this Entity:\n" + "    Entity Location = (" + entityLocation_X + ", "
				+ entityLocation_Y + ", " + entityLocation_Z + ")\n" +

				"    Entity Orientation = (" + entityOrientation_psi + ", " + entityOrientation_theta + ", "
				+ entityOrientation_phi + ")\n" +

				"    Entity Linear Velocity = (" + entityLinearVelocity_X + ", " + entityLinearVelocity_Y + ", "
				+ entityLinearVelocity_Z + ")\n" +

				"    Entity Linear Acceleration = (" + entityLinearAcceleration_X + ", " + entityLinearAcceleration_Y
				+ ", " + entityLinearAcceleration_Z + ")\n" +

				"    Entity Angular Velocity = (" + entityAngularVelocity_X + ", " + entityAngularVelocity_Y + ", "
