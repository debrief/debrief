...
/**
 * Abstract superclass for doing global coordinate transforms. Given a
 * Vector3Double that specifies the location of an entity in the world,
 * transforms it from a given initial coordinate system (such as
 * lat/lon/altitude, or x/y/altitude) to another coordinate system, such as DIS
 * earth-centered. This transformation is carried out in the concrete subclass.
 * <p>
 *
 ...
 * standard. If you want to write a transform that puts lat/lon on the wire,
 * that's up to you.
 * <p>
 *
 * @author DMcG
