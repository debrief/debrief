...
public class Relationship extends Object implements Serializable {
	...
	/**
	 * the nature or purpose for joining of the part entity to the host entity and
	 * shall be represented by a 16-bit enumeration
	 */
	protected int nature;

	/**
	 * the position of the part entity with respect to the host entity and shall be
	 * represented by a 16-bit enumeration
	 */
	...
	public void setNature(final int pNature) {
		nature = pNature;
	}
	...
	public void unmarshal(final java.nio.ByteBuffer buff) {
		nature = buff.getShort() & 0xFFFF;
		position = buff.getShort() & 0xFFFF;
	} // end of unmarshal method
} // end of class
