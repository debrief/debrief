...
public class SimulationAddress extends Object implements Serializable {
	...
	/**
	 * An application is defined as a software program that is used to generate and
	 * process distributed simulation data including live, virtual and constructive
	 * data.
	 */
