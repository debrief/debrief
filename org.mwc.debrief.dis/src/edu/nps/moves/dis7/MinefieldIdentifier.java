...
public class MinefieldIdentifier extends Object implements Serializable {
	...
	public boolean equalsImpl(final Object obj) {
		...
		if (!(simulationAddress.equals(rhs.simulationAddress)))
			ivarsEqual = false;
		if (!(minefieldNumber == rhs.minefieldNumber))
			ivarsEqual = false;
	...
	public void setMinefieldNumber(final int pMinefieldNumber) {
	...
	public void unmarshal(final DataInputStream dis) {
		try {
			...
			minefieldNumber = dis.readUnsignedShort();
		} // end try
		catch (final Exception e) {
			System.out.println(e);
		}
	...
	public void unmarshal(final java.nio.ByteBuffer buff) {
		...
		minefieldNumber = buff.getShort() & 0xFFFF;
	} // end of unmarshal method
} // end of class
