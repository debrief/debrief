...
public class MinefieldStatePdu extends MinefieldFamilyPdu implements Serializable {
	...
	public int getMarshalledSize() {
		...
		for (int idx = 0; idx < perimeterPoints.size(); idx++) {
			final Vector2Float listElement = perimeterPoints.get(idx);
	...
	public void marshal(final DataOutputStream dos) {
		...
		try {
			...
			for (int idx = 0; idx < perimeterPoints.size(); idx++) {
				final Vector2Float aVector2Float = perimeterPoints.get(idx);
	...
	public void setMinefieldID(final MinefieldIdentifier pMinefieldID) {
	...
	public void setMinefieldOrientation(final EulerAngles pMinefieldOrientation) {
	...
	public void setPerimeterPoints(final List<Vector2Float> pPerimeterPoints) {
	...
	public void unmarshal(final DataInputStream dis) {
		...
		try {
			...
			for (int idx = 0; idx < numberOfPerimeterPoints; idx++) {
				final Vector2Float anX = new Vector2Float();
				anX.unmarshal(dis);
