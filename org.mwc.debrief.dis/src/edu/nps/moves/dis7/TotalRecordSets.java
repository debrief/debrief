...
public class TotalRecordSets extends Object implements Serializable {
	...
	public boolean equalsImpl(final Object obj) {
		...
		if (!(totalRecordSets == rhs.totalRecordSets))
			ivarsEqual = false;
	...
	public void setTotalRecordSets(final int pTotalRecordSets) {
		totalRecordSets = pTotalRecordSets;
	}

	public void unmarshal(final DataInputStream dis) {
		try {
			totalRecordSets = dis.readUnsignedShort();
	...
	public void unmarshal(final java.nio.ByteBuffer buff) {
		totalRecordSets = buff.getShort() & 0xFFFF;
