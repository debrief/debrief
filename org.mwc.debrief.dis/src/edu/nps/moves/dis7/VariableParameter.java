...
public class VariableParameter extends Object implements Serializable {
	...
	public void marshal(final DataOutputStream dos) {
		try {
			...
			dos.writeDouble(variableParameterFields1);
	...
	public void marshal(final java.nio.ByteBuffer buff) {
		...
		buff.putDouble(variableParameterFields1);
	...
	public void setVariableParameterFields1(final double pVariableParameterFields1) {
		variableParameterFields1 = pVariableParameterFields1;
	}

	public void setVariableParameterFields2(final long pVariableParameterFields2) {
		variableParameterFields2 = pVariableParameterFields2;
	}

	public void setVariableParameterFields3(final int pVariableParameterFields3) {
		variableParameterFields3 = pVariableParameterFields3;
	}

	public void setVariableParameterFields4(final short pVariableParameterFields4) {
	...
	public void unmarshal(final DataInputStream dis) {
		try {
			...
			variableParameterFields3 = dis.readUnsignedShort();
	...
	public void unmarshal(final java.nio.ByteBuffer buff) {
		...
		variableParameterFields3 = buff.getShort() & 0xFFFF;
