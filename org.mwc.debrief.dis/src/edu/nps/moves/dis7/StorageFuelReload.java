...
public class StorageFuelReload extends Object implements Serializable {
	 ...
	 * station/launcher if a station/launcher is specified. If the Station/Launcher
	 * field is set to zero, then this is the total quantity of this fuel type that
	 * would be present in a standard reload of all appli- cable stations/launchers
	 ...
	 * station/launcher. If the Station/launcher field is set to zero, then this is
	 * the maximum quantity of this fuel type that would be present on this entity
	 * at all stations/launchers that can accept this fuel type.
	 */
	...
	/**
	 * the seconds normally required to reload the maximum possible quantity of this
	 * fuel type at this station/launcher. When the Station/Launcher field is set to
	 * zero, this shall be the time it takes to perform a maximum quantity
	...
	public void setMaximumQuantity(final long pMaximumQuantity) {
		maximumQuantity = pMaximumQuantity;
	}

	public void setMaximumQuantityReloadTime(final short pMaximumQuantityReloadTime) {
	...
	public void setStandardQuantity(final long pStandardQuantity) {
		standardQuantity = pStandardQuantity;
	}

	public void setStandardQuantityReloadTime(final short pStandardQuantityReloadTime) {
