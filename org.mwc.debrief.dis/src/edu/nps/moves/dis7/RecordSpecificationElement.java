...
public class RecordSpecificationElement extends Object implements Serializable {
	...
	/**
	 * the data structure used to convey the parameter values of the record for each
	 * record. 32 bit enumeration.
	 */
	...
	/**
	 * the concatenated records of the format specified by the Record ID field. The
	 * length of this field is the Record Length multiplied by the Record Count, in
	 * units of bits. ^^^This is wrong--variable sized data records, bit values.
	 * THis MUST be patched after generation.
	 */
	protected int recordValues;

	/**
	 * Padding of 0 to 31 unused bits as required for 32-bit alignment of the Record
	 * Set field. ^^^This is wrong--variable sized padding. MUST be patched
