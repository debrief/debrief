...
public class BeamStatus extends Object implements Serializable {
	...
	public int getBeamState_beamState() {
		final short val = (short) (this.beamState & (short) 0x1);
		return val >> 0;
	}
	...
	public int getBeamState_padding() {
		final short val = (short) (this.beamState & (short) 0xFE);
		return val >> 1;
	}
	...
	public void setBeamState(final short pBeamState) {
	 ...
	 * 0 active, 1 deactivated
	 */
	public void setBeamState_beamState(final int val) {
		short aVal = 0;
	 ...
	 * padding
	 */
	public void setBeamState_padding(final int val) {
		short aVal = 0;
