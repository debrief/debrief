...
public class SeesPdu extends DistributedEmissionsFamilyPdu implements Serializable {
	...
	public int getMarshalledSize() {
		...
		for (int idx = 0; idx < vectoringSystemData.size(); idx++) {
			final VectoringNozzleSystem listElement = vectoringSystemData.get(idx);
			marshalSize = marshalSize + listElement.getMarshalledSize();
		}
	...
	public void marshal(final DataOutputStream dos) {
		...
		try {
			...
			for (int idx = 0; idx < vectoringSystemData.size(); idx++) {
				final VectoringNozzleSystem aVectoringNozzleSystem = vectoringSystemData.get(idx);
	...
	public void setVectoringSystemData(final List<VectoringNozzleSystem> pVectoringSystemData) {
	...
	public void unmarshal(final DataInputStream dis) {
		...
		try {
			...
			for (int idx = 0; idx < numberOfVectoringNozzleSystems; idx++) {
				final VectoringNozzleSystem anX = new VectoringNozzleSystem();
				anX.unmarshal(dis);
