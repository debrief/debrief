...
public class DebriefFireListener  extends DebriefCoreListener implements IDISFireListener
{
  ...
  final private String LAUNCHES_LAYER = "Launches";
      ...
      final double dLon, final double depth)
  {
    ...
    final String message = "Launch fired from:" + firingName;

    // create the text marker
    addNewItem(eid, LAUNCHES_LAYER, new ListenerHelper()
    {
