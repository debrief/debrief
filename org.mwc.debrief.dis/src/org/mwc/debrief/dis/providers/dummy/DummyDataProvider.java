...
public class DummyDataProvider implements IPDUProvider
{
  ...
  private List<IDISGeneralPDUListener> _listeners =
  ...
  @Override
  public void attach(DISFilters filters, EntityID ourID)
  {
    ...
    while (iL.hasNext())
    {
      IDISGeneralPDUListener thisL = (IDISGeneralPDUListener) iL.next();
