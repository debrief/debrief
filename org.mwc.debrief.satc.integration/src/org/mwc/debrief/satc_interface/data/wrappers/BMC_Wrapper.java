...
public class BMC_Wrapper
		extends CoreLayer_Wrapper<BearingMeasurementContribution, BMeasurement, BMC_Wrapper.BearingMeasurementWrapper> {

	@SuppressWarnings("rawtypes")
	public class BearingMeasurementWrapper extends CoreLayer_Wrapper.CoreMeasurementWrapper {
		// ///////////////////////////////////////////////////////////
		// info class
		// //////////////////////////////////////////////////////////
	...
	protected void addThis(final CoreMeasurement meas) {
		final BearingMeasurementWrapper thisMe = new BearingMeasurementWrapper(meas);
		_myElements.add(thisMe);
	}

	public BoundedInteger getError() {
		final BearingMeasurementContribution bm = (BearingMeasurementContribution) super.getContribution();
