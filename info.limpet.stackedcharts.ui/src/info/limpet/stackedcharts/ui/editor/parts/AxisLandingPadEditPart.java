...
public class AxisLandingPadEditPart extends AbstractGraphicalEditPart {
	...
	protected IFigure createFigure() {
		...
		final ChartPaneEditPart.AxisLandingPad pad = (ChartPaneEditPart.AxisLandingPad) getModel();

		nameLabel.setText(pad.pos == ChartPanePosition.MIN ? "Min Axis" : "Max Axis");

		figure.add(nameLabel);
		figure.getLayoutManager().setConstraint(nameLabel, new GridData(GridData.FILL, GridData.FILL, true, true));
	...
	protected void refreshVisuals() {
		final boolean horizontal = ((AxisLandingPad) getModel()).chart.getParent()
