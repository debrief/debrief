 ...
 */
public class ChartSetHeaderEditPart extends AbstractGraphicalEditPart implements ActionListener {
	...
	protected void refreshVisuals() {
		...
		((ChartsetFigure) getFigure()).setVertical(getModel().getOrientation() == Orientation.HORIZONTAL);
	}
}
