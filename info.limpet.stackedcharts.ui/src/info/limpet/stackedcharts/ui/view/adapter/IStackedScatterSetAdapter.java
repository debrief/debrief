...
public interface IStackedScatterSetAdapter {
	/**
	 * whether this adapter can convert objects of the supplied type. This is
	 * expected to return promptly, so it can be used when determining hover target
	 *
	...
	/**
	 * convert the supplied data object into a Limpet scatterset if possible
	 *
	 * @param data the object to convert
