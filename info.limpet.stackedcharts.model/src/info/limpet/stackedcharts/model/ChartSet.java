 ...
 *
 * <!-- begin-model-doc --> A stack of charts, sharing a single independent
 * axis. <!-- end-model-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>{@link info.limpet.stackedcharts.model.ChartSet#getCharts
 * <em>Charts</em>}</li>
 * <li>{@link info.limpet.stackedcharts.model.ChartSet#getOrientation
 * <em>Orientation</em>}</li>
 * <li>{@link info.limpet.stackedcharts.model.ChartSet#getSharedAxis <em>Shared
 * Axis</em>}</li>
 * </ul>
 *
...
public interface ChartSet extends EObject {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Charts</em>' containment reference list isn't
	 ...
	 * value is <code>"Vertical"</code>. The literals are from the enumeration
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Shared Axis</em>' containment reference isn't
	 * clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	 ...
	 * -->
	 *
	 * @param value the new value of the '<em>Shared Axis</em>' containment
	 *              reference.
	 * @see #getSharedAxis()
	 * @generated
	 */
