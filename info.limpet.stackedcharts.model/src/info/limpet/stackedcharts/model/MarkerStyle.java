 ...
 * '<em><b>Marker Style</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 *
...
public enum MarkerStyle implements Enumerator {
	 ...
	 * <p>
	 * If the meaning of '<em><b>Square</b></em>' literal object isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	 ...
	 * @generated
	 */
	private static final MarkerStyle[] VALUES_ARRAY = new MarkerStyle[] { NONE, SQUARE, CIRCLE, TRIANGLE, CROSS,
			DIAMOND, };

	/**
	 * A public read-only list of all the '<em><b>Marker Style</b></em>'
	...
	/**
	 * Returns the '<em><b>Marker Style</b></em>' literal with the specified integer
	 ...
	 * @generated
	 */
	public static MarkerStyle get(final int value) {
		switch (value) {
		case NONE_VALUE:
			return NONE;
		case SQUARE_VALUE:
	...
	/**
	 * Returns the '<em><b>Marker Style</b></em>' literal with the specified literal
	 * value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 ...
	 * @generated
	 */
	public static MarkerStyle get(final String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			final MarkerStyle result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static MarkerStyle getByName(final String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			final MarkerStyle result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private MarkerStyle(final int value, final String name, final String literal) {
		this.value = value;
		this.name = name;
