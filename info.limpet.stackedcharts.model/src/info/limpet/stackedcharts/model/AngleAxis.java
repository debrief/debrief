...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Angle
 * Axis</b></em>'. <!-- end-user-doc -->
 *
 * <!-- begin-model-doc --> Axis that wraps around at a particular value - used
 * with cyclic dimensions such as angles
 *
 * <!-- end-model-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>{@link info.limpet.stackedcharts.model.AngleAxis#getMinVal <em>Min
 * Val</em>}</li>
 * <li>{@link info.limpet.stackedcharts.model.AngleAxis#getMaxVal <em>Max
 * Val</em>}</li>
 * <li>{@link info.limpet.stackedcharts.model.AngleAxis#isMidOrigin <em>Mid
 * Origin</em>}</li>
 * <li>{@link info.limpet.stackedcharts.model.AngleAxis#isRedGreen <em>Red
 * Green</em>}</li>
 * </ul>
 *
...
public interface AngleAxis extends NumberAxis {
	...
	/**
	 * Returns the value of the '<em><b>Max Val</b></em>' attribute. The default
	 * value is <code>"0.0"</code>. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Max Val</em>' attribute isn't clear, there really
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Min Val</em>' attribute isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Whether to
	 * position the origin at the mid-point of the range <!-- end-model-doc -->
	 *
	...
	/**
	 * Returns the value of the '<em><b>Red Green</b></em>' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Whether to
	 * display angle using RED for -ve and GREEN for +ve
	 *
	 * <!-- end-model-doc -->
	 *
	 ...
	 *
	 * @param value the new value of the '<em>Red Green</em>' attribute.
	 * @see #isRedGreen()
	 * @generated
	 */
