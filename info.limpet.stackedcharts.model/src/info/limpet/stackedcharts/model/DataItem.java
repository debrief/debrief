 ...
 * </p>
 * <ul>
 * <li>{@link info.limpet.stackedcharts.model.DataItem#getIndependentVal
 * <em>Independent Val</em>}</li>
 * <li>{@link info.limpet.stackedcharts.model.DataItem#getDependentVal
...
public interface DataItem extends EObject {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Dependent Val</em>' attribute isn't clear, there
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Independent Val</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	 ...
	 * <em>Independent Val</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
