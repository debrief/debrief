 ...
 * <!-- end-user-doc --> <!-- begin-model-doc --> The direction in which the
 * charts are stacked <!-- end-model-doc -->
 *
...
public enum Orientation implements Enumerator {
	 ...
	 * @generated
	 */
	private static final Orientation[] VALUES_ARRAY = new Orientation[] { HORIZONTAL, VERTICAL, };
	 ...
	 * @generated
	 */
	public static Orientation get(final String literal) {
	 ...
	 * @generated
	 */
	public static Orientation getByName(final String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			final Orientation result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private Orientation(final int value, final String name, final String literal) {
		this.value = value;
		this.name = name;
