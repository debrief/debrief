...
public enum LineType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final LineType[] VALUES_ARRAY = new LineType[] { NONE, SOLID, DOTTED, DASHED, };
	 ...
	 * @generated
	 */
	public static LineType get(final int value) {
		switch (value) {
		case NONE_VALUE:
			return NONE;
		case SOLID_VALUE:
	 ...
	 * @generated
	 */
	public static LineType get(final String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			final LineType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static LineType getByName(final String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			final LineType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private LineType(final int value, final String name, final String literal) {
		this.value = value;
		this.name = name;
