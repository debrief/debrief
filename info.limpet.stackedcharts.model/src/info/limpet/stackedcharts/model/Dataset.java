 ...
 * </p>
 * <ul>
 * <li>{@link info.limpet.stackedcharts.model.Dataset#getName
 * <em>Name</em>}</li>
 * <li>{@link info.limpet.stackedcharts.model.Dataset#getMeasurements
 * <em>Measurements</em>}</li>
 * <li>{@link info.limpet.stackedcharts.model.Dataset#getStyling
 * <em>Styling</em>}</li>
 * <li>{@link info.limpet.stackedcharts.model.Dataset#getUnits
 * <em>Units</em>}</li>
 * </ul>
 *
...
public interface Dataset extends EObject {
	 ...
	 * {@link info.limpet.stackedcharts.model.DataItem}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Measurements</em>' containment reference list
	 ...
	 * used for measurements in this dataset <!-- end-model-doc -->
	 *
	...
	/**
	 * Sets the value of the '{@link info.limpet.stackedcharts.model.Dataset#getName
