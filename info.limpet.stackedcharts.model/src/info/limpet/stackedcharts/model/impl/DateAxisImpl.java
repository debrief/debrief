 ...
 * </p>
 * <ul>
 * <li>{@link info.limpet.stackedcharts.model.impl.DateAxisImpl#getDateFormat
...
public class DateAxisImpl extends AxisTypeImpl implements DateAxis {
	...
	public void setDateFormat(final String newDateFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StackedchartsPackage.DATE_AXIS__DATE_FORMAT,
