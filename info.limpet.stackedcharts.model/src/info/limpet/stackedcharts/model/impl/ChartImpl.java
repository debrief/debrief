 ...
 * </p>
 * <ul>
 * <li>{@link info.limpet.stackedcharts.model.impl.ChartImpl#getParent
 * <em>Parent</em>}</li>
 * <li>{@link info.limpet.stackedcharts.model.impl.ChartImpl#getMaxAxes <em>Max
 * Axes</em>}</li>
 * <li>{@link info.limpet.stackedcharts.model.impl.ChartImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link info.limpet.stackedcharts.model.impl.ChartImpl#getTitle
 * <em>Title</em>}</li>
 * <li>{@link info.limpet.stackedcharts.model.impl.ChartImpl#getMinAxes <em>Min
 * Axes</em>}</li>
 * </ul>
 *
 * @generated
...
public class ChartImpl extends MinimalEObjectImpl.Container implements Chart {
	...
	/**
	 * The cached value of the '{@link #getMaxAxes() <em>Max Axes</em>}' containment
	...
	/**
	 * The cached value of the '{@link #getMinAxes() <em>Min Axes</em>}' containment
	 * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getMinAxes()
	 * @generated
	 ...
	 * @generated
	 */
	public NotificationChain basicSetParent(final ChartSet newParent, NotificationChain msgs) {
	...
	public NotificationChain eBasicRemoveFromContainerFeature(final NotificationChain msgs) {
		...
		case StackedchartsPackage.CHART__PARENT:
			return eInternalContainer().eInverseRemove(this, StackedchartsPackage.CHART_SET__CHARTS, ChartSet.class,
					msgs);
		}
	...
	public EList<DependentAxis> getMaxAxes() {
		if (maxAxes == null) {
			maxAxes = new EObjectContainmentEList<DependentAxis>(DependentAxis.class, this,
					StackedchartsPackage.CHART__MAX_AXES);
		}
		return maxAxes;
	}
	...
	public EList<DependentAxis> getMinAxes() {
		if (minAxes == null) {
			minAxes = new EObjectContainmentEList<DependentAxis>(DependentAxis.class, this,
					StackedchartsPackage.CHART__MIN_AXES);
		}
		return minAxes;
	}
	 ...
	 */
	@Override
	public void setParent(final ChartSet newParent) {
		if (newParent != eInternalContainer()
				|| (eContainerFeatureID() != StackedchartsPackage.CHART__PARENT && newParent != null)) {
			...
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			if (newParent != null)
				msgs = ((InternalEObject) newParent).eInverseAdd(this, StackedchartsPackage.CHART_SET__CHARTS,
						ChartSet.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StackedchartsPackage.CHART__PARENT, newParent,
					newParent));
	}
