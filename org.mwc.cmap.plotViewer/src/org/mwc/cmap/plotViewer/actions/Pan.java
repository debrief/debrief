...
public class Pan extends CoreDragAction {
	...
	public static class PanMode extends SWTChart.PlotMouseDragger {
		...
		public void doMouseDrag(final org.eclipse.swt.graphics.Point pt, final int JITTER, final Layers theLayers,
			...
			final WorldLocation theLocation = theCanvas.getProjection().toWorld(new java.awt.Point(pt.x, pt.y));
			...
			if (_lastLocation != null) {
				...
				// ok, set the new area
				MWC.GUI.Tools.Chart.Pan.PanAction.setNewArea(theCanvas.getProjection(), newArea);
		...
		public void doMouseUp(final org.eclipse.swt.graphics.Point point, final int keyState) {
			...
			// and wrap it
			final DebriefActionWrapper daw = new DebriefActionWrapper(theAction, _theLayers, null);
