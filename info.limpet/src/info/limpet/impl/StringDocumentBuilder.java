...
public class StringDocumentBuilder extends CoreDocumentBuilder<String, StringDocument>
		implements IDocumentBuilder<String> {
	public StringDocumentBuilder(final String name, final ICommand predecessor, final Unit<?> indexUnits) {
	...
	@Override
	protected StringDocument getDocument(final IDataset dataset, final ICommand _predecessor2) {
