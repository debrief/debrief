...
@Suite.SuiteClasses({
		...
		Debrief.GUI.Tote.Painters.PainterManager.testMe.class, Debrief.GUI.Tote.Painters.RelativePainter.testMe.class,
		Debrief.GUI.Tote.Painters.SnailDrawFix.testMe.class, Debrief.GUI.Tote.Painters.SnailPainter.testMe.class,
		Debrief.GUI.Tote.Painters.TotePainter.testMe.class, Debrief.GUI.Tote.StepControl.testMe.class,
		Debrief.GUI.Tote.StepControl.testMe.class, Debrief.GUI.Tote.Swing.SwingStepControl.testStepper.class,
		Debrief.GUI.Views.LogicHelpers.TestLogic.class, Debrief.ReaderWriter.FlatFile.FlatFileExporter.testMe.class,
		...
		Debrief.ReaderWriter.Replay.ImportSensor2.testMe.class, Debrief.ReaderWriter.Replay.ImportSensor3.testMe.class,
		...
		Debrief.Wrappers.Formatters.SliceTrackFormatListener.TestMe.class,
		Debrief.Wrappers.BuoyPatternWrapper.testMe.class, Debrief.Wrappers.FixWrapper.testMe.class,
		...
		MWC.Algorithms.EarthModels.CompletelyFlatEarth.FlatEarthTest.class, MWC.GUI.BaseLayer.BaseLayerTest.class,
		MWC.GUI.Canvas.CanvasAdaptor.testMe.class, MWC.GUI.Canvas.Swing.SwingCanvas.CanvasTest.class,
		MWC.GUI.Chart.Painters.CoastPainter.CoastPainterTest.class,
		MWC.GUI.Chart.Painters.Grid4WPainter.Grid4WTest.class, MWC.GUI.Chart.Painters.GridPainter.GridPainterTest.class,
		...
		MWC.GUI.ETOPO.ETOPO_2_Minute.Etopo2Test.class, MWC.GUI.Layers.LayersTest.class,
		MWC.GUI.Plottables.Grid4WTest.class, MWC.GUI.S57.S57Layer.GridPainterTest.class,
		MWC.GUI.Shapes.ArcShape.CircleTest.class, MWC.GUI.Shapes.CircleShape.CircleTest.class,
		MWC.GUI.Shapes.EllipseShape.EllipseTest.class, MWC.GUI.Shapes.FurthestOnCircleShape.WheelTest.class,
		MWC.GUI.Shapes.LineShape.LineTest.class, MWC.GUI.Shapes.PolygonShape.TestPolygonShape.class,
		MWC.GUI.Shapes.RangeRingShape.WheelTest.class, MWC.GUI.Shapes.RectangleShape.RectangleTest.class,
		MWC.GUI.Shapes.Symbols.Geog.ReferenceSym.ReferenceTest.class,
		MWC.GUI.Shapes.Symbols.Geog.WreckSym.WreckTest.class, MWC.GUI.Shapes.Symbols.SymbolFactory.SymFactoryTest.class,
		MWC.GUI.Shapes.Symbols.SVG.SVGCircle.SVGCircleTest.class,
		MWC.GUI.Shapes.Symbols.SVG.SVGEllipse.SVGEllipseTest.class,
		MWC.GUI.Shapes.Symbols.SVG.SVGPoligon.SVGPolygoneTest.class,
		MWC.GUI.Shapes.Symbols.SVG.SVGPolyline.SVGPolylineTest.class,
		MWC.GUI.Shapes.Symbols.SVG.SVGRectangle.SVGRectangleTest.class,
		MWC.GUI.Shapes.Symbols.SVG.SVGShape.SVGShapeTest.class, MWC.GUI.Shapes.Symbols.SVG.SVGLine.SVGLineTest.class,
		MWC.GUI.Shapes.WheelShape.WheelTest.class, MWC.GenericData.Duration.DurationTest.class,
		MWC.GenericData.WorldAcceleration.AccelTest.class, MWC.GenericData.WorldArea.WorldAreaTest.class,
		MWC.GenericData.WorldDistance.DistWithUnitsTest.class, MWC.GenericData.WorldLocation.LocationTest.class,
		MWC.GenericData.WorldPath.PathTest.class, MWC.GenericData.WorldSpeed.SpeedTest.class,
		MWC.GenericData.WorldVector.VectorTest.class, MWC.GenericData.TimePeriod.TestTimePeriod.class,
		MWC.TacticalData.NarrativeEntry.testMe.class, MWC.TacticalData.SliderConverter.SliderConverterTest.class,
		MWC.Utilities.Errors.Testing.EmptyTestCase.class, MWC.Utilities.Errors.Testing.TestEmpty.class,
		...
		Debrief.ReaderWriter.powerPoint.test.FindMapTest.class, Debrief.ReaderWriter.powerPoint.test.JUnitTests.class,
		...
		org.mwc.debrief.pepys.model.bean.Datafile.DatafilesTest.class,
