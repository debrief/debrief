...
interface PointerDrawer extends Disposable {
	...
	/**
	 * @return AreaGate which may be used to distinguish area used to draw pointer.
	 *         This gate is updated after any repaint.
	 */
	public AreaGate getAreaGate();

	/**
	 * Message sent to Drawer with request to draw pointer which points to the given
	 * screen pont.
	 *
	 * @param x             horizontal coordinate of the screen point the result
	 *                      pointer should point to in coordinate system of the
	 *                      given GC.
	 * @param y             vertical coordinate of the screen point the result
	 *                      pointer should point to in coordinate system of the
	 *                      given GC.
	 *
	 * @param optionalLabel optional label which should be drawn near the pointer or
