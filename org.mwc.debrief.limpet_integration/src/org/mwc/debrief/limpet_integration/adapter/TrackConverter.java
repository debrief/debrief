...
public class TrackConverter
{
  ...
  private final WatchableList list;

  public TrackConverter(final WatchableList list)
  {
    this.list = list;
  }
  ...
  private abstract static class StateChoiceProvider extends
      DataChoiceProvider
  {
  ...
  public List<Object> convert(List<Object> res)
  {
    ...
    if (_previousChoices != null)
    {
      ...
      {
        DataChoiceProvider provider =
            (DataChoiceProvider) _previousChoices[i];
