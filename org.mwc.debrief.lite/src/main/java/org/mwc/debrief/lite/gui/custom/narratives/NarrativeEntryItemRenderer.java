...
public class NarrativeEntryItemRenderer extends JPanel implements TableCellRenderer {

	private static final ImageIcon HIGHLIGHT_ICON = Utils.getIcon("icons/16/highlight.png");
	private static final ImageIcon BLANK_ICON = Utils.getIcon("icons/16/blank.png");
	private static final ImageIcon REMOVE_NARRATIVE_ICON = Utils.getIcon("icons/16/remove_narrative.png");
	private static final ImageIcon EDIT_NARRATIVE_ICON = Utils.getIcon("icons/16/edit_narrative.png");
	...
	private JPanel getHeader(final NarrativeEntryItem valueItem, final JLabel time, final Font originalFont) {
		...
		final Font smallFont = new Font(originalFont.getName(), originalFont.getStyle(), 10);
	...
	private JPanel getName(final String text, final boolean hasFocus, final Font originalFont, final JTable table) {
	...
	public Component getTableCellRendererComponent(final JTable table, final Object value, final boolean isSelected,
		...
		if (value instanceof NarrativeEntryItem) {
			...
			if (valueItem.getModel().getCurrentHighLight() != null
					&& valueItem.getModel().getCurrentHighLight().equals(valueItem.getEntry())) {
