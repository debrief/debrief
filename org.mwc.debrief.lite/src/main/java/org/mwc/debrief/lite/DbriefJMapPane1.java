...
public class DbriefJMapPane1 extends DebriefAbstractMapPane {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2483842396582297806L;
	private GTRenderer renderer;
    private BufferedImage baseImage;
    private Graphics2D baseImageGraphics;

    public DbriefJMapPane1() {
        this(null);
    }
    
    public DbriefJMapPane1(MapContent content) {
        this(content, null, null);
    }

    public DbriefJMapPane1(MapContent content, RenderingExecutor executor, GTRenderer renderer) {
    ...
    public RenderedImage  scaleImage(RenderedImage image, float scaleFactor) {
