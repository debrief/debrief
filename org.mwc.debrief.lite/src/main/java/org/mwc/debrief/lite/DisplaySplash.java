...
public class DisplaySplash extends JFrame implements ActionListener, Runnable {
	...
	private static void renderSplashFrame(final Graphics2D g, final String message) {
	...
	public void run() {
		...
		final String[] tasks = { "Loading map content", "Initializing Debrief Lite", "Creating map pane",
