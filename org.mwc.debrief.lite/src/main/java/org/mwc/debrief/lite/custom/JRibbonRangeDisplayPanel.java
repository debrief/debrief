...
public class JRibbonRangeDisplayPanel extends JPanel
{
  ...
  public JRibbonRangeDisplayPanel(Projection<JRibbonRangeDisplayPanel,
  RangeDisplayComponentContentModel, ComponentPresentationModel> projection)
  {
    RangeDisplayComponentContentModel contentModel = projection.getContentModel();
