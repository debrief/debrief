 ...
 *
 */
public class CreateScaleCommandAction extends CreateScale implements CommandAction {
	...
	public CreateScaleCommandAction(final ToolParent theParent, final PropertiesPanel thePanel, final Layers theData,
