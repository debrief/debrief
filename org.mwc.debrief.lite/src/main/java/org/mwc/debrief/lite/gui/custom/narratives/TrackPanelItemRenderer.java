...
public class TrackPanelItemRenderer extends JPanel implements ListCellRenderer<TrackNameColor> {
	...
	@Override
	public Component getListCellRendererComponent(final JList<? extends TrackNameColor> list,
			final TrackNameColor value, final int index, final boolean isSelected, final boolean cellHasFocus) {
