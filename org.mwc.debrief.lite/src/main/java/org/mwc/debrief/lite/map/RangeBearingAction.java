...
/**
 * An action for connect a control (probably a JButton) to the Range Bearing
 * tool - for measuring range and bearing
 *
...
public class RangeBearingAction extends MapAction implements CommandAction {
	...
	*/
	 ...
	 * @param transform
	 */
	public RangeBearingAction(final MapPane mapPane, final boolean showToolName, final JLabel statusBar,
	 ...
	 * cursor tool being set to a new ZoomInTool object
	 *
	 * @param ev the event (not used)
	 */
	@Override
	public void actionPerformed(final ActionEvent ev) {
		// Not an amazing cast, but it is ok since AbstractMapPane is the only
		// implementation of MapPane
		final RangeBearingTool rangeBearingTool = new RangeBearingTool(_statusBar, _transform,
