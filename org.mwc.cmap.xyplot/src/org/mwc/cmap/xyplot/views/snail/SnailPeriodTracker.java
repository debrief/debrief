...
public class SnailPeriodTracker extends WorkbenchWindowControlContribution {
	...
	private final List<ISnailPeriodChangedListener> _listeners = new ArrayList<ISnailPeriodChangedListener>();
	...
	protected Control createControl(final Composite parent) {
		...
		_reader = new Combo(container, SWT.BORDER | SWT.READ_ONLY | SWT.DROP_DOWN);
		_reader.setLayoutData(glReader);

		for (final String value : PERIODS_IN_MILLISEC.keySet())
			_reader.add(value);
		...
		_reader.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(final SelectionEvent e) {
				...
				for (final ISnailPeriodChangedListener listener : _listeners) {
	...
	public void removeSnailPeriodChangedListener(final ISnailPeriodChangedListener listener) {
