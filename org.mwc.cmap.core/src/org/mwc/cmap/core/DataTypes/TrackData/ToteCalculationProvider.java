...
public interface ToteCalculationProvider {
	/**
	 * find out the current set of calculations (typically performed as the provider
	 * is opening/activated)
	 *
	 * @return
	 */
	...
	/**
	 * assign the current set of calculations (typically performed as the provider
	 * is closing/deactivated)
	 *
	 * @param calcs
	 */
