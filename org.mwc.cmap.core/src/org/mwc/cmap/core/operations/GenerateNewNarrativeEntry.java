 ...
 *
 */
public class GenerateNewNarrativeEntry implements RightClickContextItemGenerator {
	...
	public static class AddNarrativeEntry extends CMAPOperation {
		...
		public AddNarrativeEntry(final Layers layers, final NarrativeWrapper parent, final NarrativeEntry entry) {
	...
	public void generate(final IMenuManager parent, final Layers theLayers, final Layer[] parentLayers,
		...
		if (goForIt) {
			...
			addEntry.setImageDescriptor(CorePlugin.getImageDescriptor("icons/16/narrative_entry.png"));
	 ...
	 * @param helpContext
	 */
	private void runOperation(final Layers theLayers, final NarrativeWrapper theNarrative,
			final NewNarrativeEntryWizard wizard) {
		...
		if (dialog.getReturnCode() == Window.OK) {
			...
			final IUndoableOperation addTheCut = new AddNarrativeEntry(theLayers, theNarrative, ne);
