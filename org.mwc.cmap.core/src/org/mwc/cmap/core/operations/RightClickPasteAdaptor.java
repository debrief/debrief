...
public class RightClickPasteAdaptor
{
  ...
  public static class PasteItem extends Action
  {
    ...
    public PasteItem(final Editable[] items, final Layer theDestination,
  ...
  {
    public PasteLayer(final Editable[] items, final Clipboard clipboard,
  ...
  public static class TestPaste extends TestCase
  {
    public void testCreateAction()
    {
      ...
      layer3.setName("name");
      final Editable[] items = new Editable[]
      {layer1, layer2, layer3};
      final Clipboard clipboard = null;
      final Layer destination = null;

      final PasteItem action = createAction(destination, layers, clipboard,
          items);
    ...
    {
      final Layers layers = new Layers();
      final DynamicTrackShapeSetWrapper layer1 =
          new DynamicTrackShapeSetWrapper("title");
      layer1.setName("name");
      final Editable[] items = new Editable[]
      {layer1};
      final Clipboard clipboard = null;
    ...
    public void testLabels()
    {
      ...
      final LabelWrapper label = new LabelWrapper("label", new WorldLocation(1d,
          1d, 1d), Color.red);
      final LabelWrapper label2 = new LabelWrapper("label", new WorldLocation(
          1d, 1d, 1d), Color.red);
      final LabelWrapper label3 = new LabelWrapper("label", new WorldLocation(
          1d, 1d, 1d), Color.red);
      final Editable[] items = new Editable[]
      {label, label2, label3};
    ...
    public void testLayers()
    {
      ...
      final Clipboard clipboard = null;
      final Layer destination = null;
      final PasteItem paste = new PasteLayer(items, clipboard, destination,
          layers);
      ...
      final Editable[] theDataList)
  {
    ...
    if (allLayers)
    {
      ...
      paster = new PasteLayer(theDataList, _clipboard, (Layer) destination,
          theLayers);
    }
    else
    {
      ...
      if (destination != null)
      {
        // just check that the layers are compliant (that we're not trying to paste a dynamic
        // plottable
        // into a non-compliant layer
        if (!(destination instanceof DynamicLayer)
            || theDataList[0] instanceof DynamicPlottable)
        {
          // create the menu items
  ...
  static public void getDropdownListFor(final IMenuManager manager,
      final Editable destination, final Layer[] updateLayer,
      final HasEditables[] parentLayer, final Layers theLayers,
