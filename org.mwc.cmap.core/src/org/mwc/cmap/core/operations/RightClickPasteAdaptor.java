...
public class RightClickPasteAdaptor
{
  ...
  public static class TestPaste extends TestCase
  {
    ...
    {
      Layers layers = new Layers();
      DynamicTrackShapeSetWrapper layer1 = new DynamicTrackShapeSetWrapper(
          "title");
      layer1.setName("name");
      Editable[] items = new Editable[]
      {layer1};
    ...
    public void testLabels()
    {
      ...
      LabelWrapper label = new LabelWrapper("label", new WorldLocation(1d, 1d,
          1d), Color.red);
      LabelWrapper label2 = new LabelWrapper("label", new WorldLocation(1d, 1d,
          1d), Color.red);
      LabelWrapper label3 = new LabelWrapper("label", new WorldLocation(1d, 1d,
          1d), Color.red);
      Editable[] items = new Editable[]
      {label, label2, label3};
