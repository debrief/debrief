...
public class DebriefIProperty implements IPropertyDescriptor, IDebriefProperty
{
	...
	public DebriefIProperty(final IPropertyDescriptor prop, final Editable subject,
	...
	@SuppressWarnings(
	{ "rawtypes" })
	private EditorHelper findHelperFor(final IPropertyDescriptor prop, final Editable subject)
	{
	  return null;
