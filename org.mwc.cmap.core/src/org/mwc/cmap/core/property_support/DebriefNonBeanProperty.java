...
public class DebriefNonBeanProperty implements IPropertyDescriptor,
    IDebriefProperty
{
  ...
  private Editable _subject;

  static Vector<EditorHelper> _myHelperList;

  static Control _theControl;

  public DebriefNonBeanProperty(final NonBeanPropertyDescriptor prop,
      final Control theControl, final Editable subject)
  {
    _theProp = prop;
  ...
  private EditorHelper findHelperFor(final Class theClass)
  {
    ...
    if (res == null)
    {
      ...
      final String msg = "editor not found for:"
          + _theProp.getDataType().toString() + "(" + _theProp.getFieldName()
          + ")";
