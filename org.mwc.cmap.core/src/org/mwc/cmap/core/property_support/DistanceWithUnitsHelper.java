...
public class DistanceWithUnitsHelper extends EditorHelper {
			...
			public String getText(final Object element) {
				...
				if (val != null) {
					...
					try {
						...
						CorePlugin.logError(IStatus.ERROR, "Trouble writing distance as string", e);
						res = "suppressed";
					}
				} else {
					res = "unset";
	...
	/**
	 * produce editable version. In our data model we may rely on a null value to
	 * describe an attribute. But, our editor cannot edit null values. We convert a
	 * null value to an editable range - but we also need to be able to convert
	 * back. So convert a zero range to a null value.
	 */
	@Override
	...
	/**
	 * produce editable version. In our data model we may rely on a null value to
	 * describe an attribute. But, our editor cannot edit null values. So, if we
	 * receive a null distance, convert it to a zero length.
	 */
	@Override
