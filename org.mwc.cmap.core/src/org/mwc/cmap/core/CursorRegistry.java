...
public class CursorRegistry {
	...
	public static Cursor getCursor(final String id) {
		Cursor cursor = cursors.get(id);
		if (cursor == null || cursor.isDisposed()) {
			if (HAND_FIST.equals(id)) {
				cursor = new Cursor(Display.getDefault(),
						CorePlugin.getImageDescriptor("icons/hand_fist.ico").getImageData(), 4, 2);
				cursors.put(HAND_FIST, cursor);
				return cursor;
			}
			if (HAND.equals(id)) {
				cursor = new Cursor(Display.getDefault(),
						CorePlugin.getImageDescriptor("icons/hand.ico").getImageData(), 4, 2);
				cursors.put(HAND, cursor);
				return cursor;
			}
			if (SELECT_POINT_HIT_DOWN.equals(id)) {
				cursor = new Cursor(Display.getDefault(),
						CorePlugin.getImageDescriptor("icons/SelectPointHitDown.ico").getImageData(), 7, 3);
				cursors.put(SELECT_POINT_HIT_DOWN, cursor);
				return cursor;
			}
			if (SELECT_POINT.equals(id)) {
				cursor = new Cursor(Display.getDefault(),
						CorePlugin.getImageDescriptor("icons/SelectPoint.ico").getImageData(), 7, 3);
			...
			if (SELECT_POINT_HIT.equals(id)) {
				cursor = new Cursor(Display.getDefault(),
						CorePlugin.getImageDescriptor("icons/SelectPointHit.ico").getImageData(), 7, 3);
			...
			if (SELECT_FEATURE_HIT_DOWN.equals(id)) {
				cursor = new Cursor(Display.getDefault(),
						CorePlugin.getImageDescriptor("icons/SelectFeatureHitDown.ico").getImageData(), 4, 2);
			...
			if (SELECT_FEATURE_HIT.equals(id)) {
				cursor = new Cursor(Display.getDefault(),
						CorePlugin.getImageDescriptor("icons/SelectFeatureHit.ico").getImageData(), 4, 2);
			...
			if (SELECT_FEATURE.equals(id)) {
				cursor = new Cursor(Display.getDefault(),
						CorePlugin.getImageDescriptor("icons/SelectFeature.ico").getImageData(), 4, 2);
			...
			if (SELECT_FEATURE_HIT_ROTATE.equals(id)) {
				cursor = new Cursor(Display.getDefault(),
						CorePlugin.getImageDescriptor("icons/SelectFeatureHitRotate.ico").getImageData(), 4, 2);
			...
			if (SELECT_FEATURE_HIT_STRETCH.equals(id)) {
				cursor = new Cursor(Display.getDefault(),
						CorePlugin.getImageDescriptor("icons/SelectFeatureHitStretch.ico").getImageData(), 4, 2);
			...
			if (SELECT_FEATURE_HIT_SHEAR.equals(id)) {
				cursor = new Cursor(Display.getDefault(),
						CorePlugin.getImageDescriptor("icons/SelectFeatureHitShear.ico").getImageData(), 4, 2);
			...
			if (SELECT_FEATURE_HIT_FAN_STRETCH.equals(id)) {
				cursor = new Cursor(Display.getDefault(),
						CorePlugin.getImageDescriptor("icons/SelectFeatureHitFanStretch.ico").getImageData(), 4, 2);
			...
			if (SELECT_FEATURE_HIT_DRAG.equals(id)) {
				cursor = new Cursor(Display.getDefault(),
						CorePlugin.getImageDescriptor("icons/SelectFeatureHitDrag.ico").getImageData(), 4, 2);
