	...
	public void initializeDefaultPreferences() {
		...
		if (fileURL != null) {
			...
			try {
				...
				CorePlugin.logError(IStatus.ERROR, "Unable to find coastline data-file", e);
			}

			// and store the default location
			final IPreferenceStore store = CorePlugin.getDefault().getPreferenceStore();
			store.setDefault(CoastlineSourcePrefsPage.PreferenceConstants.COASTLINE_FILE, fileURL.getFile());
		}
	}
