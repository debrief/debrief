...
public class CMAPPrefsPage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public synchronized void createFieldEditors() {
		...
		addField(new RadioGroupFieldEditor(PreferenceConstants.IMPORT_MODE,
				"Default &track import mode: (use 'Ask user' to allow specification of import frequency)", 1,
				_trackModeTags, getFieldEditorParent()));

		addField(new RadioGroupFieldEditor(PreferenceConstants.RNG_UNITS, "Default &range units:", 1, _distanceUnitTags,
				getFieldEditorParent()));

		addField(new RadioGroupFieldEditor(PreferenceConstants.REL_BEARING_FORMAT, "Relative &bearing format:", 1,
				_relBearingTags, getFieldEditorParent()));
	}
