...
public class ETOPOPreferenceInitializer extends AbstractPreferenceInitializer
{
  ...
  public void initializeDefaultPreferences()
  {
    ...
    URL fileURL = null;
    final Bundle staticBundle = Platform.getBundle(
        "org.mwc.cmap.static_resources");
    ...
    if (fileURL != null)
    {
      ...
      final IPreferenceStore store = CorePlugin.getDefault()
          .getPreferenceStore();
      store.setDefault(ETOPOPrefsPage.PreferenceConstants.ETOPO_FILE, fileURL
          .getFile());
