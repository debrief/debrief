...
public class ETOPOPrefsPage extends FieldEditorPreferencePage implements
    IWorkbenchPreferencePage
{
  ...
  {
    super("ETOPO library data", CorePlugin.getImageDescriptor(
        "icons/large_vpf.gif"), GRID);
  ...
  public void createFieldEditors()
  {
    ...
    addField(new ScaleFieldEditor(PreferenceConstants.TRANSPARENCY,
        "ETOPO backdrop transparency (0=transparent, 255=solid):",
