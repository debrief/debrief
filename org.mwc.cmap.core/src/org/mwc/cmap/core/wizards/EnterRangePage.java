...
public class EnterRangePage extends CoreEditableWizardPage {
	...
	public EnterRangePage(final ISelection selection, final String pageName, final String pageDescription,
			final String rangeTitle, final WorldDistance defaultRange, final String imagePath, final String helpContext,
			final String trailingMessage) {
		this(selection, pageName, pageDescription, rangeTitle, defaultRange, imagePath, helpContext, trailingMessage,
				DEFAULT_PREF_NAME);
	}
	...
	public EnterRangePage(final ISelection selection, final String pageName, final String pageDescription,
		...
		super(selection, NAME, pageName, pageDescription, imagePath, helpContext, false, trailingMessage);
