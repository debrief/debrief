...
public class SelectTrackPage extends CoreEditableWizardPage {
	...
	public SelectTrackPage(final ISelection selection, final String pageName, final String title,
			final String description, final String imageName, final String helpContext, final boolean optional,
			final String trailingMsg, final TrackWrapper[] allTracks, final TrackWrapper defaultWrapper) {
		super(selection, pageName, title, description, imageName, helpContext, optional, trailingMsg);
	...
	protected PropertyDescriptor[] getPropertyDescriptors() {
		final PropertyDescriptor[] descriptors = { prop("Track", _fieldExplanation, getEditable()) };
		return descriptors;
	}
