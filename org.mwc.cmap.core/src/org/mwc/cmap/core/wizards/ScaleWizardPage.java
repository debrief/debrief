...
public class ScaleWizardPage extends CoreEditableWizardPage {
	...
	public ScaleWizardPage(final ISelection selection) {
		super(selection, "scalePage", "Add Scale to Plot", "This page adds a scale to your plot",
	...
	protected PropertyDescriptor[] getPropertyDescriptors() {
		final PropertyDescriptor[] descriptors = { prop("Color", "the Color to draw the Scale", getEditable()),
				longProp("DisplayUnits", "the units to use for the scale", getEditable(),
