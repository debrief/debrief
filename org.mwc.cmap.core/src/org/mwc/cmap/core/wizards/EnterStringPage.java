...
public class EnterStringPage extends CoreEditableWizardPage {
	...
	public EnterStringPage(final ISelection selection, final String startName, final String pageTitle,
			final String pageExplanation, final String fieldExplanation, final String imagePath,
			final String helpContext, final boolean useDefaults, final String trailingMessage) {
		this(selection, startName, pageTitle, pageExplanation, fieldExplanation, imagePath, helpContext, useDefaults,
				trailingMessage, DEFAULT_PREF_VALUE, null);
	}
	...
	public EnterStringPage(final ISelection selection, final String startName, final String pageTitle,
			final String pageExplanation, final String fieldExplanation, final String imagePath,
			final String helpContext, final boolean useDefaults, final String trailingMessage, final String prefName,
	...
	protected String getIndex() {
		return "" + this.getClass() + "," + _prefName + "_" + _fieldExplanation.hashCode();
	}
	...
	protected PropertyDescriptor[] getPropertyDescriptors() {
		...
		final PropertyDescriptor[] descriptors = { property };
		return descriptors;
	}
