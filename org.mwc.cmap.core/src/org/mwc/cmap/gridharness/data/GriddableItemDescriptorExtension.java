...
public class GriddableItemDescriptorExtension extends GriddableItemDescriptor implements IAdaptable {
	...
	public GriddableItemDescriptorExtension(final String name, final String displayName, final Class<?> typeClass,
			final EditorHelper editor, final String sampleString) {
