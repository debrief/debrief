...
public class TimeDeltas {
	 ...
	 */
	public void load(final String path) throws ParseException, IOException, MultiPathModel.DataFormatException {
		...
		while ((line = bufRdr.readLine()) != null) {
			...
			final double strength = MWCXMLReader.readThisDouble(st.nextToken().trim());
		...
		if (!values.isEmpty()) {
			...
			if (sampleVal > 500)
				throw new MultiPathModel.DataFormatException("Doesn't look like time interval data");
