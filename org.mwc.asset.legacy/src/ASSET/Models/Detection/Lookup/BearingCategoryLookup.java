...
/**
 * class to return a double value based on a supplied combination of vessel
 * category and bearing
 *
 */
...

{
	 ...
	 */
	public BearingCategoryLookup(final double[][] sigmaTable) {
	 ...
	 * @return
	 */
	public double getValue(final String vesselType, final double bearing) {
		final double res = 0d;
		return res;
	}
