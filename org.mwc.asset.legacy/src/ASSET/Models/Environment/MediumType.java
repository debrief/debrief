...
public interface MediumType {
	 ...
	 *
	 */
	public double getLossBetween(WorldLocation origin, WorldLocation destination);
	 ...
	 *
	 */
	public double getResultantEnergyAt(WorldLocation origin, WorldLocation destination, double sourceLevel);
