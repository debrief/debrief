...
public class BroadbandMedium implements ASSET.Models.Environment.MediumType {
	 ...
	 */
	@Override
	public double getBkgndNoise(final WorldLocation origin, final double brg_degs) {
	 ...
	 * @see <a href=
	 *      "file:///D:/Dev/Asset/docs/doc_set/html/asset_mod_mediums.htm#mod_medium_bb">ASSET
	 *      Mod Guide</a>
	 *
	 */
	@Override
	public double getLossBetween(final WorldLocation origin, final WorldLocation destination) {
		double res = 0;
	 ...
	 */
	@Override
	public double getResultantEnergyAt(final WorldLocation origin, final WorldLocation destination,
