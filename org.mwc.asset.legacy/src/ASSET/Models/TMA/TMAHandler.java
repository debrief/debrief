...
public class TMAHandler {
	...
	static class ParticipantWrapper {
		...
		public String toString() {
			...
			final String res = "x:" + df.format(val[0]) + " y:" + df.format(val[1]) + " dx:" + df.format(val[2])
					+ " dy:" + df.format(val[3]);
			return res;
		}
	...
	static class SingleTrack {
		...
		@Override
		public String toString() {
			return "x:" + df.format(sol[0]) + "  y:" + df.format(sol[1]) + " dx:" + df.format(sol[2]) + " dy:"
					+ df.format(sol[3]) + " hz:" + df.format(sol[4]);
		}
	}
	...
	public static native double InitialiseNonFreq(double[] Target, double[] Sensor, double[] TrueTarget, double[] Sol,
			double[] Cov, double[] PolarCov, double B, double SigB, double R, double SigR, double RN[],
	...
	public static native double SetControlParameters(double SpeedOfSound, double RangePrior, double SpeedPrior,
			double RangePriorSigma, double CoursePriorSigma, double SpeedPriorSigma, double OutOfContactTime,
			double ManoeuvreDetectionSensitivity, double CorrelationBetweenSolutions, double MinInfoMatrixDeterminant,
			double SolutionDegradationFactor);

	public static native double sumDArray(double[] arr);

	public static native double TUACalcs(double ThisTime, double LastTime, double[] Ownship, double[] Solution,
			double[] CartCov, double[] PolSolution, double[] Sigs, double[] Axis1, double[] Axis2, double[] Orientation,
			double[] Bdot, double[] Rdot);

	public static native double Update(double[] LastUpdateTime, double[] InfMat, double[] Sensor, double[] TrueTarget,
			double[] Target, double ThisUpdateTime, double B, double SigB, double F, double SigF, double R, double SigR,
			double C, double SigC, double S, double SigS, double[] RN, double[] PolarCov, double[] CartCov,
	...
	// {
	//
	// // todo - implement this testing, and change class name back from dTest to
	////////////////////////////////////////////////////////////////////////////////////////////////// test,
	...
	// MWC.GenericData.WorldLocation.setModel(new
	...
	// final SimpleDemandedStatus demStatus = new SimpleDemandedStatus(1200,
	////////////////////////////////////////////////////////////////////////////////////////////////// status);
	...
	// status2.setLocation(new WorldLocation(origin.getLat() +
	// MWC.Algorithms.Conversions.m2Degs(-6858),
	// origin.getLong() + MWC.Algorithms.Conversions.m2Degs(11878.4), 0));
	// final SimpleDemandedStatus demStatus2 = new SimpleDemandedStatus(1200,
	////////////////////////////////////////////////////////////////////////////////////////////////// status2);
	...
	// final int len = 600;
	// System.out.println();
	// System.out.println("Time\tTrue Tgt\tAss Tgt\tOwnship\tXY Sol\tTrue
	////////////////////////////////////////////////////////////////////////////////////////////////// Pol\tRBSCF");
	// for(int i=0;i<len;i++)
	// {
	//
	...
	// // manoeuvre ownship
	//
	// final SimpleDemandedStatus demandedStatus = (SimpleDemandedStatus)
	// ssn_wrapper._myPart.getDemandedStatus();
	...
	//// ", p0:" + df.format(polarSol[0]) + ", p1:" + df.format(polarSol[1]) + ",
	////////////////////////////////////////////////////////////////////////////////////////////////// p2:"
	////////////////////////////////////////////////////////////////////////////////////////////////// +
	// df.format(polarSol[2]) +
	...
	// }
	//
	// private String writeReplay(final long newTime, String str, final String name,
	////////////////////////////////////////////////////////////////////////////////////////////////// final
	////////////////////////////////////////////////////////////////////////////////////////////////// String
	////////////////////////////////////////////////////////////////////////////////////////////////// sym,
	// final ParticipantWrapper ssk_wrapper)
	// {
	// str += MWC.Utilities.TextFormatting.DebriefFormatDateTime.toString(newTime);
	// str += " " + name + " " + sym + " ";
	// str +=
	// MWC.Utilities.TextFormatting.DebriefFormatLocation.toString(ssk_wrapper._myPart.getStatus().getLocation());
	// str += " " ;
	// str +=
	// MWC.Utilities.TextFormatting.GeneralFormat.formatOneDecimalPlace(ssk_wrapper._myPart.getStatus().getCourse());
	// str += " " ;
	// str +=
	// MWC.Utilities.TextFormatting.GeneralFormat.formatOneDecimalPlace(ssk_wrapper._myPart.getStatus().getSpeed().getValueIn(WorldSpeed.M_sec));
	// str += " " ;
	// str +=
	// MWC.Utilities.TextFormatting.GeneralFormat.formatOneDecimalPlace(ssk_wrapper._myPart.getStatus().getLocation().getDepth());
	// str += " " ;
	// return str;
	// }
	//
	// private void doStep(final ParticipantWrapper sensor, final ParticipantWrapper
	////////////////////////////////////////////////////////////////////////////////////////////////// target,
	...
	// target._myPart.getStatus().getLocation().subtract(sensor._myPart.getStatus().getLocation());
	// final double brg = sep.getBearing();
	// final double brgMeasured = brg - SIG_B +
	////////////////////////////////////////////////////////////////////////////////////////////////// ASSET.Util.RandomGenerator.nextRandom()
	////////////////////////////////////////////////////////////////////////////////////////////////// *
	////////////////////////////////////////////////////////////////////////////////////////////////// SIG_B
	////////////////////////////////////////////////////////////////////////////////////////////////// *
	////////////////////////////////////////////////////////////////////////////////////////////////// 2;
	...
	// final double course =
	// MWC.Algorithms.Conversions.Degs2Rads(target._myPart.getStatus().getCourse());
	// final double speed =
	////////////////////////////////////////////////////////////////////////////////////////////////// target._myPart.getStatus().getSpeed().getValueIn(WorldSpeed.M_sec);
	// time /= 1000;
	// lastTime /= 1000;
	// double res = 4;
	...
	//// System.out.println(" input: " + "singular: " + track.singular[0] + "
	////////////////////////////////////////////////////////////////////////////////////////////////// manoeuvre:"
	////////////////////////////////////////////////////////////////////////////////////////////////// +
	// track.manoeuvre[0] + " new time:" + time + " last time:" +
	////////////////////////////////////////////////////////////////////////////////////////////////// lastUpdateTime[0]);
	//// System.out.println(" Cut: brg:" + df.format(brg) + " (" +
	////////////////////////////////////////////////////////////////////////////////////////////////// df.format(Math.toDegrees(brg))
	////////////////////////////////////////////////////////////////////////////////////////////////// +
	////////////////////////////////////////////////////////////////////////////////////////////////// "
	// degs)"
	//// + " meas brg:" + df.format(brgMeasured) + " (" +
	////////////////////////////////////////////////////////////////////////////////////////////////// df.format(Math.toDegrees(brgMeasured))
	////////////////////////////////////////////////////////////////////////////////////////////////// +
	////////////////////////////////////////////////////////////////////////////////////////////////// "
	// degs)"
	//// + " rng:" + df.format(rng)
	//// + " crse:" + df.format(course) + " (" + df.format(Math.toDegrees(course)) +
	////////////////////////////////////////////////////////////////////////////////////////////////// "
	////////////////////////////////////////////////////////////////////////////////////////////////// degs)"
	//// + " spd:" + df.format(speed));
	//
	...
	//
	//
	// System.out.println("--output: " + "singular: " + track.singular[0] + "
	////////////////////////////////////////////////////////////////////////////////////////////////// manoeuvre:"
	////////////////////////////////////////////////////////////////////////////////////////////////// +
	// track.manoeuvre[0] + " new time:|| " + time + " || last time:" +
	////////////////////////////////////////////////////////////////////////////////////////////////// lastUpdateTime[0]);
	// System.out.println(" Target: " + "x:" + df.format(track.target[0]) + " y:" +
	// df.format(track.target[1])
	...
	//
	//
	// final double res = TMAHandler.InitialiseNonFreq( track.target, sensor4,
	////////////////////////////////////////////////////////////////////////////////////////////////// target5,
	...
	//// ;; symb, date, time, lat, long, orientation, maxima (yards), minima
	////////////////////////////////////////////////////////////////////////////////////////////////// (yards),
	////////////////////////////////////////////////////////////////////////////////////////////////// label
	//
	//
	...
	////////////////////////////////////////////////////////////////////////////////////////////////// sensor._myPart.getStatus().getLocation().add(sep);
	//
	// String str = ";ELLIPSE: @";
	...
	// str += "E ";
	// }
	// str += MWC.Utilities.TextFormatting.DebriefFormatDateTime.toString(time *
	////////////////////////////////////////////////////////////////////////////////////////////////// 1000);
	// str += " ";
	// str += MWC.Utilities.TextFormatting.DebriefFormatLocation.toString(origin);
	// str += " ";
	// str +=
	// MWC.Utilities.TextFormatting.GeneralFormat.formatOneDecimalPlace(MWC.Algorithms.Conversions.Rads2Degs(Orientation[0]));
	// str += " ";
	// str +=
	////////////////////////////////////////////////////////////////////////////////////////////////// MWC.Utilities.TextFormatting.GeneralFormat.formatOneDecimalPlace(Axis1[0]
	////////////////////////////////////////////////////////////////////////////////////////////////// *
	////////////////////////////////////////////////////////////////////////////////////////////////// 0.9144);
	// str += " ";
	// str +=
	////////////////////////////////////////////////////////////////////////////////////////////////// MWC.Utilities.TextFormatting.GeneralFormat.formatOneDecimalPlace(Axis2[0]
	////////////////////////////////////////////////////////////////////////////////////////////////// *
	////////////////////////////////////////////////////////////////////////////////////////////////// 0.9144);
	// str += " ";
	//
	// // System.out.println("orient:" + Math.toDegrees(Orientation[0]) + " axis1:"
	////////////////////////////////////////////////////////////////////////////////////////////////// +
	////////////////////////////////////////////////////////////////////////////////////////////////// Axis1[0]
	////////////////////////////////////////////////////////////////////////////////////////////////// +
	////////////////////////////////////////////////////////////////////////////////////////////////// "
	// axis2:" + Axis2[0]);
	//
	// final java.text.SimpleDateFormat dateF = new
	...
	// }
	//
	// // System.out.println("axis1:" + Axis1[0] + ", 2:" + Axis2[0] + " Orient:" +
	////////////////////////////////////////////////////////////////////////////////////////////////// Orientation[0]);
	//
	// }
	//
