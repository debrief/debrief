...
public class SonarBuoy extends CoreParticipant {
	 ...
	 *
	 */
	public SonarBuoy(final int id, final Status status, final String name) {
	...
	public void initialise() {
		...
		this.getMovementChars()
				.setMinHeight(new WorldDistance(this.getStatus().getLocation().getDepth(), WorldDistance.METRES));

		// set our max speed
		this.getMovementChars().setMaxSpeed(new WorldSpeed(0, WorldSpeed.M_sec));

		// and set the sensor
		final BroadbandSensor bb = new BroadbandSensor(12);
