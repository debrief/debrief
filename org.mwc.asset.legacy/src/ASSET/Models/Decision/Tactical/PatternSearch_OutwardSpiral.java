 ...
 */
public final class PatternSearch_OutwardSpiral extends PatternSearch_Core
		implements Serializable
{
	 ...
	 */
	public PatternSearch_OutwardSpiral(final WorldLocation myOrigin,
	...
	protected WorldPath createSearchRoute(WorldLocation currentLocation)
	{
		...
		WorldLocation origin = new WorldLocation(getOrigin().getLat() + _heightDegs
				/ 2, getOrigin().getLong() + _widthDegs / 2, 0);
	...
	// ////////////////////////////////////////////////////////////////////////////////////////////////
	public static final class SpiralOutTest extends
			SupportTesting.EditableTesting
	{
		...
		{
			PatternSearch_Core ladder = new PatternSearch_OutwardSpiral(
		...
		{
			PatternSearch_Core ladder = new PatternSearch_OutwardSpiral(null,
			...
			assertEquals("first point right", " x,79999,y,79999",
					SupportTesting.toXYString(path.getLocationAt(0)));
			assertEquals("second point right", " x,99999,y,79999",
					SupportTesting.toXYString(path.getLocationAt(1)));
			assertEquals("11th point right", " x,140000,y,140000",
		...
		{
			PatternSearch_Core ladder = new PatternSearch_OutwardSpiral(
					new WorldLocation(2, 2, 0), new WorldDistance(20, WorldDistance.KM),
					null, null, "test search", new WorldDistance(160, WorldDistance.KM),
					new WorldDistance(160, WorldDistance.KM));
			...
			assertEquals("first point right", " x,302240,y,302240",
					SupportTesting.toXYString(path.getLocationAt(0)));
			assertEquals("second point right", " x,322240,y,302240",
					SupportTesting.toXYString(path.getLocationAt(1)));
			assertEquals("11th point right", " x,362239,y,362239",
					SupportTesting.toXYString(path.getLocationAt(10)));
		}
	}
