 ...
 */
public final class PatternSearch_OutwardSpiral extends PatternSearch_Core implements Serializable {

	// ////////////////////////////////////////////////
	// editable properties
	// ////////////////////////////////////////////////
	static public class SpiralOutInfo extends EditorType {
		/**
		 * constructor for editable details of a set of Layers
		 *
		 * @param data the Layers themselves
		 */
		public SpiralOutInfo(final PatternSearch_Core data) {
	...
	// ////////////////////////////////////////////////////////////////////////////////////////////////
	public static final class SpiralOutTest extends SupportTesting.EditableTesting {
		...
		public SpiralOutTest(final String s) {
			super(s);
		...
		public Editable getEditable() {
			final PatternSearch_Core ladder = new PatternSearch_OutwardSpiral(new WorldLocation(1, 1, 1),
		...
		public final void testCreateRoute() {
			final PatternSearch_Core ladder = new PatternSearch_OutwardSpiral(null,
					new WorldDistance(20, WorldDistance.KM), null, null, "test search",
					new WorldDistance(160, WorldDistance.KM), new WorldDistance(160, WorldDistance.KM));
			...
			assertEquals("path of correct length", 14, path.size());

			assertEquals("first point right", " x,79999,y,79999", SupportTesting.toXYString(path.getLocationAt(0)));
			assertEquals("second point right", " x,99999,y,79999", SupportTesting.toXYString(path.getLocationAt(1)));
			assertEquals("11th point right", " x,140000,y,140000", SupportTesting.toXYString(path.getLocationAt(10)));
		}

		public final void testCreateRouteWithOrigin() {
			final PatternSearch_Core ladder = new PatternSearch_OutwardSpiral(new WorldLocation(2, 2, 0),
					new WorldDistance(20, WorldDistance.KM), null, null, "test search",
					new WorldDistance(160, WorldDistance.KM), new WorldDistance(160, WorldDistance.KM));
			...
			assertEquals("first point right", " x,302240,y,302240", SupportTesting.toXYString(path.getLocationAt(0)));
			assertEquals("second point right", " x,322240,y,302240", SupportTesting.toXYString(path.getLocationAt(1)));
			assertEquals("11th point right", " x,362239,y,362239", SupportTesting.toXYString(path.getLocationAt(10)));
		}
		...
		public final void testSpeed() {
			...
			final PatternSearch_Core ladder = new PatternSearch_OutwardSpiral(null,
					new WorldDistance(20, WorldDistance.KM), new WorldDistance(200, WorldDistance.METRES),
					new WorldSpeed(120, WorldSpeed.Kts), "test search", new WorldDistance(160, WorldDistance.KM),
	 ...
	 */
	static final String OUTWARD_SPIRAL = "Performing outward spiral";
	 ...
	 */
	public PatternSearch_OutwardSpiral(final WorldLocation myOrigin, final WorldDistance trackSpacing,
	 ...
	 *
	 * @param currentLocation the current location of the platform
	...
	protected WorldPath createSearchRoute(final WorldLocation currentLocation) {
		...
		final WorldLocation origin = new WorldLocation(getOrigin().getLat() + _heightDegs / 2,
				getOrigin().getLong() + _widthDegs / 2, 0);
		...
		// take us to the first point (regardless of if we are at the BL corner)
		newP = new WorldLocation(origin);
		addPointToRoute(_searchHeight, newP, route);

		while (b > origin.getLong() - _heightDegs / 2 + s) {
			r = r + s;
	...
	protected String getDescriptor() {
		return OUTWARD_SPIRAL;
	}

	@Override
	public EditorType getInfo() {
		if (_myEditor == null)
			_myEditor = new SpiralOutInfo(this);
