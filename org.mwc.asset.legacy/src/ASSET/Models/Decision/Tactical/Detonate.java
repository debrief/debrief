...
/**
 * Our implementation of detonation. A weapon (or vessel) may detonate at an
 * indicate range from an indicated type of target
 */
...
public class Detonate extends CoreDecision implements java.io.Serializable {
	 ...
	 */
	public Detonate(final TargetType myTarget, final WorldDistance detonateRange, final double thePower) {
		super("Detonate");
		_myTarget = myTarget;
