 ...
 */
public final class PatternSearch_Ladder2 extends PatternSearch_Core implements
		Serializable
{
	 ...
	 */
	public PatternSearch_Ladder2(final WorldLocation myOrigin,
	...
	// ////////////////////////////////////////////////////////////////////////////////////////////////
	public static final class LadderSearch2Test extends
			SupportTesting.EditableTesting
	{
		...
		{
			PatternSearch_Core ladder = new PatternSearch_Ladder2(new WorldLocation(1,1,1),
		...
		{
			PatternSearch_Core ladder = new PatternSearch_Ladder2(null,
					new WorldDistance(20, WorldDistance.KM), null, null, "test search",
					new WorldDistance(160, WorldDistance.KM), new WorldDistance(160,
							WorldDistance.KM));
			...
			assertEquals("second point right", " x,159999,y,19999",
					SupportTesting.toXYString(path.getLocationAt(1)));
			assertEquals("11th point right", " x,0,y,99999",
