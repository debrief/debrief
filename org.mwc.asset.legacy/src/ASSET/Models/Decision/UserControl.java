...
/**
 * Our implementation of user control, where the vessel is non-autonomous,
 * obeying the current demanded course, speed, depth
 */
...
public class UserControl extends CoreDecision implements java.io.Serializable {
	...
	// private void fireUpdate(final String type, final ASSET.Models.DecisionType
	// decider)
	// {
	...
	public void setCourse(final double demandedCourse) {
		this._demandedCourse = demandedCourse;
	}

	public void setDepth(final WorldDistance demandedDepth) {
		this._demandedDepth = demandedDepth;
	}

	public void setSpeed(final WorldSpeed demandedSpeed) {
