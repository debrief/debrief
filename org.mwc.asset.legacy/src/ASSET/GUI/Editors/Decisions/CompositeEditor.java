...
public class CompositeEditor extends MWC.GUI.Properties.Swing.SwingCustomEditor
		implements PlainPropertyEditor.EditorUsesPropertyPanel, MWC.GUI.Properties.NoEditorButtons {
	...
	private void updateForm() {
		...
		_conditionEditor = new SwingPropertyEditor2(_myComposite.getCondition().getInfo(),
				(SwingPropertiesPanel) _thePanel, _theLayers, null, null, null);
		_responseEditor = new SwingPropertyEditor2(_myComposite.getResponse().getInfo(),
				(SwingPropertiesPanel) _thePanel, _theLayers, null, null, null);
	}
