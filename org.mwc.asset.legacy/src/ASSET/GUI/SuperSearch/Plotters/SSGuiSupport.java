...
public class SSGuiSupport extends MWC.GUI.BaseLayer implements ASSET.Scenario.ParticipantsChangedListener {
	...
	public static class GuiSupportTest extends SupportTesting.EditableTesting {
		...
		public Editable getEditable() {
			final SSGuiSupport ed = new SSGuiSupport();
	 ...
	 * *********************************************************************
	 */
	public static class ParticipantListener implements ASSET.Participants.ParticipantMovedListener, MWC.GUI.Plottable {
		...
		public ParticipantListener(final ASSET.ParticipantType part, final SSGuiSupport parent) {
			_myPart = part;
			_myParent = parent;
		}
		...
		public int compareTo(final Plottable arg0) {
			final ParticipantListener other = (ParticipantListener) arg0;
	 ...
	 */
	public ParticipantListener getNewParticipantListener(final ParticipantType part) {
	...
	public void setScenarioStepTime(final Duration duration) {
	 ...
	 */
	public void setShowActivities(final boolean showActivities) {
	...
	public void setStepTime(final Duration duration) {
