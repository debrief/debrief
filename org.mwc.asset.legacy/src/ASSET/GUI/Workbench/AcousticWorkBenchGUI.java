...
public class AcousticWorkBenchGUI extends WorkBenchGUI {
	...
	protected void addUniqueComponents(final CoreGUISwing.MyToolbarHolder assetHolder) {
		...
		final ScenarioNoiseLevelPainter ap = new ScenarioNoiseLevelPainter(_theScenario.getEnvironment(), this,
				EnvironmentType.BROADBAND_PASSIVE, this.getChart().getLayers());
		...
		final NoiseSourcePainter nsp = new NoiseSourcePainter(noiseSource, 180, _theScenario.getEnvironment(),
