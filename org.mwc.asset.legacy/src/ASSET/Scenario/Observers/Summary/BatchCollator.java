...
/**
 * Definition of type which is able to summarize performance across a series of
 * runs Created by IntelliJ IDEA. User: Ian.Mayo Date: 12-Aug-2004 Time:
 * 13:32:20 To change this template use File | Settings | File Templates.
 */
public interface BatchCollator extends InterScenarioObserverType {
	...
	/**
	 * provide a listing of the instances provided, each annotated with it's
	 * scenario
	 */
	 ...
	 */
	public void setBatchCollationProcessing(String fileName, String collationMethod, boolean perCaseProcessing,
			boolean isActive);
