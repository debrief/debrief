 ...
 *
 */
public class StopOnElapsedObserver extends CoreObserver
		implements ASSET.Scenario.ScenarioSteppedListener, ScenarioObserver.ScenarioReferee, Serializable {
	//////////////////////////////////////////////////
	// editable properties
	//////////////////////////////////////////////////
	 ...
	 ***************************************************************/
	/**
	 * default constructor, taking the elapsed time after which the scenario should
	 * be stopped
	 *
	 * @param elapsed elapsed milliseconds since scenario start time
	 */
	public StopOnElapsedObserver(final Duration elapsed, final String name, final boolean isActive) {
		super(name, isActive);
	 ...
	 */
	public StopOnElapsedObserver(final int days, final int hours, final int mins, final int secs, final String name,
			final boolean isActive) {
		this(new Duration((days * 24 * 60 * 60 * 1000) + (hours * 60 * 60 * 1000) + (mins * 60 * 1000) + (secs * 1000),
				Duration.MILLISECONDS), name, isActive);
	}
	...
	public void setElapsed(final Duration val) {
		_elapsedTime = val;
	}
