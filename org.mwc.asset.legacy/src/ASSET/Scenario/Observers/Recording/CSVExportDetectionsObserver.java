...
public class CSVExportDetectionsObserver extends RecordStatusToFileObserverType {
	 ...
	 */
	public CSVExportDetectionsObserver(final String directoryName, final String fileName,
		...
		super(directoryName, fileName, true, false, false, subjectToTrack, observerName, isActive);
	...
	private void outputThisLocation(final WorldLocation loc, final java.io.OutputStreamWriter os,
	...
	protected void writeTheseDetectionDetails(final ParticipantType pt, final DetectionList detections,
		...
		final boolean subjectValid = _subjectName == null || _subjectName.equals(pt.getName());
		...
		if (subjectValid) {
			...
			while (iter.hasNext()) {
				...
				final boolean sensorValid = _sensorName == null || _sensorName.equals(theSensor.getName());
				...
				if (sensorValid) {
					...
					final String strengthStr = de.getStrength() == null ? "N/A"
							: threeDP.format(de.getStrength().floatValue());
