 ...
 *
 */
public class TowedArrayLocationObserver
  extends RecordStatusToFileObserverType
{
                          ...
                          final String sensorName)
  {
    ...
    case "TA_MODULES":
      ...
      break;
    case "LOC_RELATIVE":
      _recorderType = RecorderType.LOC_RELATIVE;
      break;
    case "LOC_ABSOLUTE":
      _recorderType = RecorderType.LOC_ABS;
      break;
    default:
      _recorderType = RecorderType.HDG_DEPTH;
    }
  ...
  public void writeThesePositionDetails(MWC.GenericData.WorldLocation loc,
                                        ...
                                        long newTime)
  {
    ...
    if(lastLoc != null)
    {
      bearingRads = loc.subtract(lastLoc).getBearing();
    }
    else
    {
      bearingRads = 0d;
    ...
    Fix newFix = new Fix(debTime, loc, bearingRads, 4d);
    ...
    for(Double thisO: _offsets)
    {
      ...
      if(pos != null)
      {
        WorldLocation aLoc = pos.getLocation();
