...
public class OpenScenarioXML extends MWC.GUI.Tools.Operations.Open {
	...
	static public class OpenScenarioAction implements Action {
		 ...
		 */
		private final ServerType _myServer;
		/**
		 ...
		 */
		public OpenScenarioAction(final String theFileName, final ServerType server,
	...
	public OpenScenarioXML(final ToolParent theParent, final ServerType server, final MWC.GUI.PlainChart theChart) {
		super(theParent, "Open Scenario", new String[] { "*" + mySuffix }, "Asset Scenario Files (*" + mySuffix + ")");
