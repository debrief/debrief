...
abstract public class PatternLadder2_SearchHandler extends PatternSearchCore_Handler {
	...
	protected PatternSearch_Core getModel() {
		return new PatternSearch_Ladder2(_origin, _spacing, _searchHeight, _searchSpeed, null, _height, _height);
	}
