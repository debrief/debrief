...
abstract public class PatternInwardSpiral_SearchHandler extends PatternSearchCore_Handler {
	...
	protected PatternSearch_Core getModel() {
		return new PatternSearch_InwardSpiral(_origin, _spacing, _searchHeight, _searchSpeed, null, _height, _height);
	}
