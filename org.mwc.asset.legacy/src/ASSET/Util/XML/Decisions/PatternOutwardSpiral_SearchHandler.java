...
abstract public class PatternOutwardSpiral_SearchHandler extends PatternSearchCore_Handler {
	...
	protected PatternSearch_Core getModel() {
		return new PatternSearch_OutwardSpiral(_origin, _spacing, _searchHeight, _searchSpeed, null, _height, _height);
	}
