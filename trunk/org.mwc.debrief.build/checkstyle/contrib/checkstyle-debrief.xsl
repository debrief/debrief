...
<xsl:template match="checkstyle">
  ...
  <xsl:template match="file">
    ...
    <h3>File <xsl:value-of select="@name"/> <a href="{translate(@name,'\','/')}">[open]</a></h3>
    ...
    <table class="log" border="0" cellpadding="5" cellspacing="2" width="100%">
      ...
      <tr>
        ...
        <xsl:call-template name="severity-class"/>
        <td class="severity">
        <xsl:value-of select="@severity"/></td>
  ...
  <!-- insert the severity of the error as a class into the parent element  -->
  <xsl:template name="severity-class">
