...
import com.borlander.rac353542.bislider.DragSupport.DragListener;


public class BiSliderPointer extends BiSliderComponentBase implements DragListener, Disposable {
    ...
    public BiSliderPointer(BiSlider biSlider, boolean minNotMax){
        super(biSlider);
