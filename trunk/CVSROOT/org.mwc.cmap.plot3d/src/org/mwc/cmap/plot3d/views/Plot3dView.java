...
import org.mwc.cmap.plot3d.Plot3dPlugin;
...
//		}
	...
	public void createPartControl(Composite parent)
	{
		...
		// now we need a Swing object to put our chart into (though we don't put it in there yet)
...
//		_thePlot.setDataset(dataset);
	...
	public void editMeInProperties()
	{
		...
		if (_myWorld != null)
		{
			EditableWrapper wrappedEditable = new EditableWrapper(_myWorld.getWorld().getWorldPlottingOptions(), null);
