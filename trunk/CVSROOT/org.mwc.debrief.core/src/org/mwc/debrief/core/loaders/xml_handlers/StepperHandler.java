...
public final class StepperHandler implements GUIHandler.ComponentCreator
{
                             ...
                             Debrief.GUI.Views.AnalysisView _analysisView)
  {
    ...
    {
      // set the cursor
      _analysisView.getTote().getStepper().setPainter(cursor);
      ...
      if (cursor.equals(SnailPainter.SNAIL_NAME))
      {
        ...
        {
          // set the cursor
          SnailPainter sp = (SnailPainter) _analysisView.getTote().getStepper().getCurrentPainter();
  ...
  public final GUIHandler.ComponentDetails exportThis(TimeController _controller)
  {
    // get the stepper
    Debrief.GUI.Views.PlainView pv = null;
