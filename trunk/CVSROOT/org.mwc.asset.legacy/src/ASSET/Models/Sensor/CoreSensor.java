  ...
  java.io.Serializable, MWCModel
{
  ...
  /**
   * the time of the last scan (which we remember so that we
   * can correctly observe the _TBDO value
   */
  ...
  /**
   * remove any of our past detections from the list. Detections stay valid between TBDOs, to
   * give some degree of persistnce
   *
  ...
  private void removeMyOldDetections(DetectionList existingDetections)
  {
    ...
    if (existingDetections != null)
    {
      ...
      Vector ditchThese = new Vector(0, 1);
