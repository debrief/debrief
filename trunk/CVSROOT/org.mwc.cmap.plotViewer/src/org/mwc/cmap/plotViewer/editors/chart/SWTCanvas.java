 ...
 */
public class SWTCanvas implements CanvasType,
  Serializable,
  Editable
{
  ...
  protected void repaintMe(GC gc)
	{
  	// ok - do the paint/
  	paintPlot(gc);
	}
...
//    return _theDest.drawImage(img, x, y, width, height, observer);
  ...
  public final void setColor(final java.awt.Color theCol)
  {
    ...
    // transfer the color 
    Color newCol = ColorHelper.convertColor(theCol);
...
//    _theDest.drawString(theStr, x, y);
  ...
  {
  	Color swtCol = ColorHelper.convertColor(theColor); 
...
//    repaint();
  	System.err.println("should be doing update!!!");
  	_myCanvas.update();
  }
