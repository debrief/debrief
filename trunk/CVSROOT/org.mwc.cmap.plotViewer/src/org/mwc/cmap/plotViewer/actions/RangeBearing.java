...
final public class RangeBearing extends CoreDragAction
{
	...
	final public static class RangeBearingMode extends SWTChart.PlotMouseDragger
	{
		...
		final private void plotUpdate(GC dest)
		{
			...
			java.awt.Point endPoint = new java.awt.Point(_lastRect.x + _lastRect.width, _lastRect.y + _lastRect.height);
			...
			String myUnits = CorePlugin.getToolParent().getProperty(MWC.GUI.Properties.UnitsPropertyEditor.UNITS_PROPERTY);
			...
			java.awt.Point loc = new java.awt.Point(_lastRect.x + _lastRect.width / 2, _lastRect.y
					+ _lastRect.height / 2);
