...
final public class WorldSpeed implements Serializable
{
	...
	{ 1, MWC.Algorithms.Conversions.Mps2Kts(1),
	...
	/** SPECIAL constructor created to help Kryo get Speed values across the LAN for ASSET
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *          the distance in the supplied units
	 * @param units
	...
	static public final class SpeedTest extends junit.framework.TestCase
	{
		...
		public final void testWorldDistanceUnits()
		{
			...
			assertEquals("retrieve m/s label",
					WorldSpeed.getLabelFor(WorldSpeed.M_sec), "m/s");
			assertEquals("retrieve ft/s label",
					WorldSpeed.getLabelFor(WorldSpeed.ft_sec), "ft/s");
			assertEquals("retrieve kts label",
