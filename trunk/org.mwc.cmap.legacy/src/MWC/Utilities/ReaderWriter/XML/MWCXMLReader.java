...
public class MWCXMLReader extends DefaultHandler
{
                           ...
                           final Attributes attributes) throws SAXException
  {
      ...
      if (_myHandlers != null)
      {
        ...
        while (enumer.hasMoreElements())
        {
          ...
          if (hand.canHandleThis(localName))
          {
            ...
            {
              MWC.Utilities.Errors.Trace.trace(e, "Trouble handling attribute:" + localName);
            }
    ...
    if (!handled)
    {
      ...
      {
        MWC.Utilities.Errors.Trace.trace("MWCXMLReader failed to find handler for:" + localName + " when handling:" + _myType, false);
        throw new java.lang.RuntimeException("\"" + localName + "\"" + HANDLER_NOT_FOUND_MESSAGE);
      }
    }
  }
  ...
  static public double readThisDouble(final String val) throws java.text.ParseException
  {
    // parse the text
