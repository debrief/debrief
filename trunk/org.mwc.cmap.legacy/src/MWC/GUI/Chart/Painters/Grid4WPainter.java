		...
		public PropertyDescriptor[] getPropertyDescriptors()
		{
			try
			{
				PropertyDescriptor[] res =
				{
						...
						prop("XMin", "the min index shown on the x-axis (A-AZ)", SPATIAL),
						prop("XMax", "the max index shown on the x-axis (A-AZ)", SPATIAL),
						prop("YMin", "the min index shown on the y-axis (A-AZ)", SPATIAL),
						prop("YMax", "the max index shown on the y-axis (A-AZ)", SPATIAL),
