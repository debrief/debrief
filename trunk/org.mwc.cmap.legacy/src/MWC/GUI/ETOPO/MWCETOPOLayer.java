 ...
 * <p>
 * The MWCETOPOLayer also relies on properties to set its
 ...
 * and some other display variables.  The MWCETOPOLayer properties
...
//    {1800., 3500., 7000., 10500.}; //ep-g
	...
	if (omGraphicList != null) {
	    ...
	    Debug.message("basic", getName()+
			  "|MWCETOPOLayer.prepare(): finished with "+
			  size+" graphics");
	}
	else 
	    Debug.message("basic", getName()+
	...
	if (palette == null) {
	    ...
	    String[] resStrings = { "5 Minute", "10 Minute", "15 Minute"};
		...
		public void actionPerformed(ActionEvent e) {
			...
			spacingReset = true;
		    switch(newRes) {
		    case 0: minuteSpacing = 5; break;
		    case 1: minuteSpacing = 10; break;
		    case 2: minuteSpacing = 15; break;
		    }
