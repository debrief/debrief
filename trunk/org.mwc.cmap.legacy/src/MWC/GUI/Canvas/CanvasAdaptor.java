...
public  class CanvasAdaptor implements MWC.GUI.CanvasType
{
    ...
    private MWC.Algorithms.PlainProjection _proj;
      ...
      public CanvasAdaptor(MWC.Algorithms.PlainProjection proj, java.awt.Graphics dest) {
        _proj = proj;
        _dest = dest;
      }
   ...
   */
      ...
      {
        java.awt.BasicStroke stk = MWC.GUI.Canvas.Swing.SwingCanvas.getStrokeFor(style);
