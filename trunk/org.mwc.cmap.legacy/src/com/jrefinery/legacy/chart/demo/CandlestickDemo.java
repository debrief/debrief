 ...
 * Contributor(s):   -;
 *
 * $Id: CandlestickDemo.java,v 1.1.1.1 2003/07/17 10:06:31 Ian.Mayo Exp $
 *
 * Changes
 * -------
...
import com.jrefinery.legacy.chart.Marker;
...
public class CandlestickDemo extends ApplicationFrame {
    ...
    public CandlestickDemo(String title) {
        ...
        HighLowDataset dataset = DemoDatasetFactory.createSampleHighLowDataset();
