...
/**
 * Comparator for dealing with diamond tree nodes.
 *
 * @author Justin Couch
 * @version $Revision: 1.1.1.1 $
 */
class DiamondComparator implements Comparator<TreeNode>
{
    //----------------------------------------------------------
     ...
     * @return true if the other object is also a DiamondComparator
     */
    public boolean equals(Object o)
    {
        return (o instanceof DiamondComparator);
    }
