...
class DynamicClassLoader
{
  ...
  private static final String NULL_NAME_MSG =
      "Name supplied is null or zero length";

  /** Message in the exceptions when the base class name is not useful */
  private static final String NULL_BASE_MSG =
      "Base class name supplied is null or zero length";

  /**
   * Message in the exceptions when a class does not implement the
   * correct base class required by the caller.
   */
  private static final String BACKGROUND_MSG =
    "The class does not implement the correct base class";
