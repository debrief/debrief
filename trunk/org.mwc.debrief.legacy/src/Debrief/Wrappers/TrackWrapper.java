        ...
        DraggableItem, HasDraggableComponents, ProvidesContiguousElements
{
    ...
    private void paintTrack(final CanvasType dest, final Color nextCol, final Point nextPt)
    {
        ...
        if (getVisible())
        {
            ...
            while (fixWrappers.hasMoreElements())
            {
                ...
                if (!fw.getVisible())
                {
                    ...
                    // we do get a visible point, it isn't connected to the
                    // previous...
                    lastP = null;
                }
                else
                    ...
                    if (_linkPositions)
                    {
                        ...
                        else
                        {
                            ...
                            if (fw.getLineShowing())
                                dest.drawLine(lastP.x, lastP.y, thisP.x,
                                        thisP.y);
                        }
