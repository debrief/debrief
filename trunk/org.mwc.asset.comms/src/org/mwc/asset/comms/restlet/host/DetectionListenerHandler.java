...
public class DetectionListenerHandler extends ASSETResource implements
		ListenerResource
{
	...
	public int accept(String listenerTxt)
	{
		...
		try
		{
			...
			res = host.getHost().newParticipantDetectionListener(getScenarioId(),
	...
	public void remove()
	{
		...
		ASSETHost.HostProvider host = (HostProvider) getApplication();
		host.getHost().deleteParticipantDetectionListener(getScenarioId(),
