...
/**
 * the demanded status for this participant.  The demanded status represents the output of a
 * {@link ASSET.Models.DecisionType decision model}, and is used as an input to the
 * {@link ASSET.Models.MovementType manoeuvering model} .
 */
...
abstract public class DemandedStatus
{
  ...
  protected DemandedStatus(final long id,
                           final long time)
  {
    _id = id;
    _time = time;
