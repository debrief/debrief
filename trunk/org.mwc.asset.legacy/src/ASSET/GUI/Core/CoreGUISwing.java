  ...
  MyMetalToolBarUI.ToolbarOwner
{
  ...
  {
    final java.beans.PropertyEditorManager pm = new java.beans.PropertyEditorManager();
    pm.registerEditor(Color.class,
                      MWC.GUI.Properties.Swing.ColorPropertyEditor.class);


    // add our editors
    pm.registerEditor(ASSET.Models.Decision.TargetType.class,
  ...
  {
    // do the splash
    final SplashScreen ss = new SplashScreen(parent,
                                             imageName,
                                             "Built:" + ASSET.GUI.VersionInfo.getVersion(), Color.LIGHT_GRAY);
  }
  ...
  protected void addThisTool(final MWC.GUI.Tools.MenuItemInfo item)
  {
    ...
    {
      thisToolbar.addToggleTool(item.getMenuName(),
                                item.getTool(),
                                item.getShortCut(),
                                item.getMnemonic());
    }
  ...
  public static class ASSETParent implements ToolParent
  {
    ...
    {
      _frame.setCursor(_frame.getCursor().getDefaultCursor());
    };
    ...
    public java.util.Map getPropertiesLike(final String pattern)
    {
