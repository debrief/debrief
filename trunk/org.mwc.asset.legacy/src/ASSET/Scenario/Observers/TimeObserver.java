  ...
  ScenarioObserver.ScenarioReferee
{
   ...
   */
  public TimeObserver(Duration elapsed, String name, final boolean isActive)
  {
    super(name, isActive);
   ...
   */
  public TimeObserver(final int days, final int hours, final int mins, final int secs,
  ...
  public static class TimeObsTest extends SupportTesting.EditableTesting
  {
    ...
    {
      return new TimeObserver(12, 12, 12, 12, "", true);
    }
  }
