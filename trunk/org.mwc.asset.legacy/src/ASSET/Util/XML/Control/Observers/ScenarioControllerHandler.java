...
abstract public class ScenarioControllerHandler extends MWC.Utilities.ReaderWriter.XML.MWCXMLReader
{
  ...
  private Vector _myObserverList;
  ...
  private Integer _randomSeed = null;
  ...
  public ScenarioControllerHandler()
  {
    ...
    addHandler(new ScenarioGeneratorHandler()
    {
      ...
      {
        // don't bother doing anything, we're just including this to stop an error being thrown
        // later on
      }
    });
  }
  ...
  public static void exportThis(final Vector list,
