...
abstract public class WaterfallHandler extends CoreDecisionHandler
{
  ...
  // control this, by only allowing Chains to nest 5 deep (at the fifth level, don't add
   ...
   */
  private void addHandlers(MWCXMLReader list, final WaterfallHandler handler, int thisDepth)
  {
    if(thisDepth > 0)
    {
