...
public class RestSupport
{
	...
	public boolean doConnect()
	{
		...
		_myGuest.newScenarioEvent(0, "Setup", "Listening to scenario:" + _scenarioId);
	...
	public void doDisconnect()
	{
		if (_scenarioListenerId != NULL_INT)
		{
			ClientResource cr = new ClientResource(
					"http://localhost:8080/v1/scenario/" + _scenarioId
	...
	public void doTakeControl()
	{
		...
		_partListenerId = sl.accept("http://localhost:8081/v1/scenario/" + _scenarioId
