...
public class DataSupport
{
  ...
  public static JFreeChart createChart(final XYDataset dataset)
  {
    ...
    final JFreeChart chart =
        ChartFactory.createTimeSeriesChart("Bearing Management", // title
            "Time", // x-axis label
  ...
  {
    final long delay =
        (int) (Math.random() * 210) * 60000 + (int) (Math.random() * 5 * 1000);
    return delay;
  }
  ...
  {
    final long delay =
        (int) (Math.random() * 90) * 60000 + (int) (Math.random() * 500 * 1000);
    return delay;
  }
          ...
          if (nearest != null)
            if (nearest.length > 0)
            {
              ...
              final WorldVector offset =
                  thisLoc.getLocation().subtract(thisP.getLocation());
              final double thisVal =
                  MWC.Algorithms.Conversions.Rads2Degs(offset.getBearing());
  ...
  /**
   * Deletes any sensor data that is outside the start/finish period of the primary track.
   * 
   * @param primary
   * @param index
   * @return
  ...
  /**
   * Deletes all blocks of sensor data that are more than 45 degrees from an secondary track.
   * 
   * @return
   */
    ...
    while (sensors.hasMoreElements())
    {
      ...
      while (sensor != null && (contacts.hasMoreElements()))
      {
        final SensorContactWrapper contact =
            (SensorContactWrapper) contacts.nextElement();
        ...
        else
        {
          ...
          for (int i = 0; i < secondaries.length; i++)
          {
            ...
            double bearingDelta =
                contact.getBearing() - Math.toDegrees(bearing);
  ...
  static public final class DataSupportTest extends junit.framework.TestCase
  {
    ...
    private TrackWrapper getDummyPrimary()
    {
      ...
      final SensorContactWrapper scwa1 =
          new SensorContactWrapper("aaa", new HiResDate(150, 0), null,
              new Double(15), null, null, null, 0, null);
      final SensorContactWrapper scwa2 =
          new SensorContactWrapper("bbb", new HiResDate(180, 0), null,
              new Double(15), null, null, null, 0, null);
      final SensorContactWrapper scwa3 =
          new SensorContactWrapper("ccc", new HiResDate(250, 0), null,
      ...
      final SensorContactWrapper scw3 =
          new SensorContactWrapper("fff", new HiResDate(650, 0), null, null,
              null, null, null, 0, null);
      _sw2a.add(scw1);
      _sw2a.add(scw2);
      _sw2a.add(scw3);
    ...
    private TrackWrapper getDummySecondary()
    {
      ...
      final FixWrapper fw3 =
          new FixWrapper(new Fix(new HiResDate(300, 30000), loc_1
              .add(new WorldVector(33 + 200, new WorldDistance(300,
                  WorldDistance.METRES), null)), 30, 130));
      fw3.setLabel("fw3");
