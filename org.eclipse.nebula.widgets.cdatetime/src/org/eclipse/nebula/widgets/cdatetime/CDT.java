 ...
 * Widget Toolkit (SWT) and has been created separately to avoid collisions.
 * <p>
 * Note that, unlike the SWT class, these constants apply for all platforms
 * (upon which CDateTime has been tested) because the CDateTime is a custom
 * widget.
 * </p>
 */
public class CDT {
	...
	public enum PickerPart {
		BodyPanel, HeaderPanel, MonthLabel, MonthPrev, MonthNext, DateNow, YearPrev, YearNext, YearLabel,
		DayOfWeekPanel, DayOfWeekLabel, DayPanel, DayButton, FooterPanel, TodayButton, ClearButton, OkButton,
	...
	/**
	 * Style constant requesting a border. This value will be converted to its SWT
	 * equivalent and passed to the SWT super (value is 1&lt;&lt;0).
	 * 
	 * @see SWT#BORDER
	 */
	...
	/**
	 * Style constant for a DropCombo with its button to the Left of the text (value
	 * is 1&lt;&lt;14).
	 * 
	 * @see #BUTTON_RIGHT
	 */
...
///////////////////////////////////////////////////////////////////////////////////////
	...
	/**
	 * Style constant specifying the CDateTime be created in compact mode (value is
	 * 1&lt;&lt;15).
	 */
	 ...
	 * CDateTime's fields (value is 1&lt;&lt;19).
	 */
	public static final int TAB_FIELDS = 1 << 25;

	/**
	 * Style constant indicating that the CDateTime should created with a spinner
	 * (value is 1&lt;&lt;26).
	 */
	public static final int SPINNER = 1 << 26;

	/**
	 * Style constant indicating that the CDateTime should created with a discrete
	 * clock, rather than an analog clock (value is 1&lt;&lt;27).
	 */
