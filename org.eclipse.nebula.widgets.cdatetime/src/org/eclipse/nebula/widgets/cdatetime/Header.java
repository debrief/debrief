...
public class Header {
	...
	private Header(final int type, final int... field) {
		this.type = type;
		this.fields = field;
	}

	public Header align(final int alignment) {
		this.alignment = alignment;
		return this;
	}

	public Header align(final int textAlignment, final int controlAlignment, final boolean grab) {
