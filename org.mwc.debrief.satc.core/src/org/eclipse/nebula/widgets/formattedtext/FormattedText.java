 ...
 * 
 * <h4>Styles:</h4>
 * <blockquote> CENTER, LEFT, RIGHT, READ_ONLY </blockquote>
 */
public class FormattedText
{
	 ...
	 * 
	 * @param beepSound
	 *          true to emit beep sound on errors, else false
	 */
	 ...
	 * <code>false</code>.<br>
	 * An empty value depends of the formatter applied on the Text widget and is
	 * not just an empty String in the widget. Formatters can use special
	 * formatting characters to format the value. These characters are not always
	 * considered as part of the value. For example, in a DateFormatter the
	 * pattern uses "/" separator and always displays it in the input field.
	 * 
	 ...
	 * 
	 * @param value
	 *          The String value to display in the widget
	 */
	...
	public void setValue(Object value)
	{
		...
		formatter.setIgnore(true);
		text.setText(text.isFocusControl() ? formatter.getEditString() : formatter
				.getDisplayString());
		formatter.setIgnore(false);
	}
}
