...
public class UnitConverter {
	...
	public static UnitConverter scale(final UnitConverter converter, final double scale) {
		return new UnitConverter(new ScaleConverter(converter.getModelToUI(), scale),
	...
	UnitConverter(final AbstractUnitConverter modelToUI, final AbstractUnitConverter uiToModel) {
