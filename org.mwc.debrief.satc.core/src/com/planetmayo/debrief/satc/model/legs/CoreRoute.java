...
public abstract class CoreRoute {
	 ...
	 *
	 */
	private final LegType _legType;

	protected CoreRoute(final Point startP, final Point endP, final Date startTime, final Date endTime,
			final String name, final LegType legType) {
		_startP = startP;
		_endP = endP;
	...
	public State getStateAt(final Date time) {
		for (final State state : _myStates) {
	...
	public void setScore(final Double thisScore) {
		_myScore = thisScore;
	}
