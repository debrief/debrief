...
public interface SAFunctions {
	...
	/**
	 * Function to change temperature based on saParameters, current temperature and
	 * current step Temperature must decrease from step to step
	 * 
	...
	/**
	 * returns probability to accept worse solution based on current score, new
	 * score and current temperature
	 * 
