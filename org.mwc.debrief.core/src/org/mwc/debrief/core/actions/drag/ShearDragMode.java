...
//		private WorldLocation _lastLoc;
		...
		public ShearOperation(final WorldLocation cursorLoc, final WorldLocation origin, final CoreTMASegment segment,
	...
	protected DraggableItem getEndOperation(final WorldLocation cursorLoc, final TrackSegment seg,
			final FixWrapper origin, final TrackWrapper parent, final Layers theLayers) {
		return new ShearOperation(cursorLoc, origin.getFixLocation(), (CoreTMASegment) seg, parent, theLayers);
	}
