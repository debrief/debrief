...
public class GenerateSensorRangePlot implements RightClickContextItemGenerator
{
  ...
  {
    final Vector<SensorWrapper> sensorCandidates =
        new Vector<SensorWrapper>(0, 1);
        ...
        try
        {
          ...
          while (tIter.hasNext())
          {
            ...
            if (trackWrapper != null)
            {
              ...
              {
                outerPeriod =
                    new TimePeriod.BaseTimePeriod(trackWrapper.getStartDTG(),
          ...
          final TimeSeriesCollection theSeriesCollection =
          ...
          if (multiTrackRun)
          {
            ...
            theTitle =
                "(Sensor) Range to "
                    + sensorCandidates.firstElement().getName()
                    + " vs Time plot";
          ...
          else
          {
            ...
            addDataSeries(primaryTrack, sensorCandidates, startTime, endTime,
                theSeriesCollection, !multiTrackRun);
            theTitle =
                "(Sensor) Range to " + primaryTrack.getName() + " vs Time plot";
          }
      ...
      final boolean useSensorName)
  {
    ...
    while (iter.hasMoreElements())
    {
      ...
      else
      {
        ...
        // step through the track
        //
        final Collection<Editable> primaryFixes =
        ...
        if (primaryFixes != null)
        {
          ...
          while (theseFixes.hasNext())
          {
            ...
            if (useSensorName)
            {
              ...
              final Watchable[] thisCut =
                  thisSensor.getNearestTo(thisPosition.getDateTimeGroup());
  ...
  public static class TestCalcs extends TestCase
  {
    ...
    public void NtestIt()
    {
      ...
      for (int i = 0; i < 35; i++)
      {
        final FixWrapper scw =
            getFix(i * 4000, new WorldLocation(1, i, 0), ownship);
        ownship.add(scw);
      }
      ...
      {
        final FixWrapper scw =
            getFix(i * 5000, new WorldLocation(1, i, 0), target);
        target.add(scw);
      }
    ...
    public void NtestMenu()
    {
      ...
      {
        final FixWrapper scw =
            getFix(i * 5000, new WorldLocation(1, i, 0), ownship);
        ownship.add(scw);
      }
