...
public class CSVExportWizard extends Wizard implements INewWizard, ExportTrackAsCSV.CSVAttributeProvider {
	...
	public static final String DEC = "This wizard is used to provide the extra metadata\r\n"
			+ "necessary for exporting tracks to other UK agencies.";
	public static final ImageDescriptor WIZ_IMG = AbstractUIPlugin.imageDescriptorFromPlugin("org.mwc.debrief.core",
			"images/csvexport_wizard.png");

	public static final List<String> PAGE_NAMES = Arrays.asList(CSVExportPage1.PAGE_ID, CSVExportPage2.PAGE_ID,
			CSVExportPage3.PAGE_ID);
	 ...
	 * @param provenance
	 */
	public CSVExportWizard(final DropdownProvider reg, final String unit, final String provenance) {
		super();
