...
public class CSVExportPage2 extends CustomWizardPage {
	...
	private static Text addCaseNumberField(final Composite contents, final String label, final String tooltip,
	...
	protected Composite createDataSection(final Composite parent) {
		...
		classificationCmb = addCmbField(contents, "CLASSIFICATION", "Classification:",
				"Protective marking for this data", true, classification, this, provider);

		suppliedByCmb = addCmbField(contents, "SUPPLIED_BY", "Supplied by:", "Supplier organisation", false, suppliedBy,
				this, provider);

		likelihoodCmb = addCmbField(contents, "LIKELIHOOD", "Likelihood:", "Likelihood of subject identification",
				false, likelihood, this, provider);

		confidenceCmb = addCmbField(contents, "CONFIDENCE", "Confidence:", "Confidence in subject track", false,
				confidence, this, provider);
