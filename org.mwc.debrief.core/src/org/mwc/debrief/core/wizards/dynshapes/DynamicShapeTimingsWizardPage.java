...
/**
 * This is the page used for the showing the timings for all the dynamic shape
 * wizards including sensor arcs.
 *
...
public class DynamicShapeTimingsWizardPage extends DynamicShapeBaseWizardPage {
	...
	public DynamicShapeTimingsWizardPage(final String pageName, final String type, final Date startTime,
			final Date endTime) {
		super(pageName, type);
