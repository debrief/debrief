...
public abstract class DynamicShapeBaseWizardPage extends WizardPage {
	...
	protected DynamicShapeBaseWizardPage(final String pageName, final String shapeName) {
		super(pageName);
	...
	protected Composite createBaseControl(final Composite parent) {
		...
		final Label lblVerticalBar = new Label(control, SWT.SEPARATOR | SWT.VERTICAL);
		...
		font = new Font(Display.getDefault(), new FontData(fontData.getName(), fontData.getHeight(), SWT.BOLD));
