...
abstract public class CoreDynamicShapeWizard<WizardPageType extends DynamicShapeBaseWizardPage> extends Wizard {
	...
	public CoreDynamicShapeWizard(final String shapeName, final Date startDate, final Date endDate) {
	...
	public void addPages() {
		_shapeTimingsPage = new DynamicShapeTimingsWizardPage(DynamicShapeBaseWizardPage.TIMINGS_PAGE, _shapeName,
				_startDate, _endDate);
	...
	public boolean performFinish() {
		...
		if (shape instanceof PolygonShape) {
			_dynamicShape = new DynamicPolygonShapeWrapper(_stylingPage.getShapeLabel(), (PolygonShape) shape, theColor,
					shapeDate, endDate);
		} else {
			_dynamicShape = new DynamicShapeWrapper(_stylingPage.getShapeLabel(), shape, theColor, shapeDate,
					"dynamic " + _shapeName);
			if (endTime != null) {
