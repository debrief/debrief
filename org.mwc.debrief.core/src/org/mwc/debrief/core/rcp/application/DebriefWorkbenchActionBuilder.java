 ...
 * 
 * Based on IDEWorkbenchActionBuilder
 * 
 */
public final class DebriefWorkbenchActionBuilder extends ActionBarAdvisor {
     ...
     */
    public DebriefWorkbenchActionBuilder(IActionBarConfigurer configurer) {
        super(configurer);
...
//        }
    	coolBar.add(new GroupMarker("debrief"));
...
//        }
    ...
    public void dispose() {
    	...
    	isDisposed = true;
    	IMenuService menuService = (IMenuService) window.getService(IMenuService.class);
    	if (coolbarPopupMenuManager != null) {
