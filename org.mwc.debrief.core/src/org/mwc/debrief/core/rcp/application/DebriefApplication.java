...
/**
 * The "main program" for the Debrief. Based on Eclipse IDEApplication,.
 * 
 * @since 3.0
 */
public class DebriefApplication implements IApplication, IExecutableExtension {
    ...
    public Object start(IApplicationContext appContext) throws Exception {
        ...
        try {
            ...
            int returnCode = PlatformUI.createAndRunWorkbench(display,
            		new DebriefWorkbenchAdvisor(processor));
