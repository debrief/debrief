package org.mwc.debrief.core.rcp.application;
 ...
 * 
 * Based on IDEWorkbenchWindowAdvisor
 */
public class DebriefWorkbenchWindowAdvisor extends WorkbenchWindowAdvisor {

	private static final String WELCOME_EDITOR_ID = "org.eclipse.ui.internal.ide.dialogs.WelcomeEditor"; //$NON-NLS-1$

	private DebriefWorkbenchAdvisor wbAdvisor;
	 ...
	 */
	public DebriefWorkbenchWindowAdvisor(DebriefWorkbenchAdvisor wbAdvisor,
	...
	public ActionBarAdvisor createActionBarAdvisor(
		...
		return new DebriefWorkbenchActionBuilder(configurer);
	}
	...
	public void postWindowOpen()
	{
		...
		try
		{
			CorePlugin.getDefault().initialize();
		}
		catch (CoreException e)
		{
			CorePlugin.logError(Status.ERROR,
					"Failed to initialise org.mwc.cmap.core", null);
		}
		DebriefPlugin.getDefault().initialize();
	}
