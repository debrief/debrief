		...
		return new IRunnableWithProgress() {
...

			{
				try {
					...
					final ImportSATC importer = new ImportSATC(theLayers);
					importer.importThis(fileName, inputStream);
				} catch (final ParseException pe) {
					DebriefPlugin.logError(IStatus.ERROR, "Problem loading SATC datafile:" + fileName, pe);
				} catch (final RuntimeException e) {
					DebriefPlugin.logError(IStatus.ERROR, "Problem loading SATC datafile:" + fileName, e);
