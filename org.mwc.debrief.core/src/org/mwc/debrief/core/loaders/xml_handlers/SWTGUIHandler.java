...
abstract public class SWTGUIHandler extends MWC.Utilities.ReaderWriter.XML.MWCXMLReader {
	...
	public static void exportThis(final PlotEditor thePlot, final org.w3c.dom.Element parent,
		...
		// first the tote
		// //////////////////////////////////////////////
		final TrackDataProvider theTracks = (TrackDataProvider) thePlot.getAdapter(TrackDataProvider.class);
		...
		final LayerPainterManager painter = (LayerPainterManager) thePlot.getAdapter(LayerPainterManager.class);
		final TimeProvider timeProvider = (TimeProvider) thePlot.getAdapter(TimeProvider.class);
		if (controller != null) {
			final ComponentDetails stepperD = _myStepperHandler.exportThis(controller, painter, timeProvider, doc);
