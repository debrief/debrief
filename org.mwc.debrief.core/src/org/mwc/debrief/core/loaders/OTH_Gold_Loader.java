			...
			public void run(final IProgressMonitor pm) {
				...
				Display.getDefault().syncExec(new Runnable() {
					...
					public void run() {
						...
						final MessageBox messageBox = new MessageBox(s,
								SWT.ICON_QUESTION | SWT.YES | SWT.NO | SWT.CANCEL);
						messageBox.setMessage("Do you wish to generate ellipse shapes for TUAs?");
				...
				final OTH_Helper_Headless othHelper = new OTH_Helper_Headless(importOTH);

				try {
					// ok - get loading going
					final Action importAction = importer.importThis(othHelper, inputStream, layers,
