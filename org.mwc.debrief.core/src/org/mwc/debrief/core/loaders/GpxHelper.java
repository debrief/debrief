...
public interface GpxHelper {
	 ...
	 *
	 * @param from      tracks to export
	 * @param saveToGpx GPX file to save to.
	 */
	 ...
	 *
	 * @param gpxStream stream representing the gpx xml.
	 * @param theLayers layers to which the tracks are added. A new Layers object
	 *                  will be created if <code>theLayers</code> is null.
