...
public class InsertDynamicPolygon extends InsertDynamicShape<DynamicPolygonBoundsPage> {
	...
	@Override
	protected CoreDynamicShapeWizard<DynamicPolygonBoundsPage> getWizard(final Date startDate, final Date endDate,
			final WorldLocation center) {
		return new CoreDynamicShapeWizard<DynamicPolygonBoundsPage>("Polygon", startDate, endDate) {
			@Override
			...
			@Override
			protected PlainShape getShape(final DynamicPolygonBoundsPage page) {
