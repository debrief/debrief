...
public class InsertDynamicRectangle extends InsertDynamicShape<DynamicRectangleBoundsPage> {
	...
	@Override
	protected CoreDynamicShapeWizard<DynamicRectangleBoundsPage> getWizard(final Date startDate, final Date endDate,
			final WorldLocation center) {
		return new CoreDynamicShapeWizard<DynamicRectangleBoundsPage>("Rectangle", startDate, endDate) {
			@Override
			...
			@Override
			protected PlainShape getShape(final DynamicRectangleBoundsPage page) {
