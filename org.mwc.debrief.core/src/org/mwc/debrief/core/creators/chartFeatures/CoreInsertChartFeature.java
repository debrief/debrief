...
abstract public class CoreInsertChartFeature extends CoreEditorAction {
	...
	public void execute() {
		...
		if (res != null) {
			// We store the object created in the _shape variable to user it in the
			// createAndStore method
	...
	private Editable findPlottable(final Layer theLayer, final String name) {
		if (name == null) {
			return null;
		}
		final Enumeration<Editable> elements = theLayer.elements();
