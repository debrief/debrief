...
public interface SensorImportHelper {
	...
	public static class SensorImportHelperUI implements SensorImportHelper {
		...
		public SensorImportHelperUI(final String sensorName, final Color sensorColor, final String introString,
			...
			getName = new EnterStringPage(null, sensorName, "Import Sensor data",
					"Please provide the name for this sensor", introString, imagePath, null, false, explain);
			getColor = new SelectColorPage(null, sensorColor, "Import Sensor data", "Now format the new sensor",
					"The default color for the cuts for this new sensor", imagePath, null, null, false);
			getVis = new EnterBooleanPage(null, false, "Import Sensor data",
					"Please specify if this sensor should be displayed once loaded", "yes/no", imagePath, null, null);
			final WorldDistance defRange = new WorldDistance(5, WorldDistance.KYDS);
			getRange = new EnterRangePage(null, "Import Sensor data",
			...
			getSensorOffset = new EnterRangePage(null, "Import Sensor data",
					"Please provide the length of the array offset", "Sensor offset", defLen, imagePath2, null, null,
					"SENSOR_OFFSET");
			getBaseFreq = new EnterStringPage(null, " 220.00", "Import Sensor data",
					"Please provide the base frequency for this sensor", "Hz", imagePath2, null, true, null,
					"BASE_FREQ", "Base freq:");
			applyRainbowInRainbowColors = new EnterBooleanPage(null, false, "Import Sensor data",
					"Should Debrief apply Rainbow Shades to these sensor cuts?", "yes/no", "images/ShadeRainbow.png",
					null, null);
