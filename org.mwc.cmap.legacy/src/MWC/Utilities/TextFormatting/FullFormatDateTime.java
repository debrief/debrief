...
public class FullFormatDateTime {
	...
	static protected long fromStringLikeThis(final String theTxt, final String thePattern) throws ParseException {
	...
	static public String toDetailedShortString(final long theVal) {
		return toStringLikeThis(theVal, "HHmm:ss");
	}

	static public String toISOString(final long theVal) {
		return toStringLikeThis(theVal, ISO_FORMAT);
	}
	...
	static public String toString(final long theVal) {
		return toStringLikeThis(theVal, FULL_FORMAT);
	}
