...
abstract public class LongLocationHandler extends MWCXMLReader {
	...
	public void elementClosed() {
		...
		final MWC.GenericData.WorldLocation res = new MWC.GenericData.WorldLocation(_latDeg, (int) _latMin, _latSec,
				_latHem, _longDeg, (int) _longMin, _longSec, _longHem, _depth);
		setLocation(res);
	}
