...
abstract public class VPFCoverageHandler extends MWCXMLReader {
	...
	public VPFCoverageHandler() {
		...
		addHandler(new VPFFeatureHandler() {
			@Override
			public void addFeature(final String type, final String description, final java.awt.Color color,
	...
	abstract public void addCoverage(String type, String description, boolean visible,
			java.util.Enumeration<FeaturePainter> features);

	public void addThisFeature(final String type, final String description, final java.awt.Color color,
			final boolean isVisible) {
