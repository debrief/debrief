...
public class TestCaseLoader {
	 ...
	 *
	 * @param requiredType An iterator over a collection of fully qualified class
	 *                     names
	 */
		...
		if (TestCase.class.isAssignableFrom(testCaseClass)) {
			try {
				...
				throw new IllegalArgumentException(
						"The field " + testCaseClass.getName() + ".TEST_ALL_TEST_TYPE is not accessible.");
			}
		}
	 ...
	 *
	 * @param classNamesIterator An iterator over a collection of fully qualified
	 *                           class names
	 */
	 ...
	 * <code>isATestCaseOfTheCorrectType</code> to determine if the test case should
