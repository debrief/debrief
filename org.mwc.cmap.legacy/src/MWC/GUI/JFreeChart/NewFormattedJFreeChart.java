...
public class NewFormattedJFreeChart extends JFreeChart implements MWC.GUI.Editable, hasPropertyListeners {
	public static class ChartDateFormatPropertyEditor extends MWC.GUI.Properties.DateFormatPropertyEditor {
		...
		static private final String[] stringTags = { AUTO_VALUE, "mm:ss.SSS", "HHmm.ss", "HHmm", "HHmm // ddHHmm",
		...
		public final PropertyDescriptor[] getPropertyDescriptors() {
			try {
				final PropertyDescriptor[] res = {
						displayExpertLongProp("DataLineWidth", "Data line width", "the width to draw the data lines",
								EditorType.FORMAT, LineWidthPropertyEditor.class),
						displayProp("TitleText", "Title text", "the title of this plot"),
						displayProp("FixedDuration", "Fixed duration", "How long a time-span to display",
								EditorType.TEMPORAL),
						displayProp("DisplayFixedDuration", "Display fixed duration",
								"Whether to show a limited time period (in Grow mode)", EditorType.TEMPORAL),
						...
						displayProp("TitleFont", "Title font", "font to use for the plot title", EditorType.FORMAT),
						displayProp("AxisFont", "Axis font", "font to use for the plot axis titles", EditorType.FORMAT),
						displayProp("TickFont", "Tick font", "font to use for the plot axis tick mark labels",
								EditorType.FORMAT),
						displayProp("LegendFont", "Legend font", "font to use for the legend", EditorType.FORMAT),
						displayProp("ShowLegend", "Show legend", "whether to show legend", EditorType.VISIBILITY),
	...
	/**
	 * ******************************************************************* embedded
	 * class which optionally applies an offset to the time value received
	 * *******************************************************************
	 */
	public static class SwitchableTimeOffsetProvider implements ColouredDataItem.OffsetProvider {
		 ...
		 * @param stepper
		 */
		public SwitchableTimeOffsetProvider(final StepperListener.StepperController stepper) {
	...
	public double getSymbolSize() {
		final ColourStandardXYItemRenderer renderer = (ColourStandardXYItemRenderer) this.getXYPlot().getRenderer();
