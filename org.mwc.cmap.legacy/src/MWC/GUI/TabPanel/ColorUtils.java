...
public class ColorUtils {
	 ...
	 *                                     unacceptable
	 */
	public static Color darken(final int r, final int g, final int b, final double percent)
	 ...
	 *                                     unacceptable
	 */
	public static Color lighten(final int r, final int g, final int b, final double percent)
			throws IllegalArgumentException {
		GeneralUtils.checkValidPercent(percent);
