...
public class AWTPropertyEditor extends PlainPropertyEditor implements KeyListener {
	...
	protected static void checkPropertyEditors() {
		...
		PropertyEditorManager.registerEditor(java.util.Date.class, AWTDatePropertyEditor.class);
		PropertyEditorManager.registerEditor(MWC.GenericData.WorldLocation.class, AWTWorldLocationPropertyEditor.class);
		PropertyEditorManager.registerEditor(boolean.class, AWTBooleanPropertyEditor.class);
	 ...
	 */
	public AWTPropertyEditor(final MWC.GUI.Editable.EditorType info, final AWTPropertiesPanel parent,
			final Layers theLayers, final MWC.GUI.ToolParent theParent, final Layer parentLayer) {
	...
	public void notifyDateInconsistency(final String startDescription, final String endDescription) {
		final MessageDialog messageDialog = new MessageDialog(null, null, "Date inconsistency",
