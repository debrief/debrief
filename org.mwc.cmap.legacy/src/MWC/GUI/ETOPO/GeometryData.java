 ...
 * geometry from one of the generator classes in this package. In general, data
 * does not get filled in for items that are not requested.
 * <p>
 *
...
public class GeometryData {
	...
	/**
	 * A generator specific field that describes the type of output algorithm you
	 * would like to use for the geometry. May be ignored.
	 */
	public int geometrySubType;

	/**
	 * The attributes of the geometry you want created. This is an OR'd list of the
	 * above variables. It is not possible to generate anything without the raw
	...
	/**
	 * Storage for coordinate information. These are stored in flat [x1, y1, z1, x2,
	 * y2, z2, ...] configuration
	 */
	public float[] coordinates;

	/**
	 * Storage for lighting normal information. This should be at least the length
	 * of the coordinates array. Data is stored in the same fashion. If normals are
	 * requested, the count is the same as vertexCount.
	 */
	...
	/**
	 * Texture coordinate information if requested. May be 2D or 3D depending on the
	 * requested type. If 2D the values are stored [s1, t1, s2, t2...] For 3D
	 * coordinates it is stores as [r1, s1, t1, r2, s2, t2,...]
	 */
	public float[] textureCoordinates;

	/**
	 * Colour values if using per-vertex coloring. This array will be identical in
	 * length to the coordinate array and index values match etc.
	 */
	public float[] colors;
}