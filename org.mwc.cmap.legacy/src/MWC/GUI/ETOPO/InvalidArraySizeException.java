...
/**
 * Exception for when one of the requested geometry generation arrays is not big
 * enough to contain the data requested.
 * <P>
 *
 * @author Justin Couch
...
public class InvalidArraySizeException extends RuntimeException {
	...
	/**
	 * Create an exception that contains the given message plus a pre-fabricated
	 * part. Typically the base message is just the array that does not have the
	 * right size.
	 *
