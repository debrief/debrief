...
/**
 * The InputReader is an interface that isolates the data file source type from
 * the BinaryFile. Represents an InputStream setup, and basic read functions.
 */
public interface InputReader {
	...
	/**
	 * Return the total byte length of the source. May not be accurate for
	 * StreamInputReaders.
	 *
	 * @return the number of bytes remaining to be read (counted in bytes)
	 * @exception IOException Any IO errors encountered in accessing the file
