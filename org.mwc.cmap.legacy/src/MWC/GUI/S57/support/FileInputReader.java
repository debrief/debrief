...
public class FileInputReader implements InputReader {
	...
	/**
	 * Initialize the underlying RandomAccessFile. If it's found, but there are too
	 * many files open, it calls BinaryFile.closeClosable to try to get an open file
	 * pointer from the system, and then tries again.
	 *
