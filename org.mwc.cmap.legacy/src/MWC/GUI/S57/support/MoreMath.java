...
public class MoreMath {
	 ...
	 * @return boolean
	 */
	final public static boolean approximately_equal(final double a, final double b, final double epsilon) {
	 ...
	 * @return boolean
	 */
	final public static boolean approximately_equal(final float a, final float b, final float epsilon) {
		return (Math.abs(a - b) <= epsilon);
	}
	 ...
	 * @return int
	 */
	public static final int BuildInteger(final byte bytevec[], final int offset, final boolean MSBFirst) {
		if (MSBFirst)
	...
	public static final int BuildIntegerBE(final byte bytevec[], final int offset) {
		return (((bytevec[0 + offset]) << 24) | (signedToInt(bytevec[1 + offset]) << 16)
	...
	public static final int BuildIntegerLE(final byte bytevec[], final int offset) {
		return (((bytevec[3 + offset]) << 24) | (signedToInt(bytevec[2 + offset]) << 16)
	 ...
	 * @return long
	 */
	public static final long BuildLong(final byte bytevec[], final int offset, final boolean MSBFirst) {
		if (MSBFirst)
	 ...
	 * @return short
	 */
	public static final short BuildShort(final byte bytevec[], final int offset, final boolean MSBFirst) {
		if (MSBFirst) {
	...
	/*
	 * public static final void main(String[] args) { byte[] b = new byte[4]; b[0] =
	 * (byte)0xff; b[1] = (byte)0x7f;
	 * com.bbn.openmap.util.Debug.output("32767="+BuildShortLE(b, 0)); b[0] =
	 * (byte)0x7f; b[1] = (byte)0xff;
	 * com.bbn.openmap.util.Debug.output("32767="+BuildShortBE(b, 0)); b[1] =
	 * (byte)0xff; b[2] = (byte)0xff; b[3] = (byte)0xff;
