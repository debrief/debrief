...
abstract public class Open extends PlainTool {
	protected class myFilter implements java.io.FilenameFilter {
		...
		public boolean accept(final File p1, final String p2) {
			...
			for (final String string : _theSuffixs) {
	 ...
	 */
	public Open(final ToolParent theParent, final String theLabel, final String[] theSuffixs,
			final String theDescription) {
		super(theParent, theLabel, "images/24/open.png");
	...
	private java.io.File[] getFileName() {
		final StringBuilder bSufix = new StringBuilder();
		...
		return MWC.GUI.Dialogs.DialogFactory.getOpenFileName(bSufix.toString(), _theDescription, _lastDirectory);
	}
}
