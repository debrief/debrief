...
public class RightClickCutCopyAdaptor implements RightClickEdit.PlottableMenuCreator {
	...
	public static class CopyItem extends CutItem {
		...
		public CopyItem(final Editable data, final Clipboard clipboard, final Layer theParent, final Layers theLayers,
				final Layer updateLayer, final UndoBuffer buffer) {
	...
	//
	/////////////////////////////////////////////////
	public static class CutItem extends javax.swing.JMenuItem implements Action, ActionListener, ClipboardOwner {
		/**
		 *
		 */
		private static final long serialVersionUID = 1L;
		...
		public CutItem(final Editable data, final Clipboard clipboard, final Layer theParent, final Layers theLayers,
				final Layer updateLayer, final UndoBuffer buffer) {
			// remember parameters
			_buffer = buffer;
			_data = data;
	...
	public static class CutLayer extends CutItem {
		...
		public CutLayer(final Editable data, final Clipboard clipboard, final Layer theParent, final Layers theLayers,
				final Layer updateLayer, final UndoBuffer buffer) {
			super(data, clipboard, theParent, theLayers, updateLayer, buffer);
		}
	...
	/**
	 * marker interface for objects that have to reconnect to their child objects
	 * after copy/paste operation. An example of this is FixWrapper
	 *
	 * @author ian
	 *
	 */
	...
	// constructor
	//////////////////////////////////
	public RightClickCutCopyAdaptor(final Clipboard clipboard, final UndoBuffer theBuffer) {
	...
	//////////////////////////////////
	@Override
	public void createMenu(final javax.swing.JPopupMenu menu, final Editable data, final java.awt.Point thePoint,
		...
		if (data instanceof MWC.GUI.Layers) {
			...
			if (theParent instanceof MWC.GUI.Layers) {
				// create the Actions
				cutter = new CutLayer(data, _clipboard, theParent, theLayers, updateLayer, _theBuffer);
			} else if (theParent == null) {
				// create the Actions
				cutter = new CutLayer(data, _clipboard, (Layer) data, theLayers, updateLayer, _theBuffer);
			} else {

				// create the Actions
				cutter = new CutItem(data, _clipboard, theParent, theLayers, updateLayer, _theBuffer);
				// create the Actions
				copier = new CopyItem(data, _clipboard, theParent, theLayers, updateLayer, _theBuffer);
