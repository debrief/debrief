...
public class WriteMetafile extends PlainTool {
	...
	public static void main(final String[] args) {
		...
		fp.setDataArea(new MWC.GenericData.WorldArea(new MWC.GenericData.WorldLocation(0, 0, 0),
				new MWC.GenericData.WorldLocation(1, 1, 1)));
		...
		final String val2 = MWC.Utilities.TextFormatting.BriefFormatLocation.toStringLong(2.1, false);
	 ...
	 * @param theData   the data we are plotting
	 */
	...
	public void execute() {
		...
		try {
			 ...
			 * mf.setColor(java.awt.Color.blue); int ht = mf.getStringHeight(newF); int wid
			 * = mf.getStringWidth(newF, "and us to"); mf.drawText(newF, "and us three",
			 * 200, 100); mf.setColor(java.awt.Color.blue); mf.fillRect(80, 100, 40, 40);
			 */
