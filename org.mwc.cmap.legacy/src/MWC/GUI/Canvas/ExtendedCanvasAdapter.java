...
public class ExtendedCanvasAdapter extends CanvasAdaptor implements ExtendedCanvasType {
	/**
	...
	public ExtendedCanvasAdapter(final PlainProjection proj, final Graphics dest, final Color bkColor) {
	...
	@Override
	public void semiFillArc(final int x, final int y, final int width, final int height, final int startAngle,
			final int arcAngle) {
		final Composite originalComposite = _dest.getComposite();
	...
	@Override
	public void semiFillOval(final int x, final int y, final int width, final int height) {
		final Composite originalComposite = _dest.getComposite();
		_dest.setComposite(makeComposite(SEMI_TRANSPARENCY_ALPHA));
	...
	@Override
	public void semiFillPolygon(final int[] xPoints, final int[] yPoints, final int nPoints) {
		final Composite originalComposite = _dest.getComposite();
		_dest.setComposite(makeComposite(SEMI_TRANSPARENCY_ALPHA));
	...
	@Override
	public void semiFillRect(final int x, final int y, final int wid, final int height) {
		final Composite originalComposite = _dest.getComposite();
		_dest.setComposite(makeComposite(SEMI_TRANSPARENCY_ALPHA));
