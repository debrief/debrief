...

{
	...
	private String[][] fontnames = { { "helvetica", "Arial" }, { "timesroman", "Times New Roman" },
			{ "courier", "Courier New" }, { "zapfdingsbat", "Windings" } };
	...
	protected int addHandle() {
		for (int i = 0; i < handles.size(); i++) {
			if (!handles.elementAt(i).booleanValue()) {
	...
	public void arc(final int i, final int i_0_, final int i_1_, final int i_2_, final int i_3_, final int i_4_,
	...
	public void bitBlt(final int i, final int i_7_, final int i_8_, final int i_9_, final int i_10_, final int i_11_,
			final int i_12_, final int[] is, final int i_13_, final int i_14_) {
	...
	private int calcChecksum(final int i, final int i_16_, final int i_17_, final int i_18_, final int i_19_) {
		int i_20_ = 39622;
		i_20_ ^= 0xcdd7;
		i_20_ ^= i;
		i_20_ ^= i_16_;
	...
	public void chord(final int i, final int i_21_, final int i_22_, final int i_23_, final int i_24_, final int i_25_,
	...
	public int createBrushIndirect(final int i, final Color color, final int i_28_) {
		metaRecord(764, 4);
		writeWord(i);
		writeColor(color);
		writeWord(i_28_);
	...
	public int createFont(final Font font, final int escapement, final boolean isUnderline, final boolean isStrikeout) {
		char isBold = '\u0190';
		if (font.isBold())
			isBold = '\u02BC';
		return createFontIndirect(-font.getSize(), 0, escapement, 0, isBold, font.isItalic(), isUnderline, isStrikeout,
				(byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, translateFontName(font.getName()));
	}

	@SuppressWarnings("deprecation")
	public int createFontIndirect(final int height, final int width, final int escapement, final int orientation,
			final int weight, final boolean isItalic, final boolean isUnderline, final boolean isStrikeOut,
			final byte charSet, final byte outputPrecision, final byte clipPrecision, final byte outputQuality,
...
// @@IM next method is deprecated
	...
	public int createPatternBrush(final int[] is, final int i, final int i_44_) {
	...
	public int createPenIndirect(final int i, final int i_46_, final Color color) {
		metaRecord(762, 5);
		writeWord(i);
		writeInteger(i_46_);
		writeColor(color);
	...
	public void deleteObject(final int i) {
		if (i < handles.size() && handles.elementAt(i).booleanValue()) {
			metaRecord(496, 1);
			writeWord(i);
	...
	public void ellipse(final int i, final int i_47_, final int i_48_, final int i_49_) {
		metaRecord(1048, 4);
		writeWord(i_49_);
		writeWord(i_48_);
		writeWord(i_47_);
	...
	public void extTextOut(final int i, final int i_52_, final int i_53_, final Rectangle rectangle,
			final String string) {
		extTextOut(i, i_52_, i_53_, rectangle, string, null);
	}

	@SuppressWarnings("deprecation")
	public void extTextOut(final int i, final int i_54_, final int i_55_, final Rectangle rectangle,
...
// @@IM
	...
	private void outputInteger(final OutputStream outputstream, final int i) throws IOException {
		outputWord(outputstream, lowWord(i));
		outputWord(outputstream, highWord(i));
	}

	private void outputWord(final OutputStream outputstream, final int i) throws IOException {
//    byte[] is = new byte[2];
	...
	public void patBlt(final int i, final int i_67_, final int i_68_, final int i_69_, final int i_70_) {
		metaRecord(1565, 6);
		writeInteger(i_70_);
		writeWord(i_69_);
		writeWord(i_68_);
	...
	public void pie(final int i, final int i_71_, final int i_72_, final int i_73_, final int i_74_, final int i_75_,
	 ...
	 * See Windows SDK.
	 */
	public void polypolygon(final Polygon[] polys) {
		int npoints = 0;
	...
	public void rectangle(final int i, final int i_82_, final int i_83_, final int i_84_) {
		metaRecord(1051, 4);
		writeWord(i_84_);
		writeWord(i_83_);
		writeWord(i_82_);
	...
	public void roundRect(final int i, final int i_85_, final int i_86_, final int i_87_, final int i_88_,
			final int i_89_) {
		metaRecord(1564, 6);
		writeWord(i_89_);
		writeWord(i_88_);
	...
	public void scaleViewportExt(final int i, final int i_90_, final int i_91_, final int i_92_) {
		metaRecord(1042, 4);
		writeWord(i_92_);
		writeWord(i_91_);
		writeWord(i_90_);
	...
	public void scaleWindowExt(final int i, final int i_93_, final int i_94_, final int i_95_) {
		metaRecord(1024, 4);
		writeWord(i_95_);
		writeWord(i_94_);
		writeWord(i_93_);
	...
	public void stretchBlt(final int i, final int i_102_, final int i_103_, final int i_104_, final int i_105_,
			final int i_106_, final int i_107_, final int i_108_, final int i_109_, final int[] is, final int i_110_,
			final int i_111_) {
	...
	private void writeBody(final OutputStream outputstream) throws IOException {
		for (int i = 0; i < this.wmf.size(); i++)
			outputWord(outputstream, this.wmf.elementAt(i).intValue());
	}
	...
	private void writePlaceableHeader(final OutputStream outputstream, final int i, final int i_134_, final int i_135_,
			final int i_136_, final int i_137_) throws IOException {
	...
	public void writePlaceableWMF(final OutputStream outputstream, final int i, final int i_138_, final int i_139_,
			final int i_140_, final int i_141_) throws IOException {
		writePlaceableHeader(outputstream, i, i_138_, i_139_, i_140_, i_141_);
		writeWMF(outputstream);
	}

	public void writeWMF(final OutputStream outputstream) throws IOException {
