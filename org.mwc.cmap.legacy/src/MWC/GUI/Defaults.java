...
public class Defaults {
	...
	public static Font getFont() {
		...
		final Font res = pref != null ? pref : new Font("Arial", Font.PLAIN, 10);

		return res;
	}

	public static String getPreference(final String prefName) {
	...
	public static void setProvider(final PreferenceProvider provider) {
		_provider = provider;
	}
}
