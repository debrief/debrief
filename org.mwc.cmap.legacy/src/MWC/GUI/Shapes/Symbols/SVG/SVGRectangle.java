...
public class SVGRectangle extends SVGElement {
	...
	public static class SVGRectangleTest extends junit.framework.TestCase {
		...
		public void testBasicRectangle() {
			try {
				final String contentToLoad = "<rect id=\"Rectangle-2\" fill=\"#000000\" x=\"24.5\" y=\"23\" width=\"52\" height=\"21\"/>";
				...
				final SVGRectangle newRectangle = new SVGRectangle(doc.getDocumentElement());
	...
	public SVGRectangle(final Element dom) {
		super(dom);
		try {
			final double x = Double.parseDouble(getDom().getAttribute("x"));
			final double y = Double.parseDouble(getDom().getAttribute("y"));
			final double width = Double.parseDouble(getDom().getAttribute("width"));
			final double height = Double.parseDouble(getDom().getAttribute("height"));
