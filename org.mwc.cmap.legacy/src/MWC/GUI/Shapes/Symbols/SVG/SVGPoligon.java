...
public class SVGPoligon extends SVGPolyline {
	...
	public static class SVGPolygoneTest extends junit.framework.TestCase {
		...
		public void testBasicSVGPolygone() {
			try {
				final String contentToLoad = "<polygon id=\"Rectangle\" fill=\"#000000\" points=\"7 42.5 95 42.5 87 74 14.5 74\" style=\"pointer-events: none;\"/>";
				...
				final SVGPoligon newPoligone = new SVGPoligon(doc.getDocumentElement());
	...
	public SVGPoligon(final Element dom) {
		super(dom);
	}
