...
public class FindNearest {
	public static void findNearest(final Layer thisLayer, final WorldLocation cursorLoc, final Point cursorPos,
					...
					if (pt.getVisible()) {
						...
						if (pt instanceof Layer) {
							...
							if (!sorted) {
								...
								if (rngDegs != -1) {
									final WorldDistance thisSep = new WorldDistance(pt.rangeFrom(cursorLoc),
											WorldDistance.DEGS);
