...
public interface HasDraggableComponents {
	 ...
	 *
	 * @param cursorPos      the current mouse cursor position
	 * @param cursorLoc      that position in world coordinates
	 * @param currentNearest the 'running total' of nearest points
	 * @param parentLayer    the layer to update when drag is complete
	 */
	public void findNearestHotSpotIn(Point cursorPos, WorldLocation cursorLoc,
			HasDraggableComponents.ComponentConstruct currentNearest, Layer parentLayer);

	/**
	 * get the name of the item, so we can place a detailed description on the undo
	 * buffer
	 *
