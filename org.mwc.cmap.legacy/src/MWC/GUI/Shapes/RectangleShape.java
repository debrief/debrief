    ...
    HasDraggableComponents
{
  ...
  public class RectangleInfo extends Editable.EditorType
  {
    ...
    public PropertyDescriptor[] getPropertyDescriptors()
    {
      try
      {
        ...
        {displayProp("Corner_TopLeft", "Top left corner", "the top left corner",
            SPATIAL), displayProp("CornerBottomRight", "Bottom right corner",
                "the bottom right corner", SPATIAL), prop("Filled",
                    "whether this shape is filled", FORMAT), displayProp(
                        "SemiTransparent", "Semi transparent",
                        "whether the filled rect is semi-transparent",
                        FORMAT),};
  ...
  /**
   * get the shape as a series of WorldLocation points. Joined up, these form a representation of
   * the shape
   */
