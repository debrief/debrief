...
public class RowLayout implements LayoutManager {
	...
	public RowLayout(final Orientation horizontalOrient, final Orientation verticalOrient) {
		this(horizontalOrient, verticalOrient, _defaultGap);
	}

	public RowLayout(final Orientation horizontalOrient, final Orientation verticalOrient, final int gap) {
		if (gap < 0 || (horizontalOrient != Orientation.LEFT && horizontalOrient != Orientation.CENTER
				&& horizontalOrient != Orientation.RIGHT) ||

				(verticalOrient != Orientation.TOP && verticalOrient != Orientation.CENTER
