...
class QuestionDialogLauncher extends Panel implements DialogClient, ActionListener {
	...
	public QuestionDialogLauncher(final Applet applet) {
		...
		add(modal);
		add(questionDialogButton = new Button("Launch Question Dialog"));
	...
	public void actionPerformed(final ActionEvent event) {
		final Image image = applet.getImage(applet.getCodeBase(), "gifs/book.gif");
		if (questionDialog == null) {
			questionDialog = new QuestionDialog(Util.getFrame(this), this, "Example Question Dialog",
					"Book Of The Month:  ", "The Hobbit", 45, image, modal.getState());
		}
		if (modal.getState())
