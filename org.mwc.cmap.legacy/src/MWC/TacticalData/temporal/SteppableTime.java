...
/**
 * Interface for objects for whom their time attribute may be externally
 * controlled.
 *
 * @author ian.mayo
 *
...
public interface SteppableTime {
	 ...
	 *
	 * @param origin     - an identifier for the object sending the update, provided
	 *                   largely so that triggering object can ignore time changes
	 *                   it originally created
	 * @param fireUpdate - whether to fire the update to any listeners. This should
	 *                   normally be true, but may be false when originally loading
	 *                   the data
	 */
