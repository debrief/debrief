...
public final class NarrativeEntry
		implements MWC.GUI.Plottable, Serializable, ExcludeFromRightClickEdit, TimeStampedDataItem {
	...
	public final static class NarrativeEntryInfo extends Griddable {
		...
		public PropertyDescriptor[] getGriddablePropertyDescriptors() {
			try {
				final PropertyDescriptor[] res = { prop("Type", "the type of entry", FORMAT),
		...
		public final PropertyDescriptor[] getPropertyDescriptors() {
			try {
				if (_cachedProps == null) {
					final PropertyDescriptor[] myRes = { prop("Type", "the type of entry", FORMAT),
							prop("Source", "the source for this entry", FORMAT),
	...
	public boolean equals(final Object obj) {
		...
		return Objects.equals(_DTG, other._DTG) && Objects.equals(_entry, other._entry)
				&& Objects.equals(_track, other._track) && Objects.equals(_type, other._type);
	}
