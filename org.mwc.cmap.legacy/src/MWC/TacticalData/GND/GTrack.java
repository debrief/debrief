...
public class GTrack extends PlainWrapper implements WatchableList, Layer, GriddableSeriesMarker {
	...
	public PlainSymbol getSnailShape() {
		if (_mySnail == null)
			_mySnail = MWC.GUI.Shapes.Symbols.SymbolFactory.createSymbol(SymbolFactory.MERCHANT);
