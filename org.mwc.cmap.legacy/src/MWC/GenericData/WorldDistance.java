...
public class WorldDistance implements Serializable {
	...
	/**
	 * convenience class for lengths that are specifically to be edited with the
	 * Array Lengths editor
	 *
	 * @author ianmayo
	 *
	 */
	 ...
	 */
	static private double _scaleVals[] = { 1852, 2025.371828, 1.852, 1, 1, 0.016666666666666666666667, 2.025371828,
			6076.11548 };

	/**
	 * the units labels
	 */
	static public final String[] UnitLabels = { "m", "yds", "km", "nm", "minutes", "degs", "kyds", "ft" };
	...
	/**
	 * accessor to indicate if this distance represents an absolute or angular
	 * distance
	 */
	...
	public String toString() {
		...
		final boolean isWhole = isFinite && Double.compare(_myDistance, StrictMath.rint(_myDistance)) == 0;
