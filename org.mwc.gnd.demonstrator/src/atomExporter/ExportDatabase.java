...
//	private static final String DATA_ROOT = "c:\\tmp\\atomData\\";
	...
	private static void exportCategory(final String table, final String idField, final String nameField,
...
//		}
	...
	private static void exportCore(final String thisDatasetQuery, final String thisDatasetName) {
...
//	}
	...
	private static void exportDetail(final boolean longVersion) {
//		Abdera abdera = new Abdera();
//		Factory factory = abdera.getFactory();
//		ResultSet rsf, rse;
//		Statement st, st2;
...
//		}
	...
	public static void main(final String[] args) {
		...
		final Date endD = new Date();
		System.out.println("took " + (endD.getTime() - startD.getTime()) / 1000 + " secs");
