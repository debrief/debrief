...
public interface ASSETGuest {
	...
	public void newParticipantDecision(int scenarioId, int participantId, DecidedEvent event);
	 ...
	 * @param newState
	 */
	public void newParticipantDetection(int scenarioId, int participantId, DetectionEvent event);
