...
public class ParticipantListenerHandler extends ASSETResource implements ListenerResource {
	...
	public void remove() {
		...
		final ASSETHost.HostProvider host = (HostProvider) getApplication();
		host.getHost().deleteParticipantListener(getScenarioId(), getParticipantId(), theId);
	}
