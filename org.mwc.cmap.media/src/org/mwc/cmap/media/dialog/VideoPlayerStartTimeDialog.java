...
public class VideoPlayerStartTimeDialog extends TitleAreaDialog {
	...
	public VideoPlayerStartTimeDialog(final Shell parentShell) {
		super(parentShell);
	}
	...
	protected Control createDialogArea(final Composite parent) {
		...
		composite.setLayout(new GridLayout(3, false));
		{
			...
			// startTime.setToolTipText("Actual recording start time in YYYY-MM-DD HH:mm:ss
			// format, Eg:1995-12-12 10:38:56");
	...
	protected void okPressed() {
		_startTime = (startTime.getSelection());
		super.okPressed();
	}
