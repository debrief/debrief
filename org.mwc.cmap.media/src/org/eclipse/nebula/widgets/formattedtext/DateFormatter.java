 ...
 * <code>FormattedText</code>, restricting the edit and display to the time
...
public class DateFormatter extends DateTimeFormatter {
	 ...
	 * @param loc locale
	 */
	public DateFormatter(final Locale loc) {
		super(loc);
	}
	 ...
	 */
	public DateFormatter(final String editPattern) {
		super(editPattern);
	}
	 ...
	 * @param loc         locale
	 */
	public DateFormatter(final String editPattern, final Locale loc) {
	 ...
	 */
	public DateFormatter(final String editPattern, final String displayPattern) {
	 ...
	 * @param loc            locale
	 */
	public DateFormatter(final String editPattern, final String displayPattern, final Locale loc) {
	 ...
	 * the date part for the given locale. The corresponding pattern string is then
	...
	public String getDefaultEditPattern(Locale loc) {
		...
		final String key = "DA" + loc.toString();
	 ...
	 * the parent method, restricting authorized chars to date patterns.
	 *
